...
public class Form implements Serializable{
    ...
    public Form(String id, String moduleid, String name, String code, String type, String defaultvalue, String required, String builtin, String hidden, String keyattr, String rate, String unit, Integer sortindex, Date inserttime, Date updatetime, Integer isdelete, String relformid) {
        this.id = id;
