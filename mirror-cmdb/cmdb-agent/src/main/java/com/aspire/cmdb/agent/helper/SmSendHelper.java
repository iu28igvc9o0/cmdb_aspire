package com.aspire.cmdb.agent.helper;
...
import com.aspire.cmdb.agent.util.Md5Util;
...
public class SmSendHelper {
    ...
    @Value("${sms.password:dd}")
    private String smsPassword;
    
	@Value("${sms.env:dd}")
	protected String smsEnv;
	
	@Value("${sms.bpm.smsSendUrl:dd}")
    ...
    private boolean sendOnly(List<String> mobiles, String message) throws Exception {
        ...
        String brief = Md5Util.generateCheckCode(smsPassword + action + xmlData + smsTarget);
