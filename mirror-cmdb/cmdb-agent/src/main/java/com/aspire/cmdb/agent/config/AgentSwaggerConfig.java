...
@Configuration
@EnableSwagger2
public class AgentSwaggerConfig extends WebMvcConfigurerAdapter {
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("CMBD AGENT API").description("CMBD AGENT API")
	...
	public Docket customImplementation() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors
						.basePackage("com.aspire.cmdb.agent"))
				.build()
