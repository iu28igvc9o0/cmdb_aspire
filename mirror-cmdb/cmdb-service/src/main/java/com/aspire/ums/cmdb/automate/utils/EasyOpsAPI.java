...
public class EasyOpsAPI {
    ...
    public EasyOpsAPI() {
        this(AutomateConfigConstant.getAccessKey(), AutomateConfigConstant.getSecretKey(), AutomateConfigConstant.getURL());
    }
    ...
    private String sendGet(String url, Map<String, String> data, String requestBody, String method) throws AutomateException {
        String result = null;
        String param = "";
