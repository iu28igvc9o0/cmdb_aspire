 ...
 */
@Slf4j
public class IPRepositoryPublicIPOperateLogEvent extends AbstractModuleEvent {
    ...
    public Map<String, Object> event(String moduleId, String instanceId, Map<String, Object> handleData) {
        ...
        EventThreadUtils.FIXED_POOL.execute(() -> logHelper.toLog("public_ip_need_fileds", moduleId, instanceId, handleData));
