...
public class MaintenHardServiceImpl implements MaintenHardService {
	...
	public MaintenHardware selectMaintenHardwareByDeviceModel(String maintenFactory, String deviceModel,
		...
		Map<String, Object> hashMap=new HashMap<String, Object>();
 		...
 		hashMap.put("maintenFactory", maintenFactory);
 		hashMap.put("deviceModel", deviceModel);
 		hashMap.put("warrantyDate", warrantyDate);
 		 
    	
 		List<MaintenHardware> maintenHardwareList=maintenHardwareMapper.selectMaintenHardwareByDeviceModel(hashMap);
   ...
   //删除硬件维保
	...
	@Override
	public List<MaintenHardPageResp> getMaintenHardwareList(MaintenHardPageRequest maintenHardPageRequest) {
