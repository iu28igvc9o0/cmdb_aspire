...
@Mapper
public interface IpAuditSurvivingUnplanPublicIpMapper {
     /**
     * 获取所有实例
     * @return 返回所有实例数据
     */
     ...
     * @return 返回实例信息的数据信息
     */
    IpAuditCommonResp get(IpAuditSurvivingUnplanPublicIp entity);
     ...
     * @return
     */
    void insert(IpAuditSurvivingUnplanPublicIp entity);
     ...
     * @return
     */
    void update(IpAuditSurvivingUnplanPublicIp entity);
     ...
     * @return
     */
    void delete(IpAuditSurvivingUnplanPublicIp entity);

    Long getMaxCheckNum();

    void batchInsertIp(List<IpAuditSurvivingUnplanPublicIp> list);
    ...
    List<String> getIpRepositoryPublicIps();

    List<Map<String,String>> getUnPublicIpsByUnStreated(long checkNum);
}