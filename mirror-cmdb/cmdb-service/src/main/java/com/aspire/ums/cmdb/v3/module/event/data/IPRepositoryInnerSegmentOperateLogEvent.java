 ...
 */
@Slf4j
public class IPRepositoryInnerSegmentOperateLogEvent extends AbstractModuleEvent {
    ...
    public Map<String, Object> event(String moduleId, String instanceId, Map<String, Object> handleData) {
        EventThreadUtils.FIXED_POOL.execute(() -> logHelper.toLog("inner_segment_need_fileds", moduleId, instanceId, handleData));
