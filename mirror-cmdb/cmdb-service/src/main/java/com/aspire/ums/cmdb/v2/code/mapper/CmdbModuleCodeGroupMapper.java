...
*/
@Mapper
public interface CmdbModuleCodeGroupMapper {
     /**
     * 获取所有实例
     * @return 返回所有实例数据
     */
     ...
     * @return 返回所有实例数据
     */
    List<CmdbModuleCodeGroup> listByEntity(CmdbModuleCodeGroup entity);
     ...
     * @return
     */
    void deleteBySelective(CmdbModuleCodeGroup entity);
    /**
     * 删除实例
     * @param moduleId 实例数据
     * @return
