...
/**
 * Copyright (C), 2015-2019, 卓望数码有限公司 FileName: IPRepositoryInnerSegmentOperateLogEvent Author: hangfang Date: 2020/5/26
 * Description: DESCRIPTION History: <author> <time> <version> <desc> 作者姓名 修改时间 版本号 描述
 */
@Slf4j
public class IPRepositoryPublicSegmentOperateLogEvent extends AbstractModuleEvent {
    ...
    public Map<String, Object> event(String moduleId, String instanceId, Map<String, Object> handleData) {
        ...
        EventThreadUtils.FIXED_POOL.execute(() -> logHelper.toLog("public_segment_need_fileds", moduleId, instanceId, handleData));
