...
*/
public interface ICmdbModuleEventHandlerClassService {
     /**
     * 获取所有实例
     * @return 返回所有实例数据
     */
     ...
     * @return 返回所有实例数据
     */
    List<CmdbModuleEventHandlerClass> listByEventType(String eventClass);
     ...
     * @return 返回实例信息的数据信息
     */
    CmdbModuleEventHandlerClass getById(String id);
