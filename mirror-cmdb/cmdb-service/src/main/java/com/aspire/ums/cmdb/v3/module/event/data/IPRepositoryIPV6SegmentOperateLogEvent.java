 ...
 */
@Slf4j
public class IPRepositoryIPV6SegmentOperateLogEvent extends AbstractModuleEvent {
    ...
    public Map<String, Object> event(String moduleId, String instanceId, Map<String, Object> handleData) {
        ...
        EventThreadUtils.FIXED_POOL.execute(() -> logHelper.toLog("ipv6_segment_need_fileds", moduleId, instanceId, handleData));
