 ...
 */
@Slf4j
public abstract class AbstractServerProjectInsertFactory extends AbstractInstanceInsertFactory {
        ...
        try {
            ...
            for (String refModuleId : moduleData.keySet()) {
                ...
                if (moduleData.get(refModuleId).keySet().size() > 0) {
                    ...
                    if (Arrays.asList("cmdb_ip_repository", "cmdb_server_project").contains(catalogCode)) {
            ...
            this.createServerProjectData(userName, instanceData, operateType);
     ...
     * @return 返回状态信息
     */
    public abstract void createServerProjectData(String userName, Map<String, Object> instanceData, String operateType);
}
