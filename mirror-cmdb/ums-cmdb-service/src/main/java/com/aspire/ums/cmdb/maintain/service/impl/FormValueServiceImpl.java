...
public class FormValueServiceImpl implements FormValueService {
    ...
    @Override
    public void update(FormValue formValue) {
    ...
    @Override
    public void insertSingle(FormValue formValue) {
        formValueMapper.insertSingle(formValue);
    }
    ...
    @Override
    public List<Map<String,String>> getFormValueMapByInstanceId(String instanceId) {
        return formValueMapper.getFormValueMapByInstanceId(instanceId);
    }
