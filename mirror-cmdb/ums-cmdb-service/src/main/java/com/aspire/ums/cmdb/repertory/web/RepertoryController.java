...
public class RepertoryController {
	...
	public Map<String, Object> uploadData(@PathVariable(value = "filename") MultipartFile file,@PathVariable("circleId") String circleId, HttpServletRequest request) {
		Map<String, Object> map = new HashMap<String, Object>();
		logger.info("请求编码格式：" + request.getCharacterEncoding());
		if (null == file) {
...
//			return map;
//		}
		map = repertoryService.uploadData(file,circleId);
		return map;
	}
