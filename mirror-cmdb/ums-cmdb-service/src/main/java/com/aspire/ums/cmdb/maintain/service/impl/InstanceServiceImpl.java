...
public class InstanceServiceImpl implements InstanceService {
    ...
    @Override
    public List<String> getInstanceByNameAndModuleId(Map<String, Object> map) {
        return instanceMapper.getInstanceByNameAndModuleId(map);
    }
    ...
    @Override
    public List<InstanceBaseColumn> getInstanceBaseInfoByIp(Map<String, Object> map) {
        return instanceMapper.getInstanceBaseInfoByIp(map);
    }

    @Override
    public List<Map> getInstanceByAuthParam(Map<String, Object> map) {
        return instanceMapper.getInstanceByAuthParam(map);
    }
}
