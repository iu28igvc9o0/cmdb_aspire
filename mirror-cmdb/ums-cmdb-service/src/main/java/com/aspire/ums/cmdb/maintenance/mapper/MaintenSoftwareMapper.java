...
public interface MaintenSoftwareMapper {
     ...
     */
    int saveMaintenSoftwareList( List<MaintenSoftware>  maintenSoftwareList);
     ...
     * @param alerts  
     */
    int deleteMaintenSoftwareIds(List<String>  idList);
     ...
     * @param   
     */
    int getMaintenSoftwareCount(Map<String, Object> hashmap);
     ...
     * @param   
     */
    List<MaintenSoftware> getMaintenSoftwareByPage(Map<String, Object> hashmap);
