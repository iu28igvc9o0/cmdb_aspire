package com.aspire.ums.cmdb.view;
...
public interface ICmdbViewAPI {
     ...
     * 根据viewCode所有节点数据
     */
    @RequestMapping(value = "/getAllNodeData", method = RequestMethod.POST)
    @ApiOperation(value = "根据viewCode所有节点数据", notes = "根据viewCode所有节点数据", tags = {"CMDB VIEW API"})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "查询成功", response = List.class),
            @ApiResponse(code = 500, message = "内部错误")})
    CmdbViewData getAllNodeData(@RequestBody CmdbViewData viewData);
