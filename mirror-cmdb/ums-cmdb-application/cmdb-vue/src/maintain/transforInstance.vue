<template>
<div class="container">
    <el-form :model="ruleForm" ref="ruleForm" :rules="rules"  label-width="150px" class="demo-ruleForm" style="white-space:nowrap;padding-right:30px;padding-left:150px;"  >
        
      <el-form-item label="移交的配置"    prop="instanceData" required>
				    <el-tag
	    ...
	    <el-form-item label="选择目标圈子/仓库"    prop="circleId" required>
         ...
         <el-alert style="padding:2px 0px 2px 0px;left:15%;width: 100px;text-align:right;" align="center"
		    title="配置移交后，归属权为目标圈子所有"
		    type="info"
		    :closable="false"
		    show-icon>
		  </el-alert>
...
default {
    ...
    props: ['multipleSelection','circleId'],
    data() {
            ...
            handleClose(index) {
                ...
                initData() {
                    ...
                    $.ajax({
                        ...
                        for(var i = 0; i < this.ruleForm.selectData.length; i++){
	                        if(this.ruleForm.selectData[i].id==this.circleId){
	                                  this.ruleForm.selectData.splice(i,1);
	                        }
                        }
                    }.bind(this));
                },
