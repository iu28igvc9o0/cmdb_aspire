...
// const prosessArgv = process.argv[3]
// }
// app.use(prosessArgv)
const app = express()
...
if (process.env.NODE_ENV === 'development') {
    ...
    process.env.API_COMPSITE_URL = config.dev.env.API_COMPSITE_URL
    process.env.CMDB_SERVER_URL = config.dev.env.CMDB_SERVER_URL
    process.env.LOGO_SERVER_URL = config.dev.env.LOGO_SERVER_URL
