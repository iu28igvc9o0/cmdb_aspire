...
export default class rbProjectDataServiceFactory {
    ...
    static exportItemList(templateId) {
        let param = {}
    ...
    static async getScriptList(obj) {
        return rbHttp.sendRequest({
            method: 'POST',
            data: obj,
    ...
    static async uploadReport(req) {
        return rbHttp.sendRequest({
            method: 'POST',
            url: '/v1/report/uploadReport',
            data: req
        }).then(function (data) {
            return data
        })
    }
    static async downloadReport(req) {
        return rbHttp.sendRequest({
            method: 'POST',
            url: '/v1/report/downloadReport',
            data: req,
    ...
    static async regenerate(req) {
        return rbHttp.sendRequest({
            method: 'GET',
            url: `/v1/report/regenerate/${req}`
        }).then(function (data) {
            return data
        })
    }
    ...
    static async getItemSelect(str) {
        return rbHttp.sendRequest({
            method: 'GET',
            url: `/v1/task/getItemListByTaskId/${str}`
        }).then(function (data) {
            return data
        })
    }
    // 任务报告
    // 任务报告
    static async getReportBaseInfo(str) {
        return rbHttp.sendRequest({
            method: 'GET',
            url: `/v1/report/getBaseInfo/${str}`
        }).then(function (data) {
            return data
        })
    }
    ...
    static async reportItemList(obj) {
        return rbHttp.sendRequest({
            method: 'POST',
            data: obj,
            url: '/v1/report/reportItem/pageList'
        }).then(function (data) {
            return data
        })
    }
    ...
    // cmdb新增接口获取业务系统 /v1/cmdb/module/module/data?moduleType=default_business_system_module_id
    static async getBusinessSystem(data) {
        return rbHttp.sendRequest({
            method: 'POST',
            params: data,
    ...
    static async alertNotify(obj) {
        return rbHttp.sendRequest({
            method: 'POST',
            data: obj,
            url: '/v2/alerts/alert/emailNotify'
        }).then(function (data) {
            return data
        })
    }
