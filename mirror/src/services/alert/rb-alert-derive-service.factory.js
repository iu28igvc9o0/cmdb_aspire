...
export default class rbAlertderiveServiceFactory {
    ...
    static async getDeriveAlertList(req) {
        return rbHttp.sendRequest({
            method: 'POST',
            url: '/v2/alerts/deriveAlert/list',
            data: req
        }).then(function (data) {
            return data
        })
    ...
    static async exportDeriveAlertList(req) {
        return rbHttp.sendRequest({
            method: 'POST',
            url: '/v2/alerts/deriveAlert/export',
            data: req
        }).then(function (data) {
            return data
        })
    }
    static async getDeriveAlertHistory(req) {
        return rbHttp.sendRequest({
            method: 'POST',
            url: '/v2/alerts/deriveAlertHis/list',
            data: req
        }).then(function (data) {
            return data
        })
    }
    static async exportDeriveAlertHistory(req) {
        return rbHttp.sendRequest({
            method: 'POST',
            url: '/v2/alerts/deriveAlertHis/export',
            data: req
        }).then(function (data) {
            return data
        })
    }
    static async copyDerive(id) {
        return rbHttp.sendRequest({
            method: 'GET',
            url: '/v1/alerts/derive/copyDerive',
            params: {
                'id': id
            }
        }).then(function (data) {
