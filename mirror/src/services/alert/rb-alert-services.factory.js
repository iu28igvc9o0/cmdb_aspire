...
export default class rbAlertServiceFactory {
    ...
    static async sendAlert(params) {
        return rbHttp.sendRequest({
            method: 'POST',
            url: '/v2/alerts/isolateAlert/order',
            data: params
        }).then(function (data) {
            return data
        })
    ...
    // 告警恢复
    static async renewAlert(params) {
        return rbHttp.sendRequest({
            method: 'POST',
            url: '/v2/alerts/isolateAlert/recovery',
            data: params
        }).then(function (data) {
            return data
        })
    ...
    static async alertInfluenceList(request) {
        return rbHttp.sendRequest({
            method: 'GET',
            url: '/v1/alerts_his/alertRelateData',
            params: request
        }).then(function (data) {
            return data
        })
    ...
    // 租户短信通知
    static async smsTenantNotify(page) {
        return rbHttp.sendRequest({
            method: 'POST',
            url: '/v1/alerts/smsTenantNotify',
            data: page
        }).then(function (data) {
            return data
        })
    ...
    static async queryCabinetAlertPageList(page) {
        return rbHttp.sendRequest({
            method: 'POST',
            url: '/v1/alerts/CabinetColumn/queryCabinetAlertPageList',
            data: page
        }).then(function (data) {
            return data
        })
    ...
    static async alertDeviceInformation(request) {
        return rbHttp.sendRequest({
            method: 'GET',
            url: '/v1/alerts/alertDeviceInformation',
            params: request
        }).then(function (data) {
            return data
        })
    ...
    static async remove(params) {
        return rbHttp.sendRequest({
            method: 'DELETE',
            url: '/v2/alerts/isolateAlert/remove',
            data: params
        }).then(function (data) {
            return data
        })
