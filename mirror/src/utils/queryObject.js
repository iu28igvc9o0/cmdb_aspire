export default {
    ...
    methods: {
        ...
        queryUser() {
            ...
            this.$set(this.SelectData, 'person', userInfo.name)
            this.$set(this.SelectData, 'mobile', userInfo.mobile)
            this.$set(this.SelectData, 'province', userInfo['dept_list'][0].uuid)
            sessionStorage.setItem('userInfo', userInfo['dept_id'])
