...
const NAV_ITEM_MONITOR = {
    ...
    children: [{
        ...
        children: [{
            name: '告警扫描对账',
            base: '/scan_comparision',
            routers: [{
                path: '/list',
                name: '扫描对账看板',
                component: 'alert-scan-comparision-list.vue'
            }]
        }]
    }, {
        name: '告警策略管理',
...
const NAV_ITEM_SYSTEM = {
    ...
    },
    {
        ...
        },
        {
            ...
            name: '菜单管理',
            base: 'system_manage/menu',
            routers: [{
                path: '/list',
                name: '菜单管理',
                component: 'menuList.vue'
            }]
        }
            // {
            //   name: '账号',
...
const NAV_ITEM_CONFIG_JIANKONG = {
    ...
    },
    {
        ...
        },
        {
            ...
            base: 'mirror_alert',
            routers: [{
                path: '/net_ performance_analysis',
                name: '网络性能分析',
                component: 'view.vue'
            }]
        }
            ...
            routers: [{
                ...
                children: [{
                    ...
                    routers: [{
                        ...
                        path: '/relateditemsScript',
                        name: '巡检项设置',
                        component: 'relateditemsScript.vue'
                    }, {
                        path: '/addevices',
                        name: '巡检对象设置',
                        component: 'addevices.vue'
...
const NAV_ITEM_OPERATE = {
    ...
    children: [{
        ...
        children: [{
            ...
            base: '/maintenance',
            routers: [{
                path: '/maintenStatistAnalysis',
                name: '维保统计分析',
                component: 'maintenStatistAnalysis.vue'
            }]
        }, {
            name: '维保周期分析',
            base: '/maintenance',
            routers: [{
                path: '/maintenPeriodAnalysis',
                name: '维保周期分析',
                component: 'maintenPeriodAnalysis.vue'
            }]
        }]
    }, {
        name: '后评估管理',
