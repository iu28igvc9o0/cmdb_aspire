    ...
    <div class="component-container"
        ...
        <el-form :model="form"
            ...
            <el-form-item label="命名空间">
                <el-table ref="knamespacesTable"
                    ...
                    <el-table-column type="selection"
                                     width="55"
                                     :selectable="unChecked"></el-table-column>
            ...
            <el-form-item label="镜像项目">
                <el-table ref="registryProjectsTable"
                          :data="registry_projects"
                          stripe
            ...
            <el-form-item>
                <el-button size="small"
                           type="primary"
                           @click="submitForm('form')">更新</el-button>
                <el-button size="small"
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        rbProjectDataService.modifyProject(data).then(() => {
                            this.$message({
                                type: 'success',
                                message: '更新成功'
                            })
