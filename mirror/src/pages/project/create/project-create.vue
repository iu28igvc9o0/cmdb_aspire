<template>
    <div class="component-container"
        ...
        <el-form :model="form"
            ...
            <el-form-item label="项目名称"
                ...
                <el-input v-model="form.name"
                          placeholder="字母开头，字母/数字/中横线， 最多36个字符"
                          size="small"></el-input>
            </el-form-item>
            ...
            <el-form-item label="项目模板"
                ...
                <el-select style="width: 250px;"
                           ...
                           placeholder="请选择模板"
                           @change="changeProjectTemplates"
                           size="small">
                    <el-option v-for="item in projectTemplates"
                               :key="item.value"
                               :label="item.label"
            ...
            <el-form-item label="命名空间">
                <el-table :data="knamespaces"
                          stripe
                          @selection-change="knamespacesSelectionChange"
                    ...
                    <el-table-column prop="name"
                                     label="命名空间"></el-table-column>
                </el-table>
            </el-form-item>

            <el-form-item label="镜像项目">
                <el-table :data="registry_projects"
                          stripe
                          @selection-change="registryProjectsSelectionChange"
                          style="border: 1px solid #F4F4F4">
                    <el-table-column type="selection"
                                     width="55"></el-table-column>
                    <el-table-column prop="parent_name"
            ...
            <el-form-item label="角色">
                <el-table :data="roles"
                          stripe
                          @selection-change="rolesSelectionChange"
                          style="border: 1px solid #F4F4F4">
                    <el-table-column type="selection"
                                     width="55"></el-table-column>
                    <el-table-column label="名称">
                        <template slot-scope="scope">
                            ...
                            <i class="el-icon-view"
                               ...
                               @click="openRolePermissionsPanelDialog(scope.row)"></i>
                        </template>
                    </el-table-column>
                </el-table>
            </el-form-item>
            ...
            <el-form-item>
                ...
                <el-button type="primary"
                           size="small"
                           @click="submitFormForTemplate('form')">另存为模板</el-button>
        ...
        <el-dialog title="角色"
                   :visible.sync="viewRolePermissionsPanelDialogVisible"
                   width="50%"
                   top="5vh">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding-left: 40px">
                        <el-table :data="roleDetailPermissions"
                                  border>
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        rbProjectDataService.createProject(data).then(() => {
                            this.$message({
                                type: 'success',
                                message: '创建成功'
                            })
            ...
            submitFormForTemplate(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        rbProjectDataService.saveAsTemplate(data, { project_name: this.$route.query.project_name }).then(() => {
                            this.$message({
                                type: 'success',
                                message: '另存为模板成功'
                            })
