        ...
        methods: {
                ...
                this.$confirm('是否确认新增？', '提示', {
                    ...
                    this.$refs['addForm'].validate((valid) => {
                        if (valid) {
                            ...
                            rbCmdbServiceFactory.addDiscoveryRule(addData).then(() => {
                                this.getRuleData()
                                this.$message({
                                    message: '新增规则成功',
                                    type: 'success'
            ...
            updateRule (row) {
                this.$confirm(row.enable === '是' ? '确认关闭？' : ' 确认启用', '提示', {
                    ...
                    try {
                        ...
                        rbCmdbServiceFactory.updateRule(data).then(() => {
            ...
            deleteRules () {
                this.$confirm('确认是否删除所选择新发现规则', '提示', {
                    ...
                    try {
                        rbCmdbServiceFactory.deleteRule({moduleId: this.moduleInfo.moduleId, ruleIds: ruleIds}).then(() => {
