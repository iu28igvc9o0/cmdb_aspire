<template>
    <div class="data-box">
        <el-row class="search-box">
            <el-form :model="queryForm"
                ...
                <el-col :span="10"
                    ...
                    <el-col :span="19"
                            class="ip-box">
                        <el-form-item prop="ip.ip1"
                                      :rules="{validator: checkIp}">
                            <el-input style="width: 40px"
                                      v-model="queryForm.ip.ip1"
                                      clearable></el-input><span style="font-weight: bold">.</span>
                        </el-form-item>
                        <el-form-item prop="ip.ip2"
                                      :rules="{validator: checkIp}">
                            <el-input style="width: 40px"
                                      v-model="queryForm.ip.ip2"
                                      clearable></el-input><span style="font-weight: bold">.</span>
                        </el-form-item>
                        <el-form-item prop="ip.ip3"
                                      :rules="{validator: checkIp}">
                            <el-input style="width: 40px"
                                      v-model="queryForm.ip.ip3"
                                      clearable></el-input><span style="font-weight: bold">.</span>
                        </el-form-item>
                        <el-form-item prop="ip.ip4"
                                      :rules="{validator: checkIp}">
                            <el-input style="width: 40px"
                                      v-model="queryForm.ip.ip4"
                                      clearable></el-input><span style="font-weight: bold"> -</span>
                        </el-form-item>
                        <el-form-item prop="ip.ip5"
                                      :rules="{validator: checkIp}">
                            <el-input style="width: 40px"
                                      v-model="queryForm.ip.ip5"
                                      clearable></el-input>
                        </el-form-item>
                    </el-col>
                </el-col>
        ...
        <el-row class="button-box">
            <el-button size="mini"
                       @click="shieldIp()">屏蔽</el-button>
            <el-button size="mini"
                       @click="exportLogs()">导出</el-button>
        </el-row>
        <el-row>
            <el-table v-loading="tableLoading"
                ...
                <el-table-column label="发现类型"
                                 prop="discoveryType"
                                 show-overflow-tooltip></el-table-column>
                <el-table-column label="扫描IP"
                                 prop="instanceName"
                                 show-overflow-tooltip></el-table-column>
                ...
                <el-table-column label="操作状态"
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button type="text"
                                   v-else-if="scope.row.status === '已屏蔽'"
                                   @click="unShield(scope.row)">
                            已屏蔽
                        </el-button>
                            ...
                            <el-col :span="6">
                                <el-tooltip content="维护">
                                    <i class="iconfont"
                                       ...
                                       style="color: #C0C4CC">&#xe647;</i>
                                    <i class="iconfont"
                                       @click="showInstanceDialog(scope.row)"
                                       v-else>&#xe647;</i>
                                </el-tooltip>
                            </el-col>
                            <el-col :span="6">
                            ...
                            <el-col :span="6"
                                ...
                                <el-tooltip content="查看">
                                    <i class="el-icon-view"
                                       @click.stop="showDetailDialog(scope.row)"></i>
                                </el-tooltip>
                            </el-col>
                        </el-row>
                    </template>
        ...
        <el-dialog title="选择要绑定的实例"
            ...
            <el-row type="flex"
                ...
                <el-col :span="20">
                    <el-select v-loading="instanceLoading"
                               v-model="instanceId"
                               filterable
                               style="width: 100%;">
            ...
            <span slot="footer"
                  class="dialog-footer">
                <el-button type="primary"
                           @click="bindInstance()">确 认</el-button>
                <el-button @click="resetBindDialog()">取 消</el-button>
            </span>
        </el-dialog>
        <data-detail-panel :show="showDetail"
                           :detail="currentLog"
                           @setShow="setShow"></data-detail-panel>
        <data-instance-dialog :type="'discovery'"
                              :moduleId="currentModuleId"
                              :show="showInstance"
                              :detail="currentLog"
                              @setShow="setShow"></data-instance-dialog>
    </div>
</template>
