<template>
    ...
    <div class="components-container yw-dashboard"
        ...
        <ul class="conflict-title">
            <li><span>未登记IP总数：</span><span>{{ipCount.numOfUnrecordIp}}</span></li>
        ...
        <el-form class="yw-form"
            ...
            <el-form-item label="VLAN号"
                          prop="vlanNumber">
                <el-input v-model="dialogForm.vlanNumber"
            ...
            <el-form-item label="分配一级业务"
                          prop="firstBusiness">
                <el-select v-model="dialogForm.firstBusiness"
                           multiple
                           collapse-tags
                           clearable
                           placeholder="请选择">
            ...
            <div class="senior-search"
                ...
                <el-form-item label="安全域"
                              prop="safeRegion">
                    <el-select v-model="dialogForm.safeRegion"
                               clearable
                               filterable
                               style="width:120px;"
                               placeholder="请选择">
                        <el-option v-for="item in safeRegionOptions"
                                   :key="item.value"
                                   :label="item.label"
                                   :value="item.value">
                        </el-option>
                ...
                <el-form-item label="是否录入CMDB"
                              label-width="100px"
                              prop="isCmdbManager">
                    <el-select v-model="dialogForm.isCmdbManager"
                               clearable
                               style="width:120px;"
                               placeholder="请选择">
                ...
                <el-form-item label="使用方独立业务"
                              label-width="100px"
                              prop="onlineBusiness">
                    <el-select v-model="dialogForm.onlineBusiness"
                               clearable
                               filterable
                               style="width:120px;"
                               placeholder="请选择">
...
<script>
    ...
    export default {
        name: 'CmdbCmicAuditUnassignedIp',
        data() {
        ...
        created() {
            ...
            this.getSelectValue('safe_region', 'safeRegionOptions')// 安全域
        ...
        methods: {
            ...
            async getTableList(type) {
                ...
                for (let prop in this.dialogForm) {
                    if (prop && prop !== 'time' && prop !== 'operateTime' && prop !== 'assignTime') {
                ...
                try {
                    let res = await rbIpCollectionServiceFactory.unassignedIpSearch(queryData)
            ...
            async tableExport() {
                ...
                queryData.assignTimeEnd = this.dialogForm.assignTime ? this.dialogForm.assignTime[1] : ''
                try {
                    let res = await rbIpCollectionServiceFactory.unassignedIpExport(queryData)
            ...
            async getHandleData(type) {
                ...
                try {
                    let res = await rbIpCollectionServiceFactory.unassignedIpUpdate(queryData)
                    this.$message({
                        message: res.msg,
                        type: 'success'
                    })
            ...
            cellStyle({ row, columnIndex }) {
                if (columnIndex === 14 && row.processingStatus === '0') {
                    return 'color:red;'
                } else {
                    return ''
                }
