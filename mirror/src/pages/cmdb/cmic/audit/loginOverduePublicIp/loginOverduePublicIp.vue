        ...
        <el-form class="yw-form"
            ...
            <div class="senior-search"
                ...
                <el-form-item label="线路类型"
                              prop="circuitType">
                    <el-input v-model="dialogForm.circuitType"></el-input>
                </el-form-item>
...
<script>
    ...
    export default {
        name: 'CmdbCmicAuditLoginOverduePublicIp',
        data() {
        ...
        methods: {
            ...
            async tableExport() {
                ...
                queryData.ipType = '公网IP'
                try {
                    let res = await rbIpCollectionServiceFactory.loginOverduePublicIpExport(queryData)
