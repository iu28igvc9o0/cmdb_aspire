...
<script>
    ...
    export default {
        name: 'CmdbCmicAuditSurvialUnplanPublicIp',
        data() {
        ...
        methods: {
            ...
            async getTableList(type) {
                ...
                try {
                    let res = await rbIpCollectionServiceFactory.survialUnplanPublicIpSearch(queryData)
            ...
            async tableExport() {
                ...
                queryData.operatingTimeEnd = this.dialogForm.operateTime ? this.dialogForm.operateTime[1] : ''
                try {
                    let res = await rbIpCollectionServiceFactory.survialUnplanPublicIpExport(queryData)
