...
<script>
    ...
    export default {
        name: 'CmdbCmicAuditSurvialUnassignIpV6',
        data() {
        ...
        methods: {
            ...
            async getTableList(type) {
                ...
                try {
                    let res = await rbIpCollectionServiceFactory.survialUnassignIpV6IpSearch(queryData)
            ...
            async tableExport() {
                ...
                queryData.operatingTimeEnd = this.dialogForm.operateTime ? this.dialogForm.operateTime[1] : ''
                try {
                    let res = await rbIpCollectionServiceFactory.survialUnassignIpV6IpExport(queryData)
