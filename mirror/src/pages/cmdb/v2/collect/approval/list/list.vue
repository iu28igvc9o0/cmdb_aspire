        ...
        <div class="component-container">
            ...
            <div>
                <el-table :data="changeList"
                    ...
                    <el-table-column prop="instance.ip"
                                     label="管理IP地址"
                                     sortable
                                     min-width="120px"
                                     fixed></el-table-column>
                    <el-table-column prop="cmdbCode.filedName"
                                     label="配置项"
                                     sortable
                                     min-width="120px"
                                     fixed></el-table-column>
                    ...
                    <el-table-column prop="currValue"
                                     sortable
                                     label="变更值"
                                     min-width="100px"></el-table-column>
                    <el-table-column prop="operaterType"
                                     sortable
                                     label="变更类型"
        ...
        methods: {
            ...
            deleteCode() {
                ...
                this.$confirm('确认要删除选中的码表吗?').then(() => {
                    ...
                    cmdbCodeService.deleteCode(this.selectCode).then(() => {
