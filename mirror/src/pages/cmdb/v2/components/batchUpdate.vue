<template>
    <el-dialog class="update-dailog"
               width="70%"
               :visible.sync="show"
               @close="resetShow">
        <el-container>
            <el-aside class="update-left"
                      width="25%">
                <el-input v-model="keyword"
                          placeholder="当前模型实例名称"
                ...
                <el-row class="button-row">
                    ...
                    <el-col :span="8">
                        <el-button type="text"
                                   size="mini"
                                   style="width: 100%"
                                   @click="showImport = true">实例导入</el-button>
                    </el-col>
                    <el-col :span="8">
                        <el-button @click="removeIps"
                                   type="text"
                                   size="mini"
            ...
            <el-main class="update-right">
                ...
                <el-row>
                    <el-row style="border-bottom: 1px solid #F2F6FC; padding-bottom: 20px">
                        <el-col :span="10">
                            <el-col :span="5"
                                    style="line-height: 30px">模型名称</el-col>
                            <el-col :span="15">
                                <!--<el-form-item prop="moduleId">-->
                                <el-select v-model="moduleId">
                                    <el-option :label="moduleInfo.moduleName"
                                               :value="moduleInfo.moduleId"></el-option>
                                </el-select>
                                <!--</el-form-item>-->
                            </el-col>
                        </el-col>
                        <el-col :span="10">
                            ...
                            <el-col :span="15">
                                ...
                                <el-select v-loading="loading"
                                    ...
                                    <div v-for="item in columns"
                                         :key="item.id">
                                        <el-option v-if="item.code !== 'ip' && item.code !== 'Y_name'"
                                                   :key="item.id"
                                                   :label="item.name"
                                                   :value="item">
                                        </el-option>
                            ...
                            <el-col :span="4">
                                <span @click="addFromItem()"
                                      style="font-size: 26px;color: #66b1ff;line-height: 30px">
                        ...
                        <el-scrollbar style="height: 100%;">
                            <el-form :model="updateForm"
                                ...
                                <el-row class="form-panel">
                                    <el-row v-for="item in formItems"
                                            :key="item.id">
                                        <el-col :span="3"
                                                style="line-height: 30px">{{item.name}}</el-col>
                                        <el-col :span="15">
                                            <el-form-item :prop="item.code">
                                                <el-select v-if="item.type === 'listSel'"
                                                           style="width: 100%"
                                                           v-model="updateForm[item.code]"
                                                           clearable>
                                                    <el-option v-for="option in item.formOptions"
                                                               :key="option.id"
                                                               :label="option.name"
                                                               :value="option.value">
                                                    </el-option>
                                                </el-select>
                                                <el-input v-if="item.type === 'singleRowText'"
                                                          style="width: 100%"
                                                          v-model="updateForm[item.code]"></el-input>
                                        ...
                                        <el-col :span="2"
                                                @mouseover.native="showOrDelete(item, true)"
                                                @mouseleave.native="showOrDelete(item, false)">
                                            <div style="width: 100%;height: 30px"
                                                 v-show="!item.del"></div>
                                            <span v-show="item.del"
                                                  @click="removeFormItem(item)"
                                                  style="font-size: 20px;color:#E0E0E0;line-height: 30px">
        ...
        <el-dialog title="导入excel"
            ...
            <span slot="footer"
                ...
                <el-button type="primary"
                           @click="uploadData"
                           class="tem-search1">确认</el-button>
                <el-button type="primary"
    ...
    export default {
        ...
        watch: {
            hideBatchUpdate(val) {
                ...
                this.selectData.forEach((item) => {
                    item.forEach(ip => {
                        if (!Object.prototype.hasOwnProperty.call(map, ip.name)) {
        ...
        methods: {
            ...
            batchUpdate() {
                ...
                rbCmdbServiceFactory.updateByBatch(data).then(() => {
