    ...
    <el-dialog class="yw-dialog"
        ...
        <section class="yw-dialog-main">
            <el-form ref="codeForm"
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item prop="filedCode"
                                      label="字段编码">
                            <el-input v-model="cmdbCode.filedCode"
                    ...
                    <el-col :span="12">
                        <el-form-item prop="filedName"
                                      label="字段名称">
                            <el-input v-model="cmdbCode.filedName"
                                      :disabled="codeId !== ''"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item prop="codeGroup"
                                      label="字段分组">
                            <el-select v-model="cmdbCode.codeGroup"
                                       placeholder="请选择字段分组"
                                       filterable
                    ...
                    <el-col :span="12">
                        <el-form-item prop="customGroup"
                                      label="分组名称">
                            <el-input v-model="cmdbCode.customGroup"
                                      :disabled="!showCustomGroup"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item prop="controlTypeId"
                                      label="控件类型">
                            <el-select v-model="cmdbCode.controlType.controlId"
                                       placeholder="请选择控件类型"
                                       filterable
                                       @change="changeControlType">
                                <el-option v-for="(item, index) in controlList"
                                           :key="index"
                    ...
                    <el-col :span="12"
                            v-show="showSourceType">
                        <el-form-item prop="bindSourceType"
                                      label="数据源类型">
                            <el-select v-model="cmdbCode.bindSourceType"
                                       placeholder="请选择数据源类型"
                                       @change="changeSourceType">
                                <el-option v-for="(item, index) in sourceTypeList"
                                           :key="index"
                                           :label="item.value"
                    ...
                    <el-col :span="12"
                            v-show="showCascader">
                        <el-form-item prop="refCodeId"
                                      label="父码表字段">
                            <el-select v-model="cmdbCode.refCode.codeId"
                                       placeholder="请选择父码表字段"
                                       filterable>
                ...
                <el-row v-show="showCascader || showTableSel">
                    <el-col :span="24"
                            class="sql-box">
                        <el-form-item prop="bindSql"
                                      label="SQL配置"
                                      style="width: 100% !important;">
                            <el-input type="textarea"
                                      :autosize="{ minRows: 4, maxRows: 16}"
                                      placeholder="请输入查询SQL"
                                      v-model="cmdbCode.bindSql"
                                      style="width: 100% !important;">
                            </el-input>
                        </el-form-item>
                    </el-col>
                ...
                <el-row v-show="showTable"
                        v-for="(column, idx) in bindColumns"
                        :key="idx">
                    <el-col :span="12">&nbsp;</el-col>
                    <el-col :span="5">
                        <el-input v-model="bindColumns[idx]['key']"
                                  style="width: 90% !important"></el-input>
                    </el-col>
                    <el-col :span="5">
                        <el-input v-model="bindColumns[idx]['value']"
                                  style="width: 90% !important"></el-input>
                    </el-col>
                    <el-col :span="2">
                ...
                <el-row v-show="showDict">
                    <el-col>
                        <el-form-item prop="bindSource"
                                      label="字典值编码">
                            <el-select v-model="cmdbCode.bindSource"
                                       placeholder="请选择字典值"
                                       filterable>
                                <el-option v-for="(item, index) in dictList"
                                           :key="index"
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item prop="isBuiltIn"
                                      label="是否内置">
                            <el-switch v-model="isBuiltIn"
                                       active-text="是"
                                       inactive-text="否"
                                       active-value="是"
                                       inactive-value="否"
                                       :disabled="isEditBuiltIn"></el-switch>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item prop="isRequire"
                                      label="是否必填">
                            <el-switch v-model="isRequire"
                                       active-text="是"
                                       inactive-text="否"
                                       active-value="是"
                ...
                <el-row v-show="showCollectSource">
                    <el-col :span="12">
                        <el-form-item prop="collectSource"
                                      label="采集数据来源">
                            <el-select v-model="cmdbCode.collectSource"
                                       placeholder="请选择数据来源"
                                       filterable>
                                <el-option v-for="(item, index) in collectSourceList"
                                           :key="index"
                                           :label="item.name"
                    ...
                    <el-col :span="12">
                        <el-form-item prop="collectMapperKey"
                                      label="映射来源字段">
            ...
            submitData() {
                ...
                _t.$refs['codeForm'].validate((valid) => {
                    if (valid) {
                        ...
                        cmdbCodeService.saveCode(_t.cmdbCode).then(() => {
