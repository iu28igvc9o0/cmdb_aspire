    ...
    <div class="components-container yw-dashboard"
        ...
        <el-form class="components-condition yw-form"
            ...
            <el-form-item label="控件编码">
                <el-input v-model="query.controlCode"
                          placeholder="请输入编码"></el-input>
            </el-form-item>
            <el-form-item label="控件名称">
                <el-input v-model="query.controlName"
                        ...
                        <template slot-scope="scope">
                            <div class="yw-table-operator">
                                <el-button type="text"
                                           title="修改"
                                           icon="el-icon-edit"
                                           @click="editControl(scope.row)"></el-button>
                            </div>
                        </template>
                    </el-table-column>
                </el-table>
        ...
        <control-edit v-if="edit.display"
                      :display="edit.display"
                      @setDisplay="setDisplay"
                      :controlId="edit.controlId"></control-edit>
    </div>
</template>
        ...
        methods: {
            ...
            deleteControl() {
                ...
                this.$confirm('确认要删除选中的控件吗?').then(() => {
                    this.loading = true
                    cmdbCodeService.deleteControl(this.selectControls).then(() => {
