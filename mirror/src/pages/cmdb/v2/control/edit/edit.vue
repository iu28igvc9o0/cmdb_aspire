    ...
    <el-dialog class="yw-dialog"
        ...
        <section class="yw-dialog-main">
            <el-form :model="ruleForm"
                     ...
                     label-width="120px">
                <el-form-item prop="controlCode"
                              label="控件编码">
                    <el-input v-model="ruleForm.controlCode"
                              :disabled="controlId !== ''"></el-input>
                </el-form-item>
                <el-form-item prop="controlName"
                              label="显示名称">
                    <el-input v-model="ruleForm.controlName"></el-input>
                </el-form-item>
                <el-form-item prop="isBindSource"
                              label="是否绑定字典值">
                    <el-switch v-model="dictSwitch"
                               active-color="#13ce66"
                               active-text="是"
                               inactive-text="否"
                               active-value="是"
                ...
                <el-form-item prop="sortIndex"
                              label="排序"
                              placeholder="请输入排序序号">
                    <el-input-number v-model="ruleForm.sortIndex"
                                     :min="1"
        ...
        methods: {
            ...
            submit() {
                ...
                this.$refs['ruleForm'].validate(valid => {
                    ...
                    _t.loading = true
                    cmdbCodeService.saveCodeControl(this.ruleForm).then(function () {
