            ...
            getImportProcess(proccessId) {
                ...
                rbCmdbServiceFactory.getImportProcess(proccessId).then((data) => {
                    if (data.flag === 'true') {
                        ...
                        let condicationCode = this.$route.query.condicationCode
                        console.log(condicationCode === 'server_cabinet_list' || condicationCode === 'server_cabinet_bill_conf' || condicationCode === 'server_network_line' || condicationCode === 'server_network_line_bill', 'condicationCode')
                        if (condicationCode === 'server_cabinet_list' || condicationCode === 'server_cabinet_bill_conf' || condicationCode === 'server_network_line' || condicationCode === 'server_network_line_bill') {
