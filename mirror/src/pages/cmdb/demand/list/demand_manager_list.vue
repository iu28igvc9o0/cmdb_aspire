                    ...
                    <el-popover ref="popover"
                        ...
                        <div id="popover"
                            ...
                            <el-checkbox-group v-model="selectColumns"
                                ...
                                <div v-for="(column,columnIndex) in checkColumns"
                                     :key="columnIndex">
            ...
            <div class="yw-el-table-wrap">
                <el-table class="yw-el-table"
                    ...
                    <el-table-column :label="item.label"
                                     ...
                                     :key="index">
                        <template v-if="showGroup(item.key)">
    ...
    export default {
        ...
        methods: {
            ...
            getBizSysList($event) {
                ...
                this.bizSysList = []
                let data = {
                    'department1': this.demand.department1.orgName,
                    'department2': this.demand.department2.orgName
                }
            ...
            handleCheckedColumnChange(val) {
                ...
                cmdbServiceFactory.updateColumnFilter(this.dbFilterData).then(() => { }).catch(() => {
