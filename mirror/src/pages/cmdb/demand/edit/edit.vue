    ...
    <div class="component-container"
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="部门"
                                      prop="department">
                            <el-tooltip :disabled="!demand.department"
                                        :content="demand.department">
                                <el-input v-model="demand.department"
                                          :disabled="true" />
                            </el-tooltip>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="应用系统"
                                      prop="bizSystem">
                            <el-tooltip :disabled="!demand.bizSystem"
                                        :content="demand.bizSystem">
                    ...
                    <el-col :span="8">
                        <el-form-item label="容灾类型"
                            ...
                            <el-radio v-model="demand.disasterType"
                                      label="双活"
                                      :disabled="!control.isDisaster">双活</el-radio>
                            <el-radio v-model="demand.disasterType"
                                      label="异地灾备"
                                      :disabled="!control.isDisaster">异地灾备</el-radio>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="宽带要求"
                            ...
                            <el-input v-model="demand.wlanRequirement"
                                      style="width: 200px"
                                      :disabled="!control.isDisaster"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="资源池要求"
                            ...
                            <el-select style="width: 200px"
                                       ...
                                       placehoder="请选择"
                                       :disabled="!control.isIdcRequirement">
        ...
        <fieldset class="bootstrap-elem-field"
            ...
            <table class="gridtable"
                ...
                <tr>
                    <th colspan="4"
                        style="text-align: left;">{{data.label}}</th>
                </tr>
                <tr>
                    <td width="25%">资源配置</td>
                ...
                <tr v-for="(type, typeIndex) in data.data"
                    ...
                    <td>
                        <el-input v-model="dynamicModel[type.resource_type_id]['count_' + type.resource_type_id]"
                                  @change="validNumber(type.resource_type_id)"></el-input>
                    </td>
                    <td>
