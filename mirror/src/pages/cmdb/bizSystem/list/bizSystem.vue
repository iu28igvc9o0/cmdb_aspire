<template>
    <el-container class="repertory-panel">
        ...
        <el-aside width="20%"
                  class="panel-aside"
                  style="min-width: 150px;max-width: 100%;height: calc(100vh - 136px);"
                  oncontextmenu="self.event.returnValue=false">
            <el-scrollbar style="margin: 20px; min-width: 150px; height: calc(100vh - 180px);">
                <el-tree ref="systemTree"
                ...
                <div ref="menu"
                    ...
                    <ul>
                        <li class="menu__item"
                            @click="editCard"
                            v-show="level !== 1">修改</li>
                        <li class="menu__item"
                            @click="deleteCard"
                            v-show="level !== 1">下线</li>
                        <li class="menu__item"
                            @click="addCard">添加下级业务</li>
                    </ul>
                </div>
            </el-scrollbar>
        </el-aside>
            ...
            <el-row>
                <el-col :span="5">
                    ...
                    <el-select v-model="department1"
                        ...
                        <el-option v-for="(item) in departmentList1"
                                   :key="item.id"
                                   :label="item.orgName"
                                   :value="item">
                        </el-option>
                ...
                <el-col :span="5">
                    ...
                    <el-select v-model="department2"
                               ...
                               placeholder="请选择"
                               value-key="id">
                        <el-option v-for="(item) in departmentList2"
                                   :key="item.id"
                                   :label="item.orgName"
                                   :value="item">
                        </el-option>
                ...
                <el-col :span="5">
                    是否禁用：
                    <el-select v-model="search_isdisable"
                               placeholder="请选择">
                        <el-option label="否"
                                   value="否"></el-option>
                        <el-option label="是"
                ...
                <el-col :span="4">
                    ...
                    <el-button type="primary"
                               size="mini"
                               plain
                               @click="cancel('searchHander')">重置</el-button>
                </el-col>
            </el-row>
            <!--        </el-header>-->
                    ...
                    <el-container>
                        ...
                        <div class="body-container"
                            ...
                            <el-table border
                                ...
                                <el-table-column prop="bizName"
                                                 label="业务名称"
                                                 align="center"
                                                 :show-overflow-tooltip="true"> </el-table-column>
                                <el-table-column prop="orgManager.orgName"
                                                 label="所属组织"
                                                 align="center"
                                                 :show-overflow-tooltip="true"> </el-table-column>
                ...
                <div class="dialog">
                    ...
                    <el-dialog :visible.sync="addDialog"
                        ...
                        <el-form :model="addForm"
                                 ...
                                 label-width="80px"
                                 size="mini">
                            <el-form-item label="上级业务"
                                          prop="">
                                <el-input v-model="addForm.pname"
                                          :disabled="true"
                                          style="width:300px"></el-input>
                            </el-form-item>
                            <el-form-item label="业务名称"
                                          prop="bizName">
                                <el-input v-model="addForm.bizName"
                                          style="width:300px"></el-input>
                            </el-form-item>
                            <el-form-item label="所属组织"
                                          prop="addOrg">
                                <select-tree v-show="level === 1"
                                             v-model="addForm.orgId"
                                             :options="orgTreeData"
                                             :props="defaultOrgProps"
                                             width="300"
                                             :disabled="isAble" />
                                <el-input v-show="level !== 1"
                            ...
                            <el-form-item label="是否禁用"
                                          prop="isdisable">
                                <el-select v-model="addForm.isdisable"
                                           placeholder="请选择"
                                           style="width:300px">
                                    <el-option label="否"
                                               value="否"></el-option>
                            ...
                            <el-form-item>
                                <div class="tableDate">
                                    <div class="table">
                                        <el-table :data="addForm.concatData"
                                                  ref="table"
                                                  tooltip-effect="dark"
                                                  border
                                                  stripe
                                            ...
                                            <el-table-column min-width="15%">
                                                <template slot-scope="scope">
                                                    <i class="el-icon-circle-plus-outline"
                                                       ...
                                                       @click.prevent="addRow('add')"></i>
                                                    <i v-show="addForm.concatData.length > 1"
                                                       class="el-icon-remove-outline"
                                                       style="color: #409eff; font-size:15px;"
                                                       @click.prevent="delData(scope.$index, addForm.concatData)"></i>
                                                </template>
                                            </el-table-column>
                                        </el-table>
                                    </div>
                    ...
                    <el-dialog :visible.sync="updateDialog"
                        ...
                        <el-form :model="updateForm"
                            ...
                            <el-form-item label="上级业务"
                                          prop="pname">
                                <el-input v-model="updateForm.pname"
                                          :disabled="true"
                                          style="width:300px"></el-input>
                            </el-form-item>
                            <el-form-item label="业务名称"
                                          prop="updateBizName">
                                <el-input v-model="updateForm.updateBizName"
                                          style="width:300px"></el-input>
                            </el-form-item>
                            <el-form-item label="所属组织"
                                          prop="">
                                <select-tree v-show="level === 2"
                                             v-model="updateForm.orgId"
                                             :options="orgTreeData"
                                             :props="defaultOrgProps"
                                             width="300" />
                                <el-input v-show="level !== 2"
                                          v-model="updateForm.orgName"
                                          style="width: 300px"
                                          :disabled="isAble" />
                            </el-form-item>
                            <el-form-item label="是否禁用"
                                          prop="updateIsdisable">
                                <el-select v-model="updateForm.updateIsdisable"
                                           placeholder="请选择"
                                           style="width:300px">
                                    <el-option label="否"
                                               value="否"></el-option>
                            ...
                            <el-form-item label="备注"
                                ...
                                <el-input type="textarea"
                                          :rows="2"
                                          v-model="updateForm.updateRemark"
                                          style="width:300px"></el-input>
                            </el-form-item>
                            <el-form-item>
                                <div class="tableDate">
                                    <div class="table">
                                        <el-table :data="updateForm.concatData"
                                                  ref="table"
                                                  tooltip-effect="dark"
                                                  border
                                                  stripe
        ...
        methods: {
            ...
            rightClick(MouseEvent, object, Node) { // 鼠标右击触发事件
                ...
                if (_menu !== undefined) {
                    ...
                    _menu.style.left = MouseEvent.clientX + 'px'
                    _menu.style.top = MouseEvent.clientY - 120 + 'px'
                }
