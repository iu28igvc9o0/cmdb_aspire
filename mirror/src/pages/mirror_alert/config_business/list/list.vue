    ...
    export default {
        ...
        methods: {
            ...
            query(activePagination = false) {
                ...
                rbAlertConfigExceptionServiceFactory.getConfigBusinessList(this.queryParams).then((data) => {
