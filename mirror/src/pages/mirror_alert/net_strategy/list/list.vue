...
<script>
    ...
    export default {
        name: 'MirrorAlertNetStrategyList',
        mixins: [QueryObject],
        components: {
        ...
        data() {
            return {
                ...
                activeName: 'fireWall',
                tabData: [
                    { label: '防火墙', data: '(0)', name: 'fireWall', disabled: false },
                    { label: '负载均衡', data: '(0)', name: 'loadBalance', disabled: true },
                    { label: '公网内外映射', data: '(0)', name: 'publicNet', disabled: true }
                ],
