<template>
    <div class="components-container yw-dashboard">
        <el-form class="components-condition yw-form yw-condition-form"
                 label-width="110px">
            <el-form-item label="当前监控大屏：">
                <el-select v-model="curPanelName"
                           placeholder="请选择"
                           @change="panelChange">
                    <el-option :label="p.panel_name"
                               :value="p.panel_name"
            ...
            <section class="btn-wrap">
                <el-button type="primary"
                           plain
                           @click="createPanel">创建监控大屏</el-button>
                <el-button type="primary"
                           plain
                           @click="editPanel">修改当前大屏</el-button>
                <el-button type="primary"
                           plain
                           @click="delPanel">删除当前大屏</el-button>
                <el-button type="primary"
                           plain
                           @click="savePanel">保存当前大屏</el-button>
                <el-button type="primary"
                           plain
                           @click="copyPanel">拷贝当前大屏</el-button>
            </section>
        </el-form>
        <el-form class="yw-form clearfix"
            ...
            <el-form-item label>
                <el-button class="btn-time"
                           ...
                           style="margin: 0px;"
                           type="text"
                           @click="getDataByTime(1,'hour')">1小时</el-button>
                <el-button class="btn-time"
                           :class="(timeRange + timeUnit) == '3hour' ? 'active' : 'normal'"
                           type="text"
                           @click="getDataByTime(3,'hour')">3小时</el-button>
                <el-button class="btn-time"
                           :class="(timeRange + timeUnit) == '6hour' ? 'active' : 'normal'"
                           type="text"
                           @click="getDataByTime(6,'hour')">6小时</el-button>
                <el-button class="btn-time"
                           :class="(timeRange + timeUnit) == '12hour' ? 'active' : 'normal'"
                           type="text"
                           @click="getDataByTime(12,'hour')">12小时</el-button>
                <el-button class="btn-time"
                           :class="(timeRange + timeUnit) == '1day' ? 'active' : 'normal'"
                           type="text"
                           @click="getDataByTime(1,'day')">1天</el-button>
                <el-button class="btn-time"
                           :class="(timeRange + timeUnit) == '3day' ? 'active' : 'normal'"
                           type="text"
                           @click="getDataByTime(3,'day')">3天</el-button>
                <el-button class="btn-time"
                           :class="(timeRange + timeUnit) == '7day' ? 'active' : 'normal'"
                           type="text"
                           @click="getDataByTime(7,'day')">7天</el-button>
                <!--<el-button
          class="btn-time"
        ...
        >14天</el-button>-->
            ...
            <div class="fr">
                <el-button type="primary"
                           size="mini"
                           plain
                           @click="refreshPanel">刷新</el-button>
                <el-button type="primary"
                           size="mini"
                           plain
                ...
                <grid-layout :layout="layout"
                    ...
                    <grid-item v-for="item in layout"
                        ...
                        <div :id="item.itemId"
                             ...
                             style="width: calc(100% - 20px);overflow:hidden;min-height:178px;height:100%;box-sizing:border-box;padding:5px 0px 5px 5px;float:left"></div>
                        <el-dropdown v-show="showDrop"
                                     :hide-on-click="false"
                                     @command="handleCommand">
                            <span class="el-dropdown-link">
                                <i class="el-icon-caret-bottom el-icon--right"
                                   style="float:left;width:20px;margin:4px 0px 0;cursor:pointer"></i>
                            </span>
        ...
        <el-dialog title="选择监控项"
            ...
            <section class="yw-dialog-main">
                <el-form class="yw-form"
                    ...
                    <el-form-item label="设备分类"
                                  prop="deviceClass">
                        <el-select v-model="moniterForm.deviceClass"
                                   placeholder="选择设备分类"
                    ...
                    <el-form-item class="yw-form"
                                  label="设备类型"
                                  prop="deviceType">
                        <el-select :disabled=deviceTypedisabled
                    ...
                    <el-form-item class="yw-form"
                                  label="监控项"
                                  prop="moniter">
                        <el-cascader v-model="moniterForm.moniter"
                                     :options="moniterList"
                                     clearable
                                     placeholder="监控逻辑/监控指标"
                                     class="input-tem-name1"
                                     style="width: 200px;line-height: 35px;"
                                     @change="onMoniterChange"></el-cascader>
                    </el-form-item>
                </el-form>
            </section>
            <div v-if="moniterForm.showIp"
                 class="table-wrap">
                <div class="table-wrap__left">
                    ...
                    <el-table class="table-wrap__table"
                              :data="deviceTable"
                    ...
                    <el-pagination @size-change="onSizeChange"
                                   ...
                                   class="table-wrap__pagination"></el-pagination>
                </div>
                        ...
                        <el-table-column>
                            <template slot-scope="scope">
                                <i class="el-icon-delete"
                                   ...
                                   @click="removeDeviceItem(scope.row)"></i>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
            ...
            <div class="btn-group">
                <el-button type="primary"
                           @click="dofilterChoose()">确定</el-button>
        ...
        <el-dialog class="yw-dialog"
            ...
            <div>
                ...
                <section class="dashboard-section">
                    ...
                    <div class="dashboard-content"
                        ...
                        <el-form class="yw-form yw-select-form"
                                 ...
                                 :inline="true"
                                 :model="m">
                            <el-button style="bottom:51px;"
                                       class="dashboard-btn"
                                       type="primary"
                                       size="mini"
                                       plain
                                       @click="copyMoniter(index)">拷贝</el-button>
                            <el-button class="dashboard-btn"
                                       v-if="index > 0"
                                       type="primary"
                                       size="mini"
                                       plain
                                       @click="delMoniter(index)">删除</el-button>
                            <el-form-item prop="m.resource_device"
                                          label="资源设备"
                                          :rules="{
                                              required: true, message: '不能为空', trigger: 'blur'
                                          }">
                                <el-tooltip :content="m.resource_device"
                                            placement="top">
                                    <el-input v-model="m.resource_device"
                                              placeholder="请选择"
                                              :disabled="true"></el-input>
                                </el-tooltip>
                                <el-button class="ml-5"
                                           type="primary"
                                           @click="choose(index)">选择</el-button>
                            </el-form-item>
                            <el-form-item prop="m.moniter_item_name"
                                          label="监控项"
                                          :rules="{
                                              required: true, message: '不能为空', trigger: 'blur'
                                          }">
                                <el-tooltip :content="m.moniter_item_name"
                                            placement="top">
                                    <el-input v-model="m.moniter_item_name"
                                              placeholder="请选择"
                                              :disabled="true"></el-input>
                                </el-tooltip>
                                <el-button type="primary"
                                           @click="chooseMoniter(index,m)">选择</el-button>
                                <span v-if="m.moniter_item">&nbsp;&nbsp;&nbsp;&nbsp;单位：{{m.unit}}</span>
                            </el-form-item>
                            <br />
                            <el-form-item prop="m.count_type"
                                          label="统计方式"
                                          :rules="{
                                              required: true, message: '不能为空', trigger: 'blur'
                                          }">
                                <el-select v-model="m.count_type"
                                           placeholder="请选择"
                                           @change="countTypeChange(index)">
                                    <el-option label="最大"
                                               value="max"></el-option>
                                    <el-option label="最小"
                                               value="min"></el-option>
                            ...
                            <el-form-item prop="m.view_name"
                                          label="展示名称"
                                          :rules="{
                                              required: true, message: '不能为空', trigger: 'blur'
                                          }">
                                <!-- <el-input v-model="m.view_name"
                                          placeholder></el-input> -->
                                <el-tooltip :content="m.view_name"
                                            placement="top">
                                    <el-input v-model="m.view_name"
                    ...
                    <div style="margin-left: 30px;">
                        <el-button type="primary"
                                   ...
                                   size="mini"
                                   plain
                                   @click="addMoniter()">新增监控指标</el-button>
                    </div>
                </section>
                ...
                <section class="dashboard-section">
                    ...
                    <div class="dashboard-content">
                        <el-form class="components-condition yw-form yw-chart-form is-required"
                                 label-width="70px"
                                 :inline="true"
                                 :model="item">
                            <el-form-item prop="item.report_name"
                                          label="图表名称"
                                          :rules="{
                                              required: true, message: '不能为空', trigger: 'blur'
                                          }">
                                <el-input v-model="item.report_name"
                                          placeholder></el-input>
                            </el-form-item>
                            <el-form-item prop="item.time_value"
                                          label="时间刻度"
                                          :rules="{
                                              required: true, message: '不能为空', trigger: 'blur'
                                          }">

                                <el-input-number v-model="item.time_value"
                                                 :min="1"></el-input-number>
                                <el-select style="width:120px"
                                           v-model="item.time_unit"
                                           placeholder="请选择">
                                    <el-option label="分钟"
                            ...
                            <el-form-item label="显示单位">
                                <el-input v-model="item.report_unit"
                                          placeholder></el-input>
                            </el-form-item>
                            <el-form-item label="换算">
                                <el-select style="width:120px"
                                           v-model="item.conversion_type"
                                           placeholder="请选择">
                                    <el-option label="相乘"
                                               value="1"></el-option>
                                    <el-option label="相除"
                                ...
                                <el-input type="number"
                                          v-model="item.conversion_val"
                                          style="width:150px;" />
                                <el-select style="width:120px"
                                           v-model="transunit"
                                           @change="transunitChange"
                                           placeholder="请选择"
                            ...
                            <section class="btn-wrap">
                                ...
                                <el-button size="mini"
                                           @click="cancleItem">取消</el-button>
                                <el-button size="mini"
                                           @click="previewItem">预览</el-button>
                            </section>
                        </el-form>
                        <div>
                            <fullscreen class="wrapper"
                                ...
                                <grid-layout :layout="itemLayout"
                                             ...
                                             :vertical-compact="true"
                                             :use-css-transforms="true">
                                    <grid-item v-for="item in itemLayout"
                                               class="showBorder"
                                        ...
                                        <div :id="item.itemId"
                                             style="width: calc(100% - 20px);overflow:hidden;min-height:178px;height:100%;box-sizing:border-box;padding:5px;float:left"></div>
                                    </grid-item>
                                </grid-layout>
                            </fullscreen>
                        </div>
        ...
        <el-dialog :title="operFlag == 'edit'?'修改大屏':'创建大屏'"
                   :visible.sync="addPanelVisible"
                   :close-on-click-modal="false"
                   width="60%">
            <el-row>
                <el-col :span="12">
                    <el-input v-model="newPanelName"
                              style="width:300px;"
                              prop="输入新监控大屏名称"></el-input>
                </el-col>
                <el-col :span="12">
                    访问分享 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <template v-if="operFlag == 'edit'">
                        <el-radio v-model="accessType"
                                  :disabled="(!allFlag? allFlag : (user !== panel.creater))"
                                  label="1">私人</el-radio>
                        <el-radio v-model="accessType"
                                  label="2">组内分享</el-radio>
                        <el-radio v-model="accessType"
                                  label="3">全部分享</el-radio>
                    </template>
                    <template v-else>
                        <el-radio v-model="accessType"
                                  label="1">私人</el-radio>
            ...
            <el-row style="margin-top:10px;">
                <el-col :span="12"
                        :offset="8">
                    <el-button v-if="operFlag == 'edit'"
                               class="tem-search"
                               @click="doCreate">保存</el-button>
                    <el-button v-else
                               class="tem-search"
                               @click="doCreate">创建</el-button>
                    <el-button class="tem-search"
                               @click="cancleCreate">关闭</el-button>
                </el-col>
            </el-row>
        </el-dialog>
        ...
        <DialogSearch v-if="dialogMsg.dialogVisible"
                      ...
                      @setData="setData"></DialogSearch>

        <!-- 服务器弹框 -->
        <DialogTheServer v-if="theServer.dialogVisible"
                         :theServer="theServer"
                         @dataTreeData='dataTreeData'></DialogTheServer>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        components: {
            ...
            DialogTheServer: () => import('../theServer/theServer.vue')
        },
        data() {
            return {
                theServer: {
        ...
        methods: {
            ...
            dataTreeData(val) {
                ...
                val.forEach((itemA) => {
                    this.item.moniterItems.push({
                        moniter_item_name: itemA.label,
                        count_type: itemA.count_type,
                        resource_device: itemA.ip,
                        device_type: itemA.device_type,
                        device_class: itemA.device_class,
                        // moniter_item: itemA.unit ? itemA.unit : '', // 控制单位显示隐藏
                        unit: itemA.unit ? itemA.unit : '', // 控制单位显示隐藏
                        view_name: itemA.label + '(' + itemA.view_name + ')',
                        mointer_index: itemA.valueType,
                        resource_type: '6',
                        sub_moniter_items: itemA.value,
                        noSubItemIds: itemA.noSubItemIds,
                        moniter_item: itemA.value, // 新加参数
                    })
                })
                console.log('111', this.item.moniterItems)
                let objTiLing = this.item.moniterItems.filter((item) => {
                    return item.resource_device
                })
                this.item.moniterItems = objTiLing
            },
            poolClick() { // 资源池弹框
                this.theServer.dialogVisible = true
            },
            transunitChange(val) {
                if (val) {
                    let v = val.split('_')
      ...
      rbAlertRepPanelServicesFactory.getMonitorItem(obj).then((res) => {
          ...
          rs.forEach(item => {
            ...
            async onMoniterChange(value) {
                ...
                let data = {
                    ...
                    ip: moniterItem.resource_device.split(','),
                    reType: type,
                    item: value[1],
                    multiQuery: false
                }
                ...
                rbAlertRepPanelServicesFactory.getMonitorItemList(data).then((res) => {
                    ...
                    this.moniterForm.unit = res && res.units
            ...
            dofilterChoose() {
                ...
                this.keepViewName = this.moniterForm.monitorItemName
                if (moniterItem.count_type) {
                    moniterItem.view_name += '(' + moniterItem.count_type + ')'
                }
                moniterItem.moniter_item = this.moniterForm.moniter[1]
                moniterItem.subclass = this.moniterForm.moniter[0]
                moniterItem.unit = this.moniterForm.unit || this.item.moniterItems[0].unit
                ...
                if (this.moniterIndex == 0) {
                    this.item.report_name = moniterItem.device_class + moniterItem.device_type + this.keepViewName
                    this.item.report_unit = moniterItem.unit
                    // 设置转化单位
                    this.setUnitList(moniterItem.unit)
                }
                // 服务器方式(noSubItemIds==='1')： sub_moniter_items (subItemIds) 需设置为空
                if (this.deviceSelection && this.deviceSelection.length > 0 && !moniterItem.noSubItemIds) {
                    let val = ''
            ...
            // 选择监控项时
            async chooseMoniter(index, itemInfo) {

                if (!(this.item.moniterItems[index].resource_device)) {
                    this.$message.warning('请先选择资源设备！')
                    return
                }
                this.setTable()
                ...
                if (moniterItem.subclass && moniterItem.moniter_item) {
                    ...
                    this.onMoniterChange(this.moniterForm.moniter)
                }
                // 还原监控项
                this.moniterForm.moniter = itemInfo.moniter_item
            ...
            countTypeChange(index) {
                let itemInfo = this.item.moniterItems[index]
                if (itemInfo.view_name) {
                    // console.log('0000000', itemInfo.view_name, itemInfo.view_name.slice(0, itemInfo.view_name.lastIndexOf('(')))
                    itemInfo.view_name = itemInfo.view_name.slice(0, itemInfo.view_name.lastIndexOf('('))
                    itemInfo.view_name += '(' + itemInfo.count_type + ')'
                }
            },
            panelChange(val) {
                if (this.modifyFlag) {
          ...
          myChart.resize()
            ...
            doCreate() {
                ...
                if (this.operFlag == 'add' || this.operFlag == 'copy') {
                    ...
                    if (this.panel.panel_name == this.newPanelName) {
                        rbAlertRepPanelServicesFactory.update(this.panel).then(() => {
            ...
            copyPanel() {
                if (!this.curPanelName) {
                    this.$message.warning('请选择要拷贝的大屏！')
                    return
                }
                this.operFlag = 'copy'
                this.addPanelVisible = true
        ...
        return
            ...
            setLayout(showItems) {
                ...
                if (this.itemList.length > 0) {
                    ...
                    showItems.forEach(s => {
                        let itemId = s.itemId
                        if (tt.includes(itemId) && !ss.includes(itemId)) {
                            list.push(s)
                            ss.push(itemId)
                        }
                    })
            ...
            initPanelInfo() {
                ...
                if (this.panel.show_item) {
                    ...
                    this.initLayout = JSON.parse(this.panel.show_item)
                }
                ...
                if (this.panel.show_item) {
                    showItems = JSON.parse(this.panel.show_item)
                    this.layout = this.setLayout(showItems)
                }
                // this.layout = showItems
                this.$forceUpdate()
                this.$nextTick(() => {
            ...
            loadReport(item, id, flag) {
                ...
                item.moniterItems.forEach(function (e) {
                    let dataSet = {
                        ...
                        subItemIds: !e.noSubItemIds ? e.sub_moniter_items : '',
        ...
        this.$message.error('图表刷新失败')
            ...
            savePanel(flag) {
                this.panel.show_item = JSON.stringify(this.setLayout(this.layout))
            ...
            delPanel() {
                this.$confirm('删除视图组后相应的视图也将会删除，确认删除该视图组吗？', '删除', {
                    ...
                    rbAlertRepPanelServicesFactory.delete(this.panel.id).then(() => {
            ...
            copyMoniter(index) {
                ...
                let itemOld = this.item.moniterItems[index]
                let itemNew = JSON.parse(JSON.stringify(itemOld))
                if (this.item.moniterItems.length - index <= 1) {
                    this.item.moniterItems.push(itemNew)
                }
            ...
            addMoniter() {
                this.item.moniterItems.push({ view_name: '', moniterItemList: [] })
                this.$forceUpdate()
            },
            addItem() {
                if (!this.curPanelName) {
                ...
                this.item.report_name = ''
                this.item.report_unit = ''
                this.unitList = []
                this.item.moniterItems.push({ view_name: '', moniterItemList: [] })
                this.$forceUpdate()
            },
            ...
            resizedEventItem: function (i, newH, newW) {
            ...
            resizedEvent: function (i, newH, newW) {
                ...
                this.initLayout.forEach(item => {
                    if (item.i == i) {
                        // debugger
                        if (newH !== item.h || newW !== item.w) {
                            this.modifyFlag = true
                        }
                    }
                })
        ...
        return res
            ...
            loadIndex(item, reportType) {
                ...
                var lineOption = {
                    ...
                    series: [{ name: '邮件营销', type: 'line', stack: '总量', data: [120, 132, 101, 134, 90, 230, 210] }, { name: '联盟广告', type: 'line', stack: '总量', data: [220, 182, 191, 234, 290, 330, 310] }]
                }
                ...
                var barOption = {
                    ...
                    series: [{ name: '直接访问', type: 'bar', data: [320, 332, 301, 334, 390, 330, 320] }, { name: '邮件营销', type: 'bar', stack: '广告', data: [120, 132, 101, 134, 90, 230, 210] }]
                }
                if (reportType == 'line') {
                    myChart.setOption(lineOption)
                    // eslint-disable-next-line no-undef
