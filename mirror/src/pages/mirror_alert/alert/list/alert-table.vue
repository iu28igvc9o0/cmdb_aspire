        ...
        <el-form class="yw-form">
            <div class="table-operate-wrap clearfix">
                <section class="fr">
                    ...
                    <el-button class="btn-icons-wrap"
                               v-popover:popover>选择列&nbsp;&nbsp;&nbsp;<i class="el-icon-arrow-down"></i></el-button>
                ...
                <el-button class="btn-icons-wrap"
                           type="primary"
                           @click="confirmDialog"
                           v-if="alertType === 'observe'">待观察</el-button>
                <el-button class="btn-icons-wrap"
                           type="primary"
            ...
            <div class="yw-el-table-wrap ywTabBorder">
                <el-table border
                    ...
                    <el-table-column prop="moni_index"
                                     ...
                                     sortable>
                        <template slot-scope="scope">
                            <span style="color:#0060DF">{{scope.row.moni_index}}</span>
                        </template>
                    </el-table-column>
              ...
              >{{scope.row.order_id}}</el-button> -->
                            ...
                            <span @click="gotoBPM(scope.row.order_id)"
                                  style="color:#0060DF">{{scope.row.order_id}}</span>
                        </template>
                    </el-table-column>
                    <div v-for="itemData in checkColumns"
                         :key="itemData.keyName">
                        <el-table-column v-if="itemData.keyIsSelected"
                                         :label="itemData.keyName"
                                         :prop="itemData.keyCode"
                                         sortable
                                         :show-overflow-tooltip="true"
                                         :width="flexColumnWidth(itemData.keyCode) ? flexColumnWidth(itemData.keyCode) : '250px'"></el-table-column>
                    </div>
...
<script>
    import { alert_level, alert_type, relation } from '../../alert_his/config/options.js'
    ...
    export default {
        ...
        props: ['alertType', 'alertLevel_default', 'queryDatas', 'queryDatasFile'],
        data() {
            return {
        ...
        methods: {
            ...
            handleSizeChange(val) {
                ...
                if (this.queryDataParameterFile.condition) {
                    ...
                    this.queryDataParameter.page_no = val
