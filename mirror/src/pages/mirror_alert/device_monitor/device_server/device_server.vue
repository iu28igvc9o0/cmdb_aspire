...
<script>
    ...
    export default {
        ...
        components: {
            ...
            ModuleData: () => import('../module-data.vue'),
            ModuleGauge: () => import('../module-gauge.vue'),
            TrendCpu: () => import('./trend-cpu.vue'),
            TrendDisk: () => import('./trend-disk.vue'),
            TrendMemory: () => import('./trend-memory.vue'),
            TrendSysLoad: () => import('./trend-sysLoad.vue'),
            TrendBandWidthIn: () => import('./trend-bandWidth-in.vue'),
            TrendBandWidthOut: () => import('./trend-bandWidth-out.vue'),
        },
        data() {
            return {
                // 表单数据
