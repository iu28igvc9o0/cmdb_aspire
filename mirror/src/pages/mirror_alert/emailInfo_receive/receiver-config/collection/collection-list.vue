<template>
    <div class="component-container">
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <div>
                        ...
                        <span>
                            <el-date-picker v-model="send_time_range"
                                            type="daterange"
                                            range-separator="至"
                                            start-placeholder="开始日期"
                                            end-placeholder="结束日期"
            ...
            <el-row style="margin-top: 10px;">
                <el-col :span="12">
                    <div>
                        ...
                        <span>
                            <el-input v-model="title_include"
                                      placeholder="请输入内容"
                ...
                <el-col :span="12">
                    <div>
                        ...
                        <span>
                            <el-input v-model="content_include"
                                      placeholder="请输入内容"
                                      class="input-tem-name1"
                                      style="width:375px;"
                                      clearable></el-input>
        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="resolve_time"
                             label="采集时间"
                             align="center">
            ...
            <el-table-column prop="mail_content"
                             label="邮件信息"
                             align="center">
                <template slot-scope="scope">
                    <el-row>
                    ...
                    <el-row>
                        ...
                        <el-col :span="18"
                                style="text-align: left"
                                v-html="scope.row.mail_content"></el-col>
                    </el-row>
                </template>
            </el-table-column>
            <el-table-column prop="moni_index"
                ...
                <template slot-scope="scope">
                    ...
                    <el-row>
                        ...
                        <el-col :span="18"
                                style="text-align: left">
                            {{alert_level_obj[scope.row.alert_level].name}}
                        </el-col>
                    </el-row>
                </template>
            </el-table-column>
            <el-table-column prop="alert_id"
                             label="关联告警"
                             align="center">
            </el-table-column>
        </el-table>
