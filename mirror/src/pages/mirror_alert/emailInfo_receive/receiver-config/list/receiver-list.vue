<template>
    <div class="component-container">
        <header>
            <div class="dataTime">
                ...
                <div class="creat-time"
                     style="margin-left: 80px;">采集状态：</div>
            ...
            <div class="dataTime"
                ...
                <el-button class="tem-search"
                           @click="create"
                           style="margin-left: 0px;">新增</el-button>
                <el-button class="tem-search"
        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="title_include"
                             label="邮件标题过滤"
                             align="center">
            </el-table-column>
            <el-table-column prop="content_include"
                             label="邮件内容过滤"
                             align="center">
            </el-table-column>
            ...
            <el-table-column prop="last_send_time"
                             label="最新发件时间"
                             align="center">
                <template slot-scope="scope">
            ...
            <el-table-column prop="times"
                ...
                <template slot-scope="scope">
                    <a href="#"
                       @click="gotoScene(scope.row.id)">{{scope.row.times}}</a>
                </template>
            </el-table-column>
        ...
        <el-dialog :visible.sync="editFlag"
            ...
            <el-form ref="form"
                ...
                <el-row style="margin: 0px;padding: 0px;">
                    <el-col :span="8"
                        ...
                        <el-form-item style="margin-bottom: 0px">
                            <span slot="label"
                                  style="font-size: 16px;">过滤设置</span>
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="邮件标题"
                                      style="margin-bottom: 0px"
                                      prop="title_include">
                            <el-input v-model="form.title_include"
                                      style="width: 200px"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="邮件内容"
                            ...
                            <el-input v-model="form.content_include"
                                      style="width: 200px"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row style="margin: 0px;padding: 0px;">
                    <el-col :span="8"
                        ...
                        <el-form-item style="margin-bottom: 0px;margin-top: 0px;">
                            <span slot="label"
                                  style="font-size: 16px;">告警映射</span>
                            <hr style="color: #ebe9e9; width: 100%;" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="16"
                ...
                <el-row v-for="(row, index) in row1List"
                        :key="index">
                    <el-col :span="13">
                        <el-form-item :label="row.name">
                            <el-select v-model="row.type"
                                       placeholder="请选择"
                                       class="input-tem-name1"
                                       @change="sourceChange(row, index)"
                                       style="width: 150px;float: left;margin-right: 5px;">
                                <el-option label="自定义"
                                           value="1"></el-option>
                                <el-option label="邮件信息"
                                           value="2"></el-option>
                            </el-select>
                            <div v-if="row.type === '2'"
                                 style="float: left">
                                <el-select v-model="row.content"
                                           placeholder="请选择"
                                           class="input-tem-name1"
                                           clearable
                                           style="width: 200px">
                            ...
                            <div class="my-error-tip data-filter-error"
                                 v-if="validationPhase.isValidating && (!row.content)"
                                 style="margin-left: 155px;">此处不能为空</div>
                        </el-form-item>
                    </el-col>
                    <el-col :span="11"
                            v-if="(row.type === '2') && !row.isLevel">
                        <el-row>
                            <el-col :span="12">
                                <el-checkbox v-model="row.flag"
                                             style="line-height: 30px;float: right;padding-right: 5px;">正则匹配</el-checkbox>
                            </el-col>
                            <el-col :span="12">
                                <el-input v-model="row.rule"
                                          style="width: 200px;float: left"></el-input>
                                <div class="my-error-tip data-filter-error"
                                     v-if="row.flag && (!row.rule)">此处不能为空</div>
                            </el-col>
                        </el-row>
                    </el-col>
                    <el-col :span="11"
                        ...
                        <el-row>
                            <el-col :span="12">
                                <div class="my-error-tip data-filter-error"
                                     v-if="validationPhase.isValidating && (!row.rule)"
                                     style="margin-left: 20%;">此处不能为空</div>
                                <el-input v-model="row.rule"
                                          style="width: 150px;float:right;"></el-input>
                                <label style="float: right;width: 40px;line-height: 30px;font-weight:normal;padding-right: 0px;">包含</label>
                            </el-col>
                            <el-col :span="12">
                                <img src="/static/img/alert/to.png"
                                     style="float: left;" />
                                <el-select v-model="row.level"
                                           placeholder="请选择"
                                           class="input-tem-name1"
                                           clearable
                                           style="width: 124px;float: left">
                                    <el-option label="重大"
                                               value="5"></el-option>
                                    <el-option label="高"
                                               value="4"></el-option>
                                ...
                                <div class="my-error-tip data-filter-error"
                                     v-if="validationPhase.isValidating && (!row.level)"
                                     style="margin-left: 76px;">此处不能为空</div>
                            </el-col>
                        </el-row>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <label class="el-form-item__label"
                               style="width: 120px;float: left">告警字段</label>
                        <el-select v-model="addColVal"
                                   placeholder="请选择"
                                   class="list-sel"
                                   clearable
                                   filterable
                                   style="width: 150px;float: left">
                            <el-option :label="row.name"
                                       :value="row.code"
                                       v-for="(row, index) in alertEmailCol"
                                       :key="index"></el-option>
                        </el-select>
                        <img src="/static/img/alert/filter-add.png"
                             @click="addRow2()"
                             class="data-filter-col-add"
                             style="float: left;height: 25px;line-height: 25px;margin-left: 5px;" />
                    </el-col>
                </el-row>
                <div style="background-color: #f9fafc;padding-top: 5px;padding-bottom: 10px;">
                    <el-row v-for="(row, index) in row2List"
                            :key="index">
                        <el-col :span="13">
                            <el-form-item :label="row.name">
                                <el-select v-model="row.type"
                                ...
                                <el-input v-model="row.content"
                                          ...
                                          v-else
                                          style="width: 200px;float: left"></el-input>
                                <img src="/static/img/alert/filter-delete.png"
                                     v-if="row.type === '1'"
                                     @click="deleteRow2(index)"
                                     class="data-filter-col-add"
                                     style="height: 30px;line-height: 30px;margin-left: 5px;margin-top:5px;float: left;" />
                                <div class="my-error-tip data-filter-error"
                                     v-if="validationPhase.isValidating && (!row.content)"
                                     style="margin-left: 155px;">此处不能为空</div>
                            </el-form-item>
                            ...
                            <el-row>
                                ...
                                <el-col :span="12">
                                    ...
                                    <img src="/static/img/alert/filter-delete.png"
                                         @click="deleteRow2(index)"
                                         class="data-filter-col-add"
                                         style="height: 30px;line-height: 30px;margin-left: 5px;float: left;" />
                                    <div class="my-error-tip data-filter-error"
                                         v-if="row.flag && (!row.rule)">此处不能为空</div>
                                </el-col>
                            </el-row>
    ...
    export default {
      ...
      let filterId = this.$route.query.filterId */
        ...
        methods: {
            ...
            submitForm() {
                if ((!this.form.sender || typeof this.form.sender === 'undefined') &&
                    (!this.form.title_include || typeof this.form.title_include === 'undefined') &&
                    (!this.form.content_include || typeof this.form.content_include === 'undefined') &&
                    (!this.form.name || typeof this.form.name === 'undefined')) {
                    this.$message.error('(发件人邮箱/邮件标题/邮件内容)数据未填写,不能保存')
                } else {
            ...
            search() {
                let page = {
                    ...
                    recipientId: this.recipientId ? parseInt(this.recipientId) : null,
                    sender: this.sender,
                    active: this.active
                }
                if (!this.active) {
            ...
            deleteBatch() {
                ...
                this.$confirm('删除告警接入?', '删除', {
                    ...
                    rbEmailReceiverServicesFactory.delete(ids).then(() => {
