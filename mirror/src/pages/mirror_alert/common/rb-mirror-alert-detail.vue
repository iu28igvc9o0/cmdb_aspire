                ...
                <el-form class="yw-form form-details"
                    ...
                    <el-form-item label="设备名称">
                        <div>
                            ...
                            <span v-if="isDeviceDetailShow"><a style="text-decoration: none;cursor:pointer"
                                   @click="toDeviceDetail()">设备详情</a></span>
                        </div>
                    </el-form-item>
                    ...
                    <el-form-item label="工单编号">
                        <a style="text-decoration: none;cursor:pointer"
                           @click="gotoBPM(obj['order_id'])">{{obj['order_id']}}</a>
                    </el-form-item>
                ...
                <el-tabs class="yw-tabs"
                    ...
                    <el-tab-pane label="影响范围"
                        ...
                        <rb-mirror-alert-influence v-if="tableList.ele.flag"
                                                   :alertId="obj.alert_id"></rb-mirror-alert-influence>
                    </el-tab-pane>
        ...
        methods: {
            ...
            alertDetailInit() {
                if (this.detailType === 'alert') {
                    console.log('1111111111当前告警', this.alertId)
