<template>
    <div>
        <div>
            <div>
                <div><span style="font-size:18px;">日志记录总数:{{total}}</span></div>
                <div style="float: left;">
                    <el-form :inline="true">
                        ...
                        <el-form-item label="不包含关键字:">
                            <YwInputAdd :keys="noIncludeKey"
                                        :activeKey="noIncludeActiveKey"
                                        @changeKey="changeNoIncludeKey"
                                        style="width: 300px"></YwInputAdd>
                        </el-form-item>
                    </el-form>
                </div>
                ...
                <!--<el-col :span="3"><div><span style="font-size:18px;">日志记录总数:{{total}}</span></div></el-col>-->
                <!--<el-col :span="16">-->
                <!--<div>-->
                <!--<el-form :inline="true" >-->
                <!--<el-form-item label="日志时间范围:">-->
                ...
                <!--style="width: 300px"></YwInputAdd>-->
                <!--</el-form-item>-->
                <!--&lt;!&ndash;<el-form-item label="不包含关键字:">&ndash;&gt;-->
                <!--&lt;!&ndash;<YwInputAdd :keys="noIncludeKey"&ndash;&gt;-->
                <!--&lt;!&ndash;:activeKey="noIncludeActiveKey"&ndash;&gt;-->
                <!--&lt;!&ndash;@changeKey="changeNoIncludeKey"&ndash;&gt;-->
                <!--&lt;!&ndash;style="width: 300px"></YwInputAdd>&ndash;&gt;-->
            ...
            setParams(activePagination) {
                if (activePagination) {
                    ...
                    this.queryParams = {
                        ...
                        'includeKey': this.keys ? this.keys.toString() : '',
                        'noIncludeKey': this.noIncludeKey ? this.noIncludeKey.toString() : ''
                    }
                }
