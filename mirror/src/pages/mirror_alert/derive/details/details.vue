<template>
    <div class="components-container yw-dashboard">
        <el-collapse class="yw-dashboard-section"
                ...
                <el-form class="yw-form components-condition"
                    ...
                    <el-form-item label="收敛类型">
                        <el-radio v-model="formData.deviceRelationType"
                                  label="1"
                                  @change="changeSameDevice"
                                  disabled>同一设备衍生一条</el-radio>
                        <el-radio v-model="formData.deviceRelationType"
                                  label="2"
                                  disabled>不同设备</el-radio>
                    </el-form-item>
                </el-form>
            </el-collapse-item>
            ...
            <el-collapse-item class="data-div-boarder"
                              name="3">
                <template slot="title">
                    触发条件设置
                </template>
                ...
                <el-form class="yw-form is-required"
                    ...
                    <el-form-item label="告警等级"
                        ...
                        <el-select style="width:157px;"
                                   v-model="alertSetting.alertLevel"
                                   clearable
                                   disabled>
                    ...
                    <el-form-item label="告警分类"
                                  prop="objectType">
                        <el-select style="width:157px;"
                                   v-model="alertSetting.objectType"
                                   clearable
                                   disabled>
                    ...
                    <el-form-item label="资源池"
                                  v-if="formData.deviceRelationType !== '1'">
                        <el-input v-model="alertSetting.idcType"
                                  disabled>
                        </el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="POD池"
                                  v-if="formData.deviceRelationType !== '1'">
                        <el-input v-model="alertSetting.podName"
                                  disabled>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="机房"
                                  v-if="formData.deviceRelationType !== '1'">
                        <el-input v-model="alertSetting.sourceRoom"
                                  disabled>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="设备分类"
                                  v-if="formData.deviceRelationType !== '1'">
                        <el-input v-model="alertSetting.deviceClass"
                                  disabled>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="设备类型"
                                  v-if="formData.deviceRelationType !== '1'">
                        <el-input v-model="alertSetting.deviceType"
                                  disabled>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="设备厂商"
                                  v-if="formData.deviceRelationType !== '1'">
                        <el-input v-model="alertSetting.deviceMfrs"
                                  disabled>
                        </el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="业务系统"
                                  v-if="formData.deviceRelationType !== '1'">
                        <el-input v-model="alertSetting.bizSys"
                                  disabled>
                        </el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="告警内容">
                        <el-input style="width:157px;"
                                  type="textarea"
                                  :rows="2"
                                  v-model="alertSetting.moniIndex"
                                  disabled></el-input>
                    </el-form-item>
                </el-form>
            </el-collapse-item>
