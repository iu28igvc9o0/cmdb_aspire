    ...
    export default {
        ...
        methods: {
            ...
            delBatch() {
                ...
                rbAlertDeriveServiceFactory.delete(ids).then(() => {
                    this.query()
                })
            },
            del(id) {
                rbAlertDeriveServiceFactory.delete([id]).then(() => {
                    this.query()
                })
            },
            ...
            openBatch() {
                ...
                this.$confirm('确认启用?').then(() => {
                    rbAlertDeriveServiceFactory.start(ids).then(() => {
                        this.query()
                    })
                })
            },
            open(id) {
                this.$confirm('确认启用?').then(() => {
                    rbAlertDeriveServiceFactory.start([id]).then(() => {
                        this.query()
                    })
                })
            },
            ...
            closeBatch() {
                ...
                this.$confirm('确认停用?').then(() => {
                    rbAlertDeriveServiceFactory.stop(ids).then(() => {
                        this.query()
                    })
                })
            },
            close(id) {
                this.$confirm('确认停用?').then(() => {
                    rbAlertDeriveServiceFactory.stop([id]).then(() => {
                        this.query()
                    })
                })
            },
            ...
            copy(id) {
                this.$confirm('确认拷贝?').then(() => {
                    rbAlertDeriveServiceFactory.copyDerive(id).then(() => {
                        this.query()
                    })
                })
            },
