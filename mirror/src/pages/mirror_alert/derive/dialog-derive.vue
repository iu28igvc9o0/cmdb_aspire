            ...
            <section class="yw-dialog-main">
                <el-form class="yw-form is-required"
                    ...
                    <el-form-item label="生效时间">
                        <el-date-picker style="width:193px;"
                    ...
                    <el-form-item label="维护用户">
                        ...
                        <el-input style="width:120px;"
                                  v-model="formData.user.join(',')"
                                  placeholder=""
                                  :disabled="true"></el-input>
                        <el-button type="primary"
                                   @click="getUser()"
                                   :disabled="!otherUserFlag">选择
                        </el-button>
                    </el-form-item>
                    <br />
                    ...
                    <el-form-item label="收敛类型">
                        <el-radio v-model="formData.deviceRelationType"
                                  label="1"
                                  @change="changeSameDevice">同一设备衍生一条</el-radio>
                        <el-radio v-model="formData.deviceRelationType"
                                  label="2">不同设备</el-radio>
                    </el-form-item>
                </el-form>
                ...
                <div class="data-div-boarder">
                    ...
                    <el-form class="yw-form is-required"
                             ...
                             ref="formData1"
                             :rules="rules1">
                        <el-form-item label="关联时间窗(m)"
                                      prop="deriveActiveTimeout">
                            <el-input v-model="formData.deriveActiveTimeout"></el-input>
                        </el-form-item>
                        <el-form-item label="告警阈值个数"
                                      prop="alertThreshold">
                            <el-input v-model="formData.alertThreshold"></el-input>
                        </el-form-item>
                    </el-form>
                </div>
                <div class="data-div-boarder">
                    ...
                    <el-form class="yw-form is-required"
                        ...
                        <el-form-item label="告警来源">
                            <el-input style="width:172px;"
                                      v-model="alertSetting.source"
                                      disabled></el-input>
                        </el-form-item>
                        <el-form-item label="告警等级"
                                      prop="alertLevel">
                            <el-select v-model="alertSetting.alertLevel"
                                       clearable>
                        ...
                        <el-form-item label="告警分类"
                                      prop="objectType">
                            <el-select v-model="alertSetting.objectType"
                                       clearable>
                        ...
                        <el-form-item label="监控对象"
                                      prop="moniObject">
                            <el-input style="width:172px;"
                                      v-model="alertSetting.moniObject">
                            </el-input>
                        </el-form-item>
                        <el-form-item label="告警名称"
                                      prop="keyComment">
                            <el-input style="width:172px;"
                                      v-model="alertSetting.keyComment">
                            </el-input>
                        </el-form-item>
                        <el-form-item label="告警设备IP"
                                      prop="deviceIp"
                                      v-if="formData.deviceRelationType !== '1'">
                        ...
                        <el-form-item label="资源池"
                                      v-if="formData.deviceRelationType !== '1'">
                            <el-select v-model="alertSetting.idcType"
                                       clearable>
                        ...
                        <el-form-item label="工程期数"
                                      v-if="formData.deviceRelationType !== '1'">
                            <el-input style="width:172px;"
                                      v-model="alertSetting.projectName">
                            </el-input>
                        </el-form-item>
                        <el-form-item label="POD池"
                                      v-if="formData.deviceRelationType !== '1'">
                            <el-select v-model="alertSetting.podName"
                                       clearable>
                        ...
                        <el-form-item label="机房"
                                      v-if="formData.deviceRelationType !== '1'">
                            <el-select v-model="alertSetting.sourceRoom"
                                       clearable>
                        ...
                        <el-form-item label="设备分类"
                                      v-if="formData.deviceRelationType !== '1'">
                            <el-select v-model="alertSetting.deviceClass"
                                       clearable>
                        ...
                        <el-form-item label="设备类型"
                                      v-if="formData.deviceRelationType !== '1'">
                            <el-select v-model="alertSetting.deviceType"
                                       clearable>
                        ...
                        <el-form-item label="设备厂商"
                                      v-if="formData.deviceRelationType !== '1'">
                            <el-select v-model="alertSetting.deviceMfrs"
                                       clearable>
                        ...
                        <el-form-item label="设备型号"
                                      v-if="formData.deviceRelationType !== '1'">
                            <el-input style="width:172px;"
                                      v-model="alertSetting.deviceModel">
                            </el-input>
                        </el-form-item>
                        <el-form-item label="业务系统"
                                      prop="bizSys"
                                      v-if="formData.deviceRelationType !== '1'">
                            <el-select v-model="alertSetting.bizSys"
                                       clearable>
        ...
        methods: {
                    ...
                    this.$refs['formData1'].validate((valid1) => {
                        this.$refs['formData2'].validate((valid2) => {
                            if (valid && valid1 && valid2) {
                                ...
                                if (this.updateFlag) {
                                    rbAlertDeriveServiceFactory.update(this.formData).then(() => {
                                        this.$emit('closeDialog', 'update')
                                    }).finally(() => {
                                        this.submitDisabled = false
                                    })
                                } else {
                                    rbAlertDeriveServiceFactory.insert(this.formData).then(() => {
                                        this.$emit('closeDialog', 'update')
                                    }).finally(() => {
                                        this.submitDisabled = false
                                    })
            ...
            getDeviceMfrss() {
                ...
                this.rbHttp.sendRequest({
                    ...
                    this.device_mfrss = res.data

                    // res.data.forEach((item) => {
                    //     let obj = {}
                    //     obj.name = item.produce
                    //     obj.value = item.produce
                    //     this.device_mfrss.push(obj)
                    // })
                })
            },
            // 获取设备分类
            ...
            getList(query) {
                let query_data = {
                    ...
                    condicationCode: 'alert_strategy_device_search',
                    ip: query,
                    idcType: this.alertSetting.idc_type,
                    pageNumber: 1,
                    pageSize: 50
                }
                rbCmdbServiceFactory.getCmdbPageList(query_data).then((res) => {
                    this.currentList = res.result
                })
            },
            getSelectNameById(list = [], val = '', column = '') {
                let name = val
                list.some((item) => {
                    if (item.id === val || item[column] === val) {
                        name = item[column]
                        return true
                    } else {
                        return false
            ...
            selectIp(index) {
                ...
                if (index !== undefined && index !== null) {
                    ...
                    this.alertSetting.deviceMfrs = this.getSelectNameById(this.device_mfrss, selVal.device_mfrs, 'produce')
                    this.alertSetting.deviceModel = selVal.device_model
                    this.alertSetting.bizSys = this.getSelectNameById(this.bizSysList, selVal.bizSystem, 'bizSystem')
                } else {
