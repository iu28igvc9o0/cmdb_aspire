<template>
    <div class="component-container">
                    ...
                    <div style="width: 350px">
                        ...
                        <span>
                            <el-input style="width:200px"
                                      v-model="device_device"></el-input>
                        </span>
                    </div>
                </el-col>
                <el-col :span="6">
            ...
            <el-row>
                    ...
                    <div style="width: 350px">
                        ...
                        <span>
                            <el-select v-model="filterId"
                                       ...
                                       filterable
                                       style="width:200px;">
                                <el-option :key="val.id"
                                           :label="val.name"
                                           :value="val.id"
                                           v-for="(val) in filterData"></el-option>
                            </el-select>
                ...
                <el-col :span="18">
                    <div style="width: 100%;overflow-x: hidden;overflow-y: auto;height: 25px;">
                        <a href="#"
                           style="margin-right: 20px;height: 25px;line-height: 25px;"
                           @click="getFilterData(scene.condition, scene.sceneId)"
                           v-for="(scene, sIndex) in filterSceneData"
                           :key="sIndex">{{scene.sceneName}}({{scene.count}})</a>
                    </div>
                </el-col>
            </el-row>
            <hr style="color: #ebe9e9;margin: 0px; margin-top: 5px; width: calc(100% - 10px);"
        ...
        <div class="body-container">
                    ...
                    <div style="padding-left: 0px;">
                        <div style="float: left">
                            <el-button style="font-size: 16px;"
                                       type="text"
                                       @click="transferDialog"><span class="fa fa-external-link"></span> 转派</el-button>
                            <el-button style="font-size: 16px;"
                                       type="text"
                            ...
                            <el-button style="font-size: 16px;"
                                       type="text"
                                       @click="sendDialog"><span class="fa fa-location-arrow"></span> 派单</el-button>
                            <el-button style="font-size: 16px;"
                                       type="text"
                                       icon="el-icon-delete"
                            ...
                            <el-button style="font-size: 16px"
                                       type="text"
                                       @click="noticeDialog"><span class="fa fa-commenting-o"></span> 通知</el-button>
                        </div>
                        <div class="alertNum">
                            <div class="alertNumContent">已确认:&nbsp;&nbsp;{{alertNum.confirmCount}}</div>
                            <div class="alertNumContent">
                                <span>
                                    <rb-mirror-alert-num :status="1"></rb-mirror-alert-num>
                                </span>
                        ...
                        <div style="float: right">
                            <span class="fa fa-unlock-alt"
                                  style="color:#C4C4C4;padding-left: 10px"
                                  v-show="lockScgreen"></span>
                            <el-button style="font-size: 16px;"
                                       type="text"
                                       @click="lock"
                                       v-show="lockScgreen">锁屏</el-button>
                            <span class="fa fa-lock"
                                  style="color:#C4C4C4;padding-left: 10px"
                                  v-show="goScgreen"></span>
                            <el-button style="font-size: 16px;"
                                       type="text"
                                       @click="go"
                                       v-show="goScgreen">刷屏</el-button>
                            <el-button style="font-size: 16px;"
                                       type="text"
            ...
            <el-table :data="activityAlertData"
                      style="width: 100%;margin-top:5px;cursor: pointer;overflow: auto;height: calc(100vh - 315px)"
                      stripe
                      tooltip-effect="dark"
                      border
        ...
        <!-- 告警确认 -->
        <el-dialog :visible.sync="confirm.confirmDialog"
                   width="35%"
                   center
                   :show-close="false"
            ...
            <div style="padding-left: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span><label style="font-size:16px">告警确认</label></span></div>
                    </el-col>
            ...
            <div style="padding: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span style="font-size: 14px">确认操作</span></div>
                    </el-col>
            ...
            <div style="padding: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span style="font-size: 14px">告警确认内容</span></div>
                    </el-col>
                    <el-col :span="10">
                        <div>
            ...
            <div style="padding-top: 20px">
                <el-row :gutter="20">
                    <el-col :span="12"
                        ...
                        <el-button type="primary"
                                   size="small"
                                   @click="confirmElert">确 定</el-button>
                        <el-button size="small"
                                   @click="cancel('confirm')">取 消</el-button>
                    </el-col>
                </el-row>
            </div>
        </el-dialog>
        <div class="alertNotice">
            <el-dialog v-if="notice.noticeDialog"
                       title="告警通知"
                ...
                <div style="text-align: center;padding-top: 20px;">
                    <el-button type="primary"
                               @click="sendSMS()"
                               class="tem-search"
                               style="width:auto">发送短信</el-button>
                    <el-button type="primary"
                               @click="sendEmail()"
                               class="tem-search"
                               style="width:auto">发送邮件</el-button>
                    <el-button type="primary"
                               @click="cancel('notice')"
        ...
        <!-- 告警转派 -->
        <el-dialog :visible.sync="transfer.transferDialog"
                   width="45%"
                   center
                   :show-close="false"
                   :close-on-click-modal="false">
            <div style="padding-left: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span><label style="font-size:16px">告警转派</label></span></div>
                    </el-col>
            ...
            <div style="padding: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span style="font-size: 14px">转派操作</span></div>
                    </el-col>
            ...
            <div style="padding: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span style="font-size: 14px">转派人员</span></div>
                    </el-col>
                    <el-col :span="19">
                        <div style="float: left">
                            <el-checkbox v-model="transfer.transferTeamChecked">个人</el-checkbox>
                            <el-input v-model="transfer.transferPersonalInput"
               ...
               <el-button type="text">团队选择器</el-button><i class="el-icon-circle-plus" style="padding-left: 10px"></i>
                ...
                <el-row>
                    <el-col :span="19"
                            :offset="5">
                        <div>
                            <el-table :data="transfer.transferTableData"
            ...
            <div style="padding-top: 20px">
                <el-row :gutter="20">
                    <el-col :span="12"
                        ...
                        <el-button size="small"
                                   @click="cancel('transfer')">取 消</el-button>
                    </el-col>
                </el-row>
            </div>
        </el-dialog>
        ...
        <!--派单-->
        <el-dialog :visible.sync="send.sendDialog"
                   width="46%"
                   center
                   :show-close="false"
                   :close-on-click-modal="false">
            <div style="padding-left: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span><label>告警派单</label></span></div>
                    </el-col>
            ...
            <div style="padding: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span style="font-size: 14px">派单操作</span></div>
                    </el-col>
            ...
            <div style="padding-top: 20px">
                <el-row :gutter="20">
                    <el-col :span="12"
                        ...
                        <el-button type="primary"
                                   size="small"
                                   @click="sendbpm">确 定</el-button>
                        <el-button size="small"
                                   @click="cancel('send')">取 消</el-button>
                    </el-col>
                </el-row>
            </div>
        </el-dialog>
        <!--告警清除-->
        <el-dialog :visible.sync="clean.cleanDialog"
                   width="35%"
                   center
                   :show-close="false"
                   :close-on-click-modal="false">
            <div style="padding-left: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span><label>告警清除</label></span></div>
                    </el-col>
            ...
            <div style="padding: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span style="font-size: 14px">确认清除</span></div>
                    </el-col>
            ...
            <div style="padding: 10px">
                <el-row>
                    <el-col :span="5">
                        <div><span style="font-size: 14px">清除原因</span></div>
                    </el-col>
                    <el-col :span="18">
                        <div>
                            <el-input type="textarea"
            ...
            <div style="padding-top: 20px">
                <el-row :gutter="20">
                    <el-col :span="12"
                        ...
                        <el-button type="primary"
                                   size="small"
                                   @click="goRemove">确 定</el-button>
                        <el-button size="small"
                                   @click="cancel('clean')">取 消</el-button>
                    </el-col>
                </el-row>
            </div>
        </el-dialog>
        ...
        <!-- 高级检索 -->
        <el-dialog :visible.sync="search.searchDialog"
                   width="40%"
                   center
                   :show-close="false"
                   :close-on-click-modal="false"
            ...
            <div class="confirm-alert-content">
                ...
                <div class="confirm-alert-row">
                    ...
                    <div>告警描述</div>
                    <div>
                        <el-input v-model="search.alert_description"
                                  style="width: 150px"></el-input>
                    </div>
                </div>
                <div class="confirm-alert-row">
                ...
                <div class="confirm-alert-row">
                    <div>转派操作人</div>
                    <div>
                        <el-input v-model="search.transfer_operator"
                                  style="width: 150px"></el-input>
                    </div>
                    <div>待确认人</div>
                    <div>
                        <el-input v-model="search.confirm_operator"
                                  style="width: 150px"></el-input>
                    </div>
                </div>
                <div class="confirm-alert-row">
            ...
            <div style="padding-top: 20px">
                <el-row :gutter="20">
                    <el-col :span="12"
                        ...
                        <el-button size="small"
                                   @click="cancelHighSearch()">取 消</el-button>
                    </el-col>
                </el-row>
            </div>
        </el-dialog>
        ...
        methods: {
          ...
          rbCmdbServiceFactory.getDictValue({
            ...
            turnSend() {
                ...
                rbAlertKanBanServiceFactory.alertTransfer(obj).then(() => {
                    this.$message({
                        message: '转派成功',
                        type: 'success'
                    })
            ...
            confirmElert() {
                ...
                rbAlertKanBanServiceFactory.alertConfirm(obj).then(() => {
                    this.$message({
                        message: '确认成功',
                        type: 'success'
                    })
            ...
            sms(obj) {
                rbProjectDataServiceFactory.alertSMSNotify(obj).then(() => {
                    this.$message({
                        message: '发送成功',
                        type: 'success'
                    })
            ...
            email(obj) {
                rbProjectDataServiceFactory.alertNotify(obj).then(() => {
                    this.$message({
                        message: '发送成功',
                        type: 'success'
                    })
