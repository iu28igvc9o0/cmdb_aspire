        ...
        <div style="z-index: 51; margin-top: -12px;">
            <el-tabs v-model="activeNames"
                ...
                <el-tab-pane label="活动告警"
                             name="first">
                    <activity-alert :activity="activity"
                                    :alertType="alertType"
                                    :operationStatus="operation_status"
                                    :alert_Level="activity_alert_level"
                                    :requestData="requestData"></activity-alert>
                </el-tab-pane>
                <el-tab-pane label="确认告警"
                             name="second">
                    <confirm-alert :confirm="confirm"
                                   :alertType="alertType"
                                   :operationStatus="operation_status"
                                   :alert_Level="confirm_alert_level"
                                   :requestData="requestData"></confirm-alert>
                </el-tab-pane>
            </el-tabs>
        </div>
    </div>
