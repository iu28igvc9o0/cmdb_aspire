    ...
    <div>
            ...
            <el-row>
                ...
                <el-col :span="6">
                    <div style="width: 350px">
                        ...
                        <span>
                            <el-select v-model="search.system"
                                       placeholder="请选择"
                                       class="list-sel"
                                       clearable
                                       style="width: 200px">
        ...
        <div class="body-container">
                    ...
                    <div style="padding-left: 10px;">
                        <div>
                            <div style="float: left">
                                <el-button style="font-size: 16px;padding-right: 20px;"
                                           type="text"
                                           @click="startTransfer()"><span class="fa fa-external-link"></span> 转派</el-button>
                                <el-button style="font-size: 16px;padding-right: 20px;"
                                           type="text"
                                           @click="startWork()"><span class="fa fa-location-arrow"></span> 派单</el-button>
                                <el-button style="font-size: 16px;padding-right: 20px;"
                                           type="text"
                                           icon="el-icon-delete"
                                           @click="startClean()">清除</el-button>
                                <el-button style="font-size: 16px;padding-right: 20px;"
                                           type="text"
                                           @click="startNotice()"><span class="fa fa-commenting-o"></span> 通知</el-button>
                            </div>
                        </div>
                        <div style="float: right">
                            ...
                            <el-button style="font-size: 16px;"
                                       ...
                                       size="mini"
                                       type="text"
                                       icon="el-icon-d-caret">选择列</el-button>
            ...
            <el-table :data="activityAlertData"
                      style="width: 100%;margin-top:10px;cursor: pointer;height:calc(100vh - 400px);"
                      stripe
                      tooltip-effect="dark"
                      border
                ...
                <el-table-column prop="moni_object"
                                 label="监控对象"
                                 align="center"
                                 width="150px"
                                 :show-overflow-tooltip="true"
        ...
        <!--</div>-->
        <!--</el-dialog>-->
        <el-dialog :visible.sync="notice.noticeDialog"
                   width="40%"
            ...
            <el-transfer filterable
                         ...
                         :titles="['用户列表', '已选用户']"
                         :data="notice.userList"
                         v-model="notice.userResult">
            </el-transfer>
            <span slot="footer"
                  class="dialog-footer">
                <el-button type="primary"
                ...
                <el-row>
                    ...
                    <el-col :span="19">
                        <div style="float: left">
                            ...
                            <el-button type="text"
                                       @click="selectPersonalM()">个人选择器</el-button>
                        </div>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="19"
                        ...
                        <div>
                            <el-table :data="transfer.transferTableData"
                                      ...
                                      stripe
                                      tooltip-effect="dark">
                                <el-table-column prop="transfer_obj_type"
                                                 label="转派对象类型"
                                ...
                                <el-table-column label="操作"
                                    ...
                                    <template slot-scope="scope">
                                        <el-button type="text"
                                                   size="small"
                                                   @click="deleteSelectPersonal(scope.row.id)">删除</el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
                        </div>
            ...
            <div style="padding-top: 20px">
                <el-row :gutter="20">
                    <el-col :span="12"
                        ...
                        <el-button type="primary"
                                   size="small"
                                   @click="submitTransfer()">转 派</el-button>
        ...
        <!-- 告警派单 -->
        <el-dialog :visible.sync="work.workDialog"
                   width="38%"
                   center
                   :show-close="false"
                   :close-on-click-modal="false"
            ...
            <div style="padding-top: 20px">
                <el-row :gutter="20">
                    <el-col :span="12"
                        ...
                        <el-button type="primary"
                                   size="small"
                                   @click="submitWork()">确 定</el-button>
                        <el-button size="small"
                                   @click="cancel('work')">取 消</el-button>
                    </el-col>
                </el-row>
            </div>
        </el-dialog>
            ...
            <div style="padding-top: 20px">
                <el-row :gutter="20">
                    <el-col :span="12"
                        ...
                        <el-button type="primary"
                                   size="small"
                                   @click="submitClean()">确 定</el-button>
                        <el-button size="small"
            ...
            <div style="padding-top: 20px">
                <el-row :gutter="20">
                    <el-col :span="12"
                        ...
                        <el-button size="small"
                                   @click="cancel('search')">取 消</el-button>
                    </el-col>
                </el-row>
            </div>
        </el-dialog>
        ...
        <el-dialog title="选择用户"
                   :visible.sync="transfer.selectPersonal"
                   width="36%"
                   center
                   :show-close="false"
                   :close-on-click-modal="false"
            ...
            <span slot="footer"
                ...
                <el-button type="primary"
                           size="small"
                           @click="confirmSelectPersonal()">确认</el-button>
                <el-button type="primary"
                           size="small"
                           @click="cancel('selectPersonal')">返回</el-button>
            </span>
        </el-dialog>
