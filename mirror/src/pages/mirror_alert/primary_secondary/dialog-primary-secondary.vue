            ...
            <section class="yw-dialog-main">
                ...
                <el-form class="yw-form is-required"
                    ...
                    <div class="data-div-boarder"
                         v-if="formData.deviceRelationType === '2'">
                        <span>设备过滤</span><br>
                        ...
                        <el-form-item label="设备IP"
                                      prop="primaryIp">
                            <el-input style="width:172px;"
                                      v-model="formData.primaryIp"></el-input>
                        </el-form-item>
                    </div>
                    <br>
                    <div class="data-div-boarder">
                        ...
                        <el-form-item label="告警内容"
                                      prop="primaryMoniIndex">
                            <el-input style="width:172px;"
                                      v-model="formData.primaryMoniIndex"
                                      placeholder="模糊匹配"></el-input>
                        </el-form-item>
                        <el-form-item label="告警等级">
                            <el-radio v-model="formData.primaryAlertLevel"
                ...
                this.$refs['formData'].validate((valid) => {
                    this.$refs['formData1'].validate((valid1) => {
                        if (valid && valid1) {
                            ...
                            if (this.updateFlag) {
                                rbAlertPrimarySecondaryServiceFactory.update(this.formData).then(() => {
                                    this.$emit('closeDialog', 'update')
                                }).finally(() => {
                                    this.submitDisabled = false
                                })
                            } else {
                                rbAlertPrimarySecondaryServiceFactory.insert(this.formData).then(() => {
                                    this.$emit('closeDialog', 'update')
                                }).finally(() => {
                                    this.submitDisabled = false
                                })
