...
<script>
    ...
    export default {
        name: 'MirrorAlertPrimarySecondary',
        ...
        methods: {
            ...
            delBatch() {
                ...
                rbAlertPrimarySecondaryServiceFactory.delete(ids).then(() => {
                    this.query()
                })
            },
            del(id) {
                rbAlertPrimarySecondaryServiceFactory.delete([id]).then(() => {
                    this.query()
                })
            },
            ...
            openBatch() {
                ...
                this.$confirm('确认启用?').then(() => {
                    rbAlertPrimarySecondaryServiceFactory.start(ids).then(() => {
                        this.query()
                    })
                })
            },
            open(id) {
                this.$confirm('确认启用?').then(() => {
                    rbAlertPrimarySecondaryServiceFactory.start([id]).then(() => {
                        this.query()
                    })
                })
            },
            ...
            closeBatch() {
                ...
                this.$confirm('确认停用?').then(() => {
                    rbAlertPrimarySecondaryServiceFactory.stop(ids).then(() => {
                        this.query()
                    })
                })
            },
            close(id) {
                this.$confirm('确认停用?').then(() => {
                    rbAlertPrimarySecondaryServiceFactory.stop([id]).then(() => {
                        this.query()
                    })
                })
            },
            ...
            copy(id) {
                this.$confirm('确认拷贝?').then(() => {
                    rbAlertPrimarySecondaryServiceFactory.copyDerive(id).then(() => {
                        this.query()
                    })
                })
            },
