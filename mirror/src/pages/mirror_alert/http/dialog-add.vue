                    ...
                    <el-form class="yw-form is-required"
                        ...
                        <el-form-item label="业务系统"
                            ...
                            <treeselect class="yw-treeselect"
                                        v-model="ruleForm.biz_system_id"
                                        :multiple="false"
                ...
                <el-collapse-item name="2">
                    ...
                    <el-form class="yw-form is-required form-info-item"
                        ...
                        <el-form-item label="超时时间（毫秒）"
                                      prop="time_out">
                            <el-input v-model="ruleForm.time_out"
                                      type="number"
                                      placeholder=""
                                      clearable></el-input>
                        </el-form-item>
                            ...
                            <el-radio label="1">
                                ...
                                <el-form-item prop="json_val"
                                    ...
                                    <el-select v-model="ruleForm.json_operator"
                                               style="width:60px"
                                               placeholder="">
                                        <el-option :label="o.name"
                                                   :key="index"
                                                   v-for="(o,index) in cal_operator"
