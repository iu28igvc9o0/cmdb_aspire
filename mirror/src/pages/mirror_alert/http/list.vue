        ...
        <el-form class="yw-form components-condition"
            ...
            <el-form-item label="业务系统">
                <treeselect class="yw-treeselect"
                            v-model="formData.biz_system_id"
                            :multiple="false"
            ...
            <el-form-item label="监控名称">
                <el-input v-model="formData.monitor_name"
                          clearable
            ...
            <el-form-item label="监控地址">
                <el-input v-model="formData.request_http_addr"
                          clearable
            ...
            <div class="yw-el-table-wrap">
                <el-table class="yw-el-table"
                    ...
                    <el-table-column label="监测结果"
                        ...
                        <template slot-scope="scope">
                            <a class="text-status"
                               v-if="scope.row.result || scope.row.result === 0"
                               :class="{error:scope.row.result===0}"
                               @click="view(scope.row)">{{scope.row.result === 1?'正常':'异常'}}</a>
                        </template>
                    </el-table-column>
        ...
        methods: {
            ...
            deleteRow(id, name) {
                this.$confirm('删除监控配置 ' + name + '?', '删除', {
                    ...
                    rbMonitorManageServicesFactory.delete(id).then(() => {
            ...
            changeStatus(row, status) {
                ...
                this.$confirm(text + '监控配置 ' + name + '?', text, {
                    ...
                    rbMonitorManageServicesFactory.updateStatus(obj).then(() => {
