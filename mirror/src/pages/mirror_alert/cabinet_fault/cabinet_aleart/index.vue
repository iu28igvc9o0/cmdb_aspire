...
<script>
    import tableJson from '../smart_data/cabinetAleart.json'
    import CommonOption from 'src/utils/commonOption.js'
    // simport { createDownloadFile } from 'src/utils/utils.js'
        ...
        methods: {
                    ...
                    case 'bizSystemCount':
                        {
                            this.$router.push({
                                ...
                                query: {
                                    ...
                                    cabinetColumn: this.routeInfo.cabinetColumn,
                                    bizSystemCount: this.routeInfo.cabinetCount,
                                    alertStatus: this.routeInfo.alertStatus,
                                }
            ...
            */
            beforeHttp({ tableItem, params, httpMethod, row }) {
                ...
                params.cabinetCount = this.routeInfo.cabinetCount
                params.deviceCount = this.routeInfo.deviceCount
                params.idcType = this.routeInfo.idcType
                // params.cabinetName = this.routeInfo.cabinetColumnName
