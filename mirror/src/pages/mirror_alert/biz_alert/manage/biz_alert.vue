    ...
    <div class="components-container">
        ...
        <el-tabs class="yw-tabs"
            ...
            <el-tab-pane label="历史告警"
                         name="second">
                <keep-alive>
                    <alertHisList v-if="activeFlagList['second'].flag"
                                  :alertType="'biz_alert'"></alertHisList>
                </keep-alive>
            </el-tab-pane>
        </el-tabs>
        ...
        <!-- <div class="table-operate-wrap clearfix">
            <section class="fr">
                ...
                <div v-show="showFlag" class="alertNumContent">{{showName}}:&nbsp;&nbsp;{{showCount}}</div>
            </section>
        </div> -->
        <!-- tab -->
    </div>
...
<script>
    ...
    import alertHisList from 'src/pages/mirror_alert/alert_his_new/list/alert-list.vue'
    ...
    export default {
        name: 'MirrorAlertBizAlertManage',
        mixins: [],
        components: {
            alertList,
            rbMirrorAlertNum,
...
<style scoped lang="scss">
    @import "../../alert_new/list/alert.scss";
    .confirmCount {
        position: relative;
    }
    .table-operate-wrap {
