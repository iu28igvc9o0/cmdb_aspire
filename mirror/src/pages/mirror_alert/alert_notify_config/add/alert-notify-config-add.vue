        ...
        <el-form class="yw-form is-required"
            ...
            <el-form-item label="告警筛选场景"
                ...
                <el-select v-model="addForm.alertFilterScene"
                           ...
                           filterable
                           clearable>
                    <el-option v-for="val in alertFilterScenes"
                               :key="val.sceneId"
                               :label="val.sceneName"
                    ...
                    <div class="yw-el-table-wrap">
                        <el-table class="yw-el-table"
                            ...
                            <el-table-column prop="notifyType"
                                             label="通知方式">
                                <template slot-scope="scope">
                                    <span v-if="scope.row.notifyType == '0'">邮件/短信</span>
                                    <span v-else-if="scope.row.notifyType == '1'">邮件</span>
                                    <span v-else-if="scope.row.notifyType == '2'">短信</span>
                                    <!-- <span v-else>{{scope.row.notifyType}}</span> -->
                                </template>
                            </el-table-column>
            ...
            <el-form-item label="重发策略配置:">
                ...
                <span v-if="addForm.isRecurrenceInterval">
                    ...
                    <br />
                    <span style="padding-left: 20px;">重发次数:</span>
                    <span style="padding-left: 5px;">
                        <el-radio-group v-model="addForm.recurrenceCountType"
                                        @click="goCount()">
                            <el-radio label="1">持续发送</el-radio>
                            <el-radio label="2">自定义</el-radio>
                        </el-radio-group>
                        <el-input-number v-if="addForm.recurrenceCountType === '2'"
                                         v-model="addForm.recurrenceCount"
                                         :min="1">
                        </el-input-number>
                        <!-- <el-tooltip style="padding-left: 5px;"
                                    class="item"
                                    effect="dark"
                                    content="-1表示不限制次数"
                                    placement="top">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            goCount() {
                if (this.addForm.recurrenceCountType === '2') {
                    if (!this.addForm.recurrenceCount || this.addForm.recurrenceCount < 1) {
                        this.addForm.recurrenceCount = 3
                    }
                }
            },
            ...
            addNotifyObj() {
                ...
                this.userList.forEach((item) => {
                    ...
                    obj.notifyType = this.addForm.notifyType
            ...
            alertNotifyConfigDetail: {
                handler: function () {
                    if (this.alertNotifyConfigDetail) {
                        ...
                        // }
                        this.addForm.notifyType = this.alertNotifyConfigDetail.notifyType
                        if (this.alertNotifyConfigDetail.isRecurrenceInterval === 1) {
                            ...
                            this.addForm.recurrenceCount = this.alertNotifyConfigDetail.recurrenceCount
                            if (!this.alertNotifyConfigDetail.recurrenceCount || this.alertNotifyConfigDetail.recurrenceCount < 0) {
                                this.addForm.recurrenceCountType = '1'
                            } else {
                                this.addForm.recurrenceCountType = '2'
                            }
                        }
