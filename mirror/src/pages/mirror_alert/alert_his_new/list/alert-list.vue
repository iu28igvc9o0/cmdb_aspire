                            ...
                            <div class="aLine halfALine"
                                ...
                                <div class="content">
                                    ...
                                    <p class="elInput iconLeft">
                                        ...
                                        <!-- <i @click="deviceDeviceClick(deviceIp,'设备IP')" class="el-icon-search elInputIcon"></i> -->
        ...
        methods: {
            ...
            initDict() {
                ...
                _this.rbHttp.sendRequest({
                    ...
                    // console.log(_this.listShowList)
                    // 过滤不需要的数据
                    let obj = res.filter((item) => {
                        return item.isQueryParam == 1
                    })
                    // _this.modelFieldDataS = obj // 过滤到所有需要展示的数据

                    this.modelFieldDataS = obj.sort(function (a, b) {
                        return a.queryParamSort - b.queryParamSort
                    })
                    // console.log(_this.modelFieldDataS);

                    _this.tileDatalist = []
                    this.modelFieldDataS.forEach(fieldCodeType => {
                        // console.log('排序', _this.modelFieldDataS[item].queryParamSort,_this.modelFieldDataS[item].fieldName,_this.modelFieldDataS[item].queryParamSource)
                        let OBJ = {}
                        ...
                        setTimeout(() => {
                            ...
                            //   let arr = this.tileDatalist.filter( item => {
                            //       return item.code != "alert_level"
                            //   })
                            //   this.tileDatalist = arr
                        }, 500)
            ...
            // filterCode(itemA){
            //     let field = itemA
            //     let codeArr = ["alert_level","device_class","idc_type"]
            //     codeArr.forEach( val => {
            //         if(field.code === val) {
            //             return false
            //         }
            ...
            handleNodeClick(e) {
                ...
                // this.queryFormNew.page_no = 1
                // let objTiLing = this.queryFormNew.list.filter((item, index) => {
                //     return item.fieldName !== 'biz_sys'
                // })
                // this.queryFormNew.list = objTiLing

                // this.queryForm.bizSys = e.name
                // if(e.type === 'bizSystem') {
                //     this.queryFormNew.list.push({
                //             fieldName: 'biz_sys',
                //             fieldType: 'tree_in',
            ...
            getOperationStatus() {
                ...
                //     operationStatus = '1'
                // } else 
                if (this.alertType == 'biz_alert') {
                    operationStatus = '5'
                } else if (this.alertType == 'exception') {
                    operationStatus = '6'
                } else {
                    operationStatus = '0,1,3'
                }
            ...
            alertType: {
                handler(val) {
                    ...
                    if (val === 'biz_alert') {
                        ...
                        this.queryForm.queryType = '0,1,3'
                        this.queryFormNew.list[0].fieldValue = '0,1,3'
                    }
                },
