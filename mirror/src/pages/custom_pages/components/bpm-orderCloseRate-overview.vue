        ...
        methods: {
            ...
            onbind(data) {
                switch (data.item.columnName) {
                    ...
                    // 部门名称
                    case 'department':
                        this.$emit('changeComponent', { url: 'bpm-orderCloseRate-sub', datas: data.row, conditions: { activeTab: this.activeTab } })
                        break
                }
            },
            // 智能表格页面所有请求前的前置操作
            ...
            */
            ...
            // 重置json的http请求方法
            resetTableJsonHttp() {
                tableJson.list[0].http.methods = '/v1/bpm/runtime/umsHome/getDepartmentInstCloseInfo'
            },
