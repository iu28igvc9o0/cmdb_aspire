    ...
    <div>
        <el-form ref="filterRuleForm"
            ...
            <el-form-item label="规则名称"
                          prop="name">
                <el-input v-model="logAlertRuleData.name"
                          style="width: 300px;"></el-input>
            </el-form-item>
            <el-form-item label="规则描述"
                          prop="description">
                <el-input type="textarea"
                          v-model="logAlertRuleData.description"
                          style="width: 300px;"></el-input>
            </el-form-item>
            <el-form-item label="运行状态"
                          prop="runStatus">
                <el-switch v-model="logAlertRuleData.runStatus"
                           active-color="#13ce66"
            ...
            <el-form-item label="设备IP"
                          prop="deviceIp">
                <el-input v-model="logAlertRuleData.deviceIp"
                          placeholder="设备IP"
                          style="width: 300px;"></el-input>
            </el-form-item>
            <el-form-item label="告警名称"
                          prop="keyComment">
                <el-input v-model="logAlertRuleData.keyComment"
                          placeholder="告警名称"
                          style="width: 300px;"></el-input>
            </el-form-item>
            <el-form-item label="关键字"
                ...
                <div>
                    <span>
                        <el-checkbox v-model="logAlertRuleData.include">包含</el-checkbox>
                    </span>
                    <span v-if="type !== 'detail'"
                          style="padding-left: 12px;">
                        <el-button type="text"
                                   @click="setKeys('include')">设置关键字</el-button>
                    </span>
                    <span>
                        <el-input style="width: 175px;"
                                  v-model="logAlertRuleData.includeKey"
                                  disabled></el-input>
                    </span>
                </div>
                <div>
                    <span>
                        <el-checkbox v-model="logAlertRuleData.noInclude">不包含</el-checkbox>
                    </span>
                    <span v-if="type !== 'detail'">
                        <el-button type="text"
                                   @click="setKeys('noInclude')">设置关键字</el-button>
                    </span>
                    <span>
                        <el-input style="width: 175px;"
                                  v-model="logAlertRuleData.noIncludeKey"
                                  disabled></el-input>
                    </span>
                </div>
            ...
            <el-form-item label="时间过滤"
                          prop="filterDate">
                <span>
                    <el-radio-group v-model="logAlertRuleData.filterDate"
                ...
                <span>
                    <el-input v-model="logAlertRuleData.filterDateValue"
        ...
        data() {
            return {
                ...
                logAlertRuleData: {
                    ...
                    noIncludeKey: this.noParam ? this.noParam.toString() : '',
                    key: [],
                    filterDate: 30,
                    filterDateValue: 30,
                    alertLevel: ''
            ...
            logAlertRuleDetailData: {
                handler: function () {
                    if (this.logAlertRuleDetailData) {
                        ...
                        this.logAlertRuleData.keyComment = this.logAlertRuleDetailData.keyComment
