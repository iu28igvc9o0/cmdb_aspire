<template>
    <div class="components-container yw-dashboard yw-form pbottom">
        <el-form ref="form"
                 :inline="true"
                 :model="form"
                 :rules="formRule"
                 ...
                 id="elFormId">
            <div class="c1">
                <h3 class="border-bottom pbottom10">基础信息</h3>
                <el-row class="con0 mtop10">
                    <el-col :span="24"
                            class="content">
                        ...
                        <el-form-item class="item-name"
                            ...
                            <el-input id="name"
                                      :maxlength="100"
                                      v-model.trim="form.theme_name"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row class="con">
                ...
                <el-row class="con1">
                    <el-col :span="24"
                        ...
                        <el-form-item class="item-name"
                            ...
                            <el-input v-show="themeBut"
                                      id="name"
                                      :maxlength="100"
                                      v-model.trim="theme_code1"
            ...
            <div class="c2">
                <h3 class="border-bottom pbottom10 mtop10">数据定义</h3>
                <el-row class="con2 mtop10">
                    <el-col :span="24"
                            class="content">
                        <el-form-item class="item-name"
                                      label="日志内容："
                ...
                <el-row class="con0">
                    ...
                    <el-button type="primary"
                               class="tem-search"
                               style="margin-left:0"
                               @click="addDim()">新增</el-button>
                    <el-button type="primary"
                               class="tem-search"
                               @click="ruleDimList()">校验</el-button>
                    <el-button type="primary"
                               class="tem-search1"
                               @click="dialogVisible = true">校验结果</el-button>
                </el-row>
                <el-row class="con1">
                    <el-table :data="form.dim_list"
                              border
                        ...
                        <el-table-column prop="match_flag"
                                         label="表达式类型"
                                         align="center">
                            <template slot-scope="scope">
                                <el-select class="select"
                        ...
                        <el-table-column prop="dim_reg"
                                         label="表达式"
                                         align="center">
                            <template slot-scope="scope">
                                <el-input v-model.trim="form.dim_list[scope.$index].dim_reg"
                                          class=""
                                          v-if="form.dim_list[scope.$index].match_flag === '2'"></el-input>
                                <el-select class="select"
                                           filterable
                                           placeholder="请选择"
                                           v-model.trim="form.dim_list[scope.$index].dim_reg"
                                           v-else
                        ...
                        <el-table-column prop="dim_code"
                                         label="维度编码"
                                         align="center">
                            <template slot-scope="scope">
                                <el-input v-model.trim="form.dim_list[scope.$index].dim_code"
                                          :disabled="form.dim_list[scope.$index].match_flag !== '1'"
                                          :title="form.dim_list[scope.$index].dim_code"
                                          class="itemCode"></el-input>
                            </template>
                        </el-table-column>
                        <el-table-column prop="dim_name"
                                         label="名称"
                                         align="center">
                            <template slot-scope="scope">
                                <el-input v-model.trim="form.dim_list[scope.$index].dim_name"
                                          :disabled="form.dim_list[scope.$index].match_flag !== '1'"
                                          :title="form.dim_list[scope.$index].dim_name"
                                          class="itemCode"></el-input>
                            </template>
                        </el-table-column>
                        <el-table-column prop="dim_type"
                                         label="字段类型"
                                         align="center">
                            <template slot-scope="scope">
                                <el-select class="select"
            ...
            <div class="c3"
                ...
                <div class="title mtop10">
                    <span>在线接入调试</span>
                    <el-tooltip v-if="!validate"
                                effect="light"
                                content="请先正确完成上方参数录入及维度校验"
                                popper-class="startBut">
                        <el-button type="primary"
                                   class="but1">开始调试</el-button>
                    </el-tooltip>
                    <el-button v-else
                               type="primary"
                               class="but2"
                               @click="validForm()">开始调试</el-button>
                </div>
                ...
                <div class="con"
                    ...
                    <el-row style="margin-top:40px;display: flex;"
                        ...
                        <el-col :span="5"
                            ...
                            <div>
                                ...
                                <div v-if="receiveHost"
                                     class="head-left-text">{{receiveHost}}</div>
                                <div v-else
                                     class="head-left-text">接收中...</div>
                            </div>
                        </el-col>
                        ...
                        <el-col :span="7"
                            ...
                            <div style="width:276px">
                                <div class="thematicData-jszj-jrzj">
                                    <el-radio-group v-model="upInterfaceName"
                                                    size="small">
                                        <el-radio-button label="专网地址"></el-radio-button>
                                        <el-radio-button label="公网地址"></el-radio-button>
                                    </el-radio-group>
                                </div>
                                <div v-if="upInterfaceName==='专网地址'"
                                     class="thematicData-jszj-jrzj">{{upInterfaceObj[0]}}</div>
                                <div v-else
                                     class="thematicData-jszj-jrzj">{{upInterfaceObj[1]}}</div>
                            </div>
                        </el-col>
                    </el-row>
                    ...
                    <el-row style="margin-top: 20px;"
                            class="con2">
                        <el-col :span="12"
                                class="schedule-content-left-modify"
                            ...
                            <el-tooltip placement="top"
                                ...
                                <i class='el-icon-question'
                                   style="color: #93D0F7;font-size:20px;"></i>
                            </el-tooltip>
                        </el-col>

                        <el-col :span="12"
                                class="schedule-content-right-modify">
                            <el-row>
                                <el-col :span="9">

                                    <span class="thematicData-debug-title">在线接收日志</span>
                                    <span v-if="isContinue"
                                          style="color: #666666;">
                                        <img class="thematicData-debug-pause-continue"
                                    ...
                                    <div v-if="receiveTime"
                                         style="color: #B8CCD3;"
                                         class="thematicData-debug-title">{{receiveTime}}</div>
                                    <div v-else
                                         style="color: #B8CCD3;"
                                         class="thematicData-jszj-jrzj">接收中...</div>
                                ...
                                <el-col :span="5"
                                    ...
                                    <span v-if="isIpLock">
                                        <img class="thematicData-debug-pause-continue"
                                             @click="lockTheme('isIpLock1')"
                                             src="../../../assets/img/lockup.png" />
                                        解锁主机
                                    </span>
                                    <span v-else>
                                        <img class="thematicData-debug-pause-continue"
                                             @click="lockTheme('isIpLock0')"
                                    ...
                                    <div v-if="receiveHost"
                                         style="color: #B8CCD3;"
                                         class="thematicData-jszj-jrzj">{{receiveHost}}</div>
                                </el-col>
                                ...
                                <el-col :span="5"
                                    ...
                                    <span v-if="isYwLock">
                                        <img class="thematicData-debug-pause-continue"
                                             @click="lockTheme('isYwLock1')"
                                             src="../../../assets/img/lockup.png" />
                                        解锁业务
                                    </span>
                                    <span v-else>
                                        <img class="thematicData-debug-pause-continue"
                                             @click="lockTheme('isYwLock0')"
                                             src="../../../assets/img/unlock.png" />
                                        锁定业务
                                    </span>

                                    <div v-if="receiveBizCode"
                                         style="color: #B8CCD3;"
                                         class="thematicData-jszj-jrzj">{{receiveBizCode}}
                                    </div>
                                </el-col>

                                <el-col :span="5"
                                        style="text-align: right;margin-right: 0px;padding-left: 3%;"
                                        class="thematicData-debug-title">
                                    <span v-if="isZbLock">
                                        <img class="thematicData-debug-pause-continue"
                                             @click="lockTheme('isZbLock1')"
                                             src="../../../assets/img/lockup.png" />
                                        解锁指标
                                    </span>
                                    <span v-else>
                                        <img class="thematicData-debug-pause-continue"
                                             @click="lockTheme('isZbLock0')"
                                             src="../../../assets/img/unlock.png" />
                                        锁定指标
                                    </span>
                                    ...
                                    <div v-if="receiveJkzbCode"
                                         ...
                                         class="thematicData-jszj-jrzj"
                                         :title="receiveJkzbCode">{{receiveJkzbCode}}
                                    </div>
                                </el-col>
                            </el-row>
                        </el-col>
                    ...
                    <el-row class="con5">
                        <el-col :span="12"
                                class="schedule-content-left-modify">
                            <el-table :data="dimList"
                                      style="border:1px solid #D6E1E5;">
                                <el-table-column prop="dimName"
                                                 label="字段"
                                                 align="left">
                                </el-table-column>
                                <el-table-column prop="dimNameValue"
                                                 label="数据"
                                                 align="left">
                                </el-table-column>
                            </el-table>
            ...
            <div class="fixed-bottom-box t-center">
                <el-button type="primary"
                           @click="submitTheme()"
                           :disabled="!submitBool">提交</el-button>
                <el-button @click="returnList()">返回</el-button>
            </div>
        </el-form>

        <el-dialog :visible.sync="addSuccessDialog"
                   width="30%"
                   :before-close="handleClose"
                   class="dialogsuc">
            <div style="text-align:center">
                <img style=""
                     src="../../../assets/img/migupic.png" />
                <div style="margin-top:20px;margin-bottom:35px;font-family: PingFangSC-Regular;font-size: 14px;color: #3B3A3F;line-height: 16px;">
                    恭喜完成主题数据的接入
                </div>
            </div>
            <div style="text-align:center">
                <el-button @click="continueTheme()"
                           style="color:#46BAFE;border-color:#46BAFE;">继续接入数据</el-button>
                <el-button type="primary"
                           @click="goBack()">返回列表</el-button>
            </div>
        </el-dialog>

        <el-dialog title="日志校验结果"
                   :visible.sync="dialogVisible"
                   width="50%"
                   :before-close="handleClose1">
            <el-table :data="dim_result"
                      style="border:1px solid #D6E1E5;">
                <el-table-column prop="dim_cname"
                                 label="名称"
                                 align="left">
                </el-table-column>
                <el-table-column prop="dim_name"
                ...
                <el-table-column prop="dim_value"
                                 label="数值"
                                 align="left">
                </el-table-column>
            </el-table>
            <span slot="footer"
                ...
                <el-button type="primary"
                           ...
                           class="tem-search1">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
                ...
                if (this.form.up_type === '0') {
                    ...
                    if (str) {
                        if (this.ThemeDataTimer1) {
                            ...
                            rbProjectDataServiceFactory.updateTheme(arr).then(() => {
                    ...
                    if (this.ThemeDataTimer1) {
                        this.submitBool = false
                        this.form.status = '0'
                        rbProjectDataServiceFactory.creatTheme(this.form).then(() => {
