    ...
    export default {
        ...
        data() {
            return {
                ...
                addFormRules: {
                    pipelineId: [
                        { required: true, message: '请选择关联作业！' }
                    ],
                    scenesName: [
                        { required: true, message: '请填写场景名称！' }
                    ],
                    groupIdList: [
                        { required: true, message: '请选择场景分组！' }
                    ]
                },
                // 图片上传组件
                imageUrl: '',
                pictureData: '', // 传给接口的图片数据
                disabled: false,
        ...
        methods: {
            ...
            saveScene() {
                ...
                // console.log(groupId);
                // console.log(this.addForm.groupIdList);
                ...
                this.$refs['addForm'].validate((valid) => {
                    ...
                    rbAutoOperationWorkServicesFactory
                        .savePipelineScenes(params, pictureData)
                        .then(res => {
                            if (res.flag) {
                                this.$message({
                                    message: '保存成功',
