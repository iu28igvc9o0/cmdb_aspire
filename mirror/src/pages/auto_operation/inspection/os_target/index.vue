...
<script>
    import pageJson from 'src/pages/auto_operation/inspection/os_target/smart_data/index.json'
    import editJson from 'src/pages/auto_operation/inspection/os_target/smart_data/dialog.json'
        ...
        methods: {            // 初始化
            ...
            getRefModuleDict(item, type) {
                ...
                return rbCmdbModuleService.getRefModuleDict({ params: params }).then((res) => {
                    if (type === 'idcType') {
                        ...
                        this.$refs.editForm.asp_setOptions('pool_id', res)
                ...
                this.$nextTick(() => {
                    if (this.scriptName) {
                        if (this.editStatus === 'add') {
                            this.editModel.prototype_label = 'cruise_jw'
            ...
            onbind(data) {
                ...
                switch (data.item.columnName) {
                    ...
                    case 'exportAction': {
                        ...
                        rbAutoTargetServicesFactory.exportMonitorItemPrototypeList(obj).then(res => {
                            if (res) {
                                ...
                                createDownloadFile(res, '交维巡检列表.xls')
                            }
                        })
                        break
                    }
                    ...
                    case 'pool_id': {
                        this.editModel.pool_name = data.model.label_select_1611821469188
                        break
                    }
                    case 'open-row': {
                        let obj = {}
