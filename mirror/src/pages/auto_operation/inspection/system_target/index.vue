...
<script>
    import pageJson from 'src/pages/auto_operation/inspection/system_target/smart_data/index.json'
    import editJson from 'src/pages/auto_operation/inspection/system_target/smart_data/dialog.json'
                ...
                this.$nextTick(() => {
                    if (this.scriptName) {
                        if (this.editStatus === 'add') {
                            this.editModel.prototype_label = 'cruise_system'
                            ...
                            // this.editModel.script_group_name_group_name = this.multipleSelection[0].group_name
                    ...
                    case 'exportAction': {
                        ...
                        rbAutoTargetServicesFactory.exportMonitorItemPrototypeList(obj).then(res => {
                            if (res) {
                                ...
                                createDownloadFile(res, '系统巡检列表.xls')
                            }
                        })
                        break
                    }
