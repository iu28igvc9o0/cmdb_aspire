...
<script>
    ...
    import { formatDate2, fixedNumber } from 'src/assets/js/utility/rb-filters.js'
            ...
            drawCharts() {
                this.$nextTick(() => {
                    this.chartData.chartList.forEach((subItem) => {
                        ...
                        // let legendFilter = this.chartData.filter2.filter((item, index) => {
                        //   return item.label == this.chartData.activeFilter2
                        // })
