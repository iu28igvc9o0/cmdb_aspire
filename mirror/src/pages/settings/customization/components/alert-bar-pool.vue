    ...
    export default {
        ...
        methods: {
            ...
            getDatas() {
                ...
                // let res = [
                //     { pool: '资源池1', waitSolve: 3, inSolve: 4 },
                //     { pool: '资源池2', waitSolve: 5, inSolve: 7 },
                //     { pool: '资源池3', waitSolve: 4, inSolve: 4 },
                //     { pool: '资源池4', waitSolve: 3, inSolve: 4 },
                //     { pool: '资源池5', waitSolve: 5, inSolve: 7 },
                // ]
                // this.barDatas[0].chartDatas = res
            ...
            clickChart(params = '') {
                ...
                this.$router.push({
                    ...
                    query: {
                        ...
                        filter: JSON.stringify([{ code: 'idc_type', name: params.name, type: 'in_and' }])
                    }
                })
            },
            changeTab() {
