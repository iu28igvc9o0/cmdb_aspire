    ...
    export default {
        ...
        methods: {
            ...
            getCountByIdcDevCT(data) {
                ...
                if (window.projectName == '集中网管' || window.projectName == '客响-集中运维平台') {
                    this.legendData1 = '服务器'
                    this.legendData2 = '磁带库'
                    this.legendData3 = '网络设备'
                    this.legendData4 = '安全设备'
                    this.legendData5 = '存储设备'
                    let queryData = {
                ...
                _this.$nextTick(() => {
                    ...
                    if (window.projectName != '集中网管' && window.projectName != '客响-集中运维平台') {
                        myChart.on('click', function (params) {
                            console.info('params:')
                            console.info(params)
                            Bus.$emit('poolFlag', _this.poolOne, params.name, _this.QueryType, params.data.idcTypeId)
            ...
            drawChartsBar() {
                let _this = this
                _this.$nextTick(() => {
                    console.log(_this.chartData1.chartList)
                    _this.chartData1.chartList.forEach((subItem) => {
                        ...
                        if (window.projectName == '集中网管' || window.projectName == '客响-集中运维平台') {
                            ...
                            for (let k = 0; k < option.series.length; k++) {
                                option.legend.data.push(option.series[k].name)
                                option.series[k].label.fontSize = '10'
                            }
                            // option.legend.data = [option.series[0].name, option.series[1].name, option.series[2].name, option.series[3].name, option.series[4].name]
