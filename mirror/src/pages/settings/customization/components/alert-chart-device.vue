        ...
        data() {
            return {
                chartData: {
                    ...
                    activeFilter2: '',
                    chartList: [{ id: 'alert-chart-device-1', chartOption: 'bar-option', chartDatas: '' }, { id: 'alert-chart-device-2', chartOption: 'bar-option', chartDatas: '' }, { id: 'alert-chart-device-3', chartOption: 'bar-option', chartDatas: '' }],
                }
            }
        },
        methods: {
