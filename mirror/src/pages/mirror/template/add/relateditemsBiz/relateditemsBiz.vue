    ...
    <div class="component-container">
        <header>
            <div class="he-wrapper">
                ...
                <el-select v-model="bizTem"
                           placeholder="请选择"
                           class="list-sel"
                           ref="temp">
                    <el-option v-for="item in BizTemList"
                ...
                <div class="item-tit"
                     style="margin-left:-3%">监控项名称：</div>
                <el-input v-model="name"
                          placeholder="请输入内容"
                          class="item-input input-tem-name1"></el-input>

                <div class="item-tit"
                     style="margin-left:3%">监控Key：</div>
            ...
            addItems() {
                ...
                arr.forEach(item => {
                    if (this.monitor.indexOf(item) < 0) {
                        ...
                        tmpItem.key = item.item_id
                        this.monitor.push(tmpItem)
                    }
                })
            },
            // 已选栏全清
