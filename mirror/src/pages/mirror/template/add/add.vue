...
<script>
    ...
    export default {
        name: 'MirrorTemplateAdd',
        components: {
            agentDeviceChoose: () => import('./components/agent-device-choose.vue')
        },
        data() {
        ...
        methods: {
                ...
                if (this.active === 0) {
                    ...
                    if (this.newTemplate.mon_type === '1') {
                        ...
                        obj = {
                            ...
                            'fun_type': '2',
                            'trigger_list': this.packSend(this.tableData),
                            'object_ids': this.selectedAgentList.join(',')
                        }
                    } else {
                        if (!this.ruleTrigger()) {
                            return
            ...
            relateItems() {
                ...
                if (this.newTemplate.mon_type === '1') {
                    ...
                    this.$router.push({ path: 'add/relateditemsScript' })
                }
            },
            // 模板新增设备
            addevices() {
