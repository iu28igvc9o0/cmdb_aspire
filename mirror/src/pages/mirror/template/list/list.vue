        ...
        <el-dialog class="yw-dialog"
            ...
            <section class="yw-dialog-main">
                <template-editor ref="templateEditor"
                                 :currentCodeInfo="currentTemplateInfo"
                                 @closeDialog="closeEditDialog"></template-editor>
            </section>
            <section class="btn-wrap">
                <el-button type="primary"
...
<script>
    ...
    import templateEditor from '../../../auto_operation/inspection/template/edit/template-editor.vue'
