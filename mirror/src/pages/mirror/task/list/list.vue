<template>
    <div class="component-container">
        <header>
            ...
            <div class="dataTime">
                ...
                <div class="ym-location">
                    <el-button class="tem-search task-list-button"
                               type="primary"
        ...
        <div class="body-container">
            ...
            <el-button type="text"
                       icon=""
                       @click="goDetails">查看任务详情</el-button>
            <el-button type="text"
                       icon=""
                       @click="execute">立即执行</el-button>
            <el-button type="text"
                       icon=""
                       @click="addSchedu">添加调度</el-button>
            <el-button type="text"
                       icon=""
                       @click="stopSchedu">停止调度</el-button>
            <el-button type="text"
                       icon=""
                       @click="goResult">查看巡检结果</el-button>
...
<style lang="scss" scoped>
    ...
    /deep/.el-table .cell {
        ...
        padding: 0.02604rem 0.02604rem 0.02604rem 10px;
    }
</style>
