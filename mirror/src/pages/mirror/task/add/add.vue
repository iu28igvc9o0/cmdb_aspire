    ...
    <div class="component-container">
            ...
            <div class="head">
                <el-form :model="template"
                    ...
                    <el-form-item prop="receivers"
                                  ...
                                  class="add-tit"
                                  label-width="140px">
                        <el-input v-model="template.receivers"
                                  placeholder="请输入内容"
        ...
        <el-select v-model="type" placeholder="请选择" class="list-sel">
            ...
            <div class="dataTime">
                ...
                <div v-if=' cycle == "自定义" '
                    ...
                    <el-input v-model="exec_time"
                              placeholder="请输入cron表达式"
                              class="input-creat-time zidingyi"
                              @change="cronVal"
                              ref="cron"
                              suffix-icon="el-icon-warning"></el-input>
                    <span class="cron"
                          ref="cronText">请输入6位数正确的cron表达式</span>
                </div>

                <div v-if=' cycle == "分钟" '>
                    <el-input-number v-model="exec_time"
                ...
                <div v-if=' cycle == "日" '>
                    <el-time-picker v-model="exec_time"
                                    placeholder="选择日期时间"
        ...
        <div class="body-container">
            ...
            <el-table :data="tableData"
                ...
                <el-table-column label="模板关联"
                                 align="center">
                    <template slot-scope="scope">
                        <el-button type="text"
                                   @click="editTemplate(scope.row, scope.$index)">模板编辑</el-button>
                    </template>
                </el-table-column>
                <el-table-column prop="devices_ip_more"
                                 label="关联对象"
                                 align="center">
                </el-table-column>
                <el-table-column label="对象关联"
                                 align="center">
                    <template slot-scope="scope">
                        <el-button type="text"
                                   @click="editDevices(scope.row)"
                                   v-if="scope.row.mon_type === '系统模板'">设备编辑</el-button>
                        <el-button type="text"
                                   @click="editDevices(scope.row)"
                                   v-else-if="scope.row.mon_type === '业务模板' ? getBizname(scope.row) : false"
                                   disabled>业务编辑</el-button>
                        <el-button type="text"
                                   @click="editDevices(scope.row)"
                                   v-else>对象编辑</el-button>
                    </template>
        ...
        <el-dialog title="选择用户"
            ...
            <span slot="footer"
                ...
                <el-button @click="dialogVisible = false"
                           class="tem-search1"
                           width="auto">取 消</el-button>
                <el-button type="primary"
                           @click="goUser"
                           class="tem-search1"
                           width="auto">确 定</el-button>
            </span>
            ...
            saveData() {
                ...
                this.tableData.forEach((item) => {
                    let obj = {
                        ...
                        object_type: item.mon_type === '业务系统' ? '2' : item.mon_type === '设备' ? '1' : '3'
                    }
                    arr.push(obj)
                })
                let obj = {
