    ...
    <div class="component-container">
        <el-form :model="form1"
            ...
            <el-form-item label="角色名称"
                ...
                <el-input v-model="form1.name"
                          placeholder="接受A-Za-z0-9-_等字符"></el-input>
            </el-form-item>
            ...
            <el-form-item label="父角色"
                ...
                <el-form :model="dynamicValidateForm"
                    ...
                    <el-form-item v-for="(domain, index) in dynamicValidateForm.domains"
                        ...
                        <!--选择父角色-->
                        <el-select v-model="domain.selectRole"
                                   placeholder="请选择父角色"
                                   filterable
                                   style="width: 90%">
                        ...
                        <i class="el-icon-view"
                           @click="loadParentRoleDetailPermission(domain.selectRole)" />
                    ...
                    <el-form-item>
                        <el-row>
                            <div align="center"
                                 @click="addDomain"
                                 style="background-color: silver; width: 90%;cursor: pointer">
                ...
                <el-row id="row2"
                    ...
                    <el-col :span="24">
                        <el-table :data="tableData"
                                  stripe
                                  style="width: 100%">
                            <el-table-column prop="resour"
                                             label="资源"
                                             width="180">
                                <template slot-scope="scope">
                                    <div v-for="(item,index) in scope.row.resour"
                                         :key="index">{{item}}</div>
                                </template>
                            </el-table-column>
                            <el-table-column prop="actionName"
                                             ...
                                             width="180">
                                <template slot-scope="scope">
                                    <div v-for="(item,index) in scope.row.actionName"
                                         :key="index">{{item}}</div>
                                </template>
                            </el-table-column>
                            <el-table-column prop="con"
                                             label="约束条件">
                                <template slot-scope="scope">
                                    <div v-for="(item,index) in scope.row.con"
                                         :key="index">{{item}}</div>
                                </template>
                            </el-table-column>
                            <el-table-column prop="actions"
                                             label="操作">
                                <template slot-scope="scope">
                                    <el-button @click="updatePermissions(scope.$index, scope.row)"
                                               size="small"><i class="el-icon-edit"></i></el-button>
                                    <el-button @click.native.prevent="deleteRow(scope.$index, tableData)"
                                               size="small"><i class="el-icon-close"></i></el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                    </el-col>
        ...
        <div>
            <el-button size="mini"
                       plain
                       class="pull-right"
                       @click="getAllRoleSchemas()">添加</el-button>
            <br />
        </div>

        <div slot="footer"
             class="pull-right"><br />
            <el-button class="create-role"
                       type="primary"
                       @click="createRole('form1')">创 建</el-button>
            <el-button class="cancel-add-permission"
                       @click="cancleCreateRole">取 消</el-button>
        </div>

        <el-dialog class="add-permission-dialog"
                   :title="this.showName"
            ...
            <el-form :model="form"
                ...
                <el-form-item label="资源"
                    ...
                    <el-input v-model="form.resourceName"
                              auto-complete="off"
                              placeholder="资源名请用逗号分离"></el-input>
                </el-form-item>
                ...
                <el-form-item label="约束条件"
                        ...
                        <el-form-item class="add-constraint-group-item"
                            ...
                            <div class="demo-rangs"
                                ...
                                <el-row style="height:auto">
                                    <el-col :span="10"
                                            class="row-col-rource-constraint list-demo-range">
                                    ...
                                    <el-col :span="10"
                                            class="row-col-rource-constraint">
                                    ...
                                    <el-col :span="2">
                                        <el-button class="showConstraint"
                                                   @click="openConDataView()"
                                                   type="info"
                                                   size="mini"
                                                   plain>添加</el-button>
                                    </el-col>
                                ...
                                <el-row v-if="conIsView">
                                    <el-col class="con-is-view"
                                            :span="10">
                                        <div>{{constraintForm.groups[index].constraintSelect}}</div>
                                    </el-col>
                                    <el-col class="con-is-view"
                                            :span="10">
                                        <div>{{constraintForm.groups[index].constraintName}}</div>
                                    </el-col>
                                    <el-col class="pull-right"
                                            :span="2"><i class="el-icon-close"
                    ...
                    <div class="add-group-range">
                        <el-button size="mini"
                                   type="info"
                                   class="pull-right add-one-group-constraint"
                                   @click="addGroup()"
            ...
            <div slot="footer"
                 style="">
                <el-button class="cancel-add-permission"
                           @click="permissionVisible = false">取消</el-button>
                <el-button class="confirm-add-permission"
                           type="primary"
                           @click="addPermissions('constraintForm')">确认</el-button>
            </div>
        </el-dialog>
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        if (this.createRoleInFormation.parents.length === 0 && this.createRoleInFormation.permissions.length === 0) {
                            ...
                            rbRoleService.createRole(this.createRoleInFormation).then(() => {
                                this.$message({
                                    type: 'success',
                                    message: '角色创建成功'
                                })
