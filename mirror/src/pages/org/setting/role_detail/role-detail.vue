<template>
    <div class="component-container">
        ...
        <el-row style="margin-bottom:20px">
            ...
            <el-col :span="19">
                <el-button v-show="roleCreate"
                           class="pull-right"
                           @click="copyRole">复制角色</el-button>
            </el-col>
        </el-row>
                        ...
                        <el-tabs v-model="activeName">
                            ...
                            <el-tab-pane label="权限"
                                ...
                                <el-button type="primary"
                                           ...
                                           v-show="roleUpdate"
                                           size="small"
                                           class="pull-right">添加权限</el-button>
                                <el-table :data="permissions"
                                    ...
                                    <el-table-column prop="resource"
                                        ...
                                        <template slot-scope="scope">
                                            <div v-for="(item,index) in scope.row.resource"
                                                 :key="index">{{item}}</div>
                                        </template>
                                    </el-table-column>
                                    <el-table-column prop="actions"
                                                     ...
                                                     width="240">
                                        <template slot-scope="scope">
                                            <div v-for="(item,index) in scope.row.actions"
                                                 :key="index">{{item}}</div>
                                        </template>
                                    </el-table-column>
                                    <el-table-column prop="constraints"
                                                     label="约束条件"
                                                     width="540">
                                        <template slot-scope="scope">
                                            <div v-for="(item,index) in scope.row.constraints"
                                                 :key="index">{{item}}</div>
                                        </template>
                                    </el-table-column>
                                    <el-table-column prop="action"
                                                     ...
                                                     width="70">
                                        <template slot-scope="scope">
                                            <el-tooltip prop="update_password"
                                                        content="更新权限"
                                                        placement="top">
                                                <el-button type="text"
                                                           @click="updatePermissionFunction(permissions[scope.$index].uuid)">
                                                    <i v-show="roleUpdate"
                                                       class="el-icon-edit"></i>
                                                </el-button>
                                            </el-tooltip>
                                            <el-tooltip prop="delete"
                                                        content="删除权限"
                                                        placement="top">
                                                <el-button type="text"
                                                           @click="deletePermission (permissions[scope.$index].uuid)">
                                                    <i v-show="roleUpdate"
                            ...
                            <el-tab-pane label="父角色"
                                         name="parentRole">
                                <input v-model="searchParentRole"
                                       placeholder="按名称搜索"
                                       width="180" />
                                <el-button type="primary"
                                           @click="getRoleList()"
                                           v-show="roleUpdate"
                                           class="pull-right"
                                           size="small">添加父角色</el-button>
                                <el-table :data="searchParents"
                                          stripe
                                          style="width: 100%">
                                    <el-table-column prop="name"
                                                     ...
                                                     width="810">
                                        <template slot-scope="scope">
                                            <el-button @click.native.prevent="loadParentRoleDetail(scope.$index, scope.row.name)"
                                                       type="text"
                                                       size="small">
                                                {{scope.row.name}}
                                            </el-button>
                                    ...
                                    <el-table-column prop="assigned_at"
                                                     label="添加时间"
                                                     width="220">
                                        <template slot-scope="scope">
                                    ...
                                    <el-table-column prop="action"
                                        ...
                                        <template slot-scope="scope">
                                            <el-button type="text"
                                                       @click="loadParentRoleDetailPermission(scope.row.name)">
                                                <i v-show="roleView"
                                                   class="el-icon-view" />
                                            </el-button>
                                            <el-tooltip content="删除"
                                                        placement="top">
                                                <el-button type="text"
                                                           @click="deleteParentRole(scope.row.name,parents[scope.$index].uuid)">
                                                    <i v-show="roleUpdate"
                            ...
                            <el-tab-pane label="成员"
                                ...
                                <el-button type="primary"
                                           ...
                                           size="small"
                                           @click="addSubaccount()"
                                           v-show="roleAssign">添加用户</el-button>
                                <el-table :data="searchRoleUsers"
                                          stripe
                                          style="width: 100%">
                                    <el-table-column prop="user"
                                                     label="用户名"
                                                     width="850"></el-table-column>
                                    <el-table-column prop="assigned_at"
                                                     label="添加时间"
                                                     width="220">
                                        <template slot-scope="scope">
                                    ...
                                    <el-table-column prop="action"
                                        ...
                                        <template slot-scope="scope">
                                            <el-tooltip content="删除"
                                                        placement="top">
                                                <el-button type="text"
                                                           @click="revokeRoleUsers(scope.row.user)">
                                                    <i v-show="roleAssign"
                                                       class="el-icon-delete"></i>
                                                </el-button>
                                            </el-tooltip>
        ...
        <el-dialog title="父角色详情预览"
                   :visible.sync="parentPermissionView"
                   :close-on-click-modal="false">
            <el-row :gutter="20">
                <el-col :span="4">
                    <div class="pull-right">角色</div>
                </el-col>
                <el-col :span="20">{{this.parentRoleName}}</el-col>
            </el-row><br />
            <el-row :gutter="20">
                <el-col :span="4">
                    <div class="pull-right">权限</div>
                </el-col>
                <el-col :span="20">
                    <div style="border:1px solid #dcdcdc">
                        <el-table :data="parentRoleDetail"
                                  stripe
                                  style="width: 100%">
                            <el-table-column prop="resource"
                                             label="资源"
            ...
            <div slot="footer"
                 class="dialog-footer">
                <el-button type="primary"
                           @click="parentPermissionView = false">好</el-button>
            </div>
        </el-dialog>

        <el-dialog title="添加父角色"
                   :visible.sync="addParentRole"
                   :close-on-click-modal="false">
            <el-row :gutter="20">
                <el-col :span="4">
                    <div class="pull-right">父角色</div>
                </el-col>
                <el-col :span="20">
                    <el-select v-model="addParentRoleName"
                               filterable
                               placeholder="请选择父角色">
            ...
            <div slot="footer"
                ...
                <el-button type="primary"
                           @click="addParentRoleForRole ()">确认</el-button>
            </div>
        </el-dialog>

        <el-dialog :title="text"
                   :visible.sync="updatePermission"
                   :close-on-click-modal="false">
            <el-form :model="form"
                     ref="form"
                     :rules="rules"
                ...
                <el-form-item label="资源"
                    ...
                    <el-input v-model="form.resourceName"
                              auto-complete="off"
                              placeholder="资源名称请以逗号分隔"></el-input>
                </el-form-item>

                <el-form-item label="操作"
                              prop="actions"
                              :rules="{required: true, message: '请选择操作'}">
                    <el-select v-model="form.actions"
                               multiple
                               placeholder="请选择操作"
                               style="width: 100%">
                        <el-option v-for="item in allActions"
                                   :key="item.label"
                                   :label="item.label"
                                   :value="item.label">
                        </el-option>
                ...
                <el-form-item label="约束条件"
                              prop="name">
                    <el-form :model="constraintForm"
                             ref="constraintForm"
                             style="width: 100%"
                             class="demo-dynamic">
                        <el-form-item v-for="(group, index) in constraintForm.groups"
                                      :key="group.key"
                                      :prop="'groups.' + index + '.value'">
                            <div style="border:1px solid gainsboro">
                                <el-row>
                                    <el-col :span="11">
                                        <div style="text-indent: 5px;">字段</div>
                                    </el-col>
                                    <el-col :span="11">
                                        <div>值</div>
                                    </el-col>
                                    <el-col :span="2"
                                        ...
                                        <i class="el-icon-delete"
                                           @click.prevent="deleteGroup(group)"></i>
                                    </el-col>
                                </el-row>
                                <!--资源约束条件选择列表区域-->
                                <el-row :gutter="2">
                                    <el-col :span="12">
                                        <el-select v-model="group.constraintSelect"
                                                   @change="getProjectList"
                                                   placeholder="选择约束条件类型">
                                    ...
                                    <el-col :span="9">
                                        <el-input v-show=isProjectInput
                                                  v-model="group.constraintName"
                                                  type="text"></el-input>
                                        <el-select v-show=isProjectSelect
                                                   v-model="group.constraintName"
                                                   filterable
                                                   allow-create
                                    ...
                                    <el-col :span="3">
                                        <el-button @click="openConDataView()"
                                                   type="info"
                                                   size="mini"
                                                   plain>添加</el-button>
                                    </el-col>
                                    <div v-if="conIsView">
                                        <el-col :span="12">
                                            <div align="left">{{constraintForm.groups[index].constraintSelect}}</div>
                                        </el-col>
                                        <el-col :span="9">
                                            <div align="left">{{constraintForm.groups[index].constraintName}}</div>
                                        </el-col>
                                        <el-col :span="3"><i class="el-icon-close"
                                               @click="closeView"></i></el-col>
                                    </div>
                                </el-row>
                            </div>
                        </el-form-item>
            ...
            <div slot="footer"
                ...
                <el-button type="primary"
                           @click="signPermission('form')">确认</el-button>
            </div>
        </el-dialog>
        ...
        <el-dialog title="添加用户"
            ...
            <el-row :gutter="20">
                <el-col :span="4">
                    <div class="pull-right">用户名</div>
                </el-col>
                <el-col :span="20">
                    <el-select v-model="addUsers"
                               filterable
                               multiple
                               placeholder="请选择用户">
            ...
            <div slot="footer">
                ...
                <el-button type="primary"
                           @click="addUsersForRole()">创建</el-button>
            </div>
        </el-dialog>

        <el-dialog title="删除权限"
                   :visible.sync="deletePermissonDialog"
                   :close-on-click-modal="false">
            ...
            <span slot="footer"
                ...
                <el-button type="primary"
                           @click="confirmDeletePermission()">确 定</el-button>
            </span>
        </el-dialog>

        <el-dialog title="删除父角色"
                   :visible.sync="deleteParentDialog"
                   :close-on-click-modal="false">
            ...
            <span slot="footer"
                ...
                <el-button type="primary"
                           @click="confirmDeleteParent()">确 定</el-button>
            </span>
        </el-dialog>

        <el-dialog title="删除父角色"
                   :visible.sync="deleteRoleUserDialog"
                   :close-on-click-modal="false">
            ...
            <span slot="footer"
                ...
                <el-button type="primary"
                           @click="confirmDeleteRoleUser()">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            commitAddPermission(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        try {
                            rbRoleService.addPermission(this.name, permissonData).then(() => {
                                this.$message({
                                    type: 'success',
                                    message: '权限添加成功!'
                                })
            ...
            addUsersForRole() {
                ...
                rbRoleService.addUsersForRole(data, roleName).then(() => {
                    this.$message({
                        type: 'success',
                        message: '用户关联角色成功!'
                    })
            ...
            addParentRoleForRole() {
                try {
                    ...
                    const roleName = this.name
                    rbRoleService.addParentForRole(data, roleName).then(() => {
                        this.$message({
                            type: 'success',
                            message: '添加父角色成功!'
                        })
