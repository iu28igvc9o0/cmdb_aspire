                        ...
                        <div class="top-item">
                            <el-row class="panel-master-1">
                                <el-col class="panel-heading-1">
                                    ...
                                    <ul>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell red"
                                                  aria-hidden="true"></span><span id="host3"></span>{{businessData.host.critical}}
                                        </li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell orange"
                                                  aria-hidden="true"></span><span id="host4">{{businessData.host.high}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell yellow"
                                                  aria-hidden="true"></span><span id="host5">{{businessData.host.medium}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell gray"
                                                  aria-hidden="true"></span><span id="host6">{{businessData.host.low}}</span></li>
                                    </ul>
                                </el-col>
                            </el-row>
                        </div>
                        ...
                        <div class="top-item">
                            <el-row class="panel-success-1">
                                <el-col class="panel-heading-1">
                                    ...
                                    <ul>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell red"
                                                  aria-hidden="true"></span><span id="net3">{{businessData.network.critical}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell orange"
                                                  aria-hidden="true"></span><span id="net4">{{businessData.network.high}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell yellow"
                                                  aria-hidden="true"></span><span id="net5">{{businessData.network.medium}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell gray"
                                                  aria-hidden="true"></span><span id="net6">{{businessData.network.low}}</span></li>
                                    </ul>
                                </el-col>
                            </el-row>
                        </div>
                        ...
                        <div class="top-item">
                            <el-row class="panel-warning-1">
                                <el-col class="panel-heading-1">
                                    ...
                                    <ul>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell red"
                                                  aria-hidden="true"></span><span id="storage3">{{businessData.storage.critical}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell orange"
                                                  aria-hidden="true"></span><span id="storage4">{{businessData.storage.high}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell yellow"
                                                  aria-hidden="true"></span><span id="storage5">{{businessData.storage.medium}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell gray"
                                                  aria-hidden="true"></span><span id="storage6">{{businessData.storage.low}}</span></li>
                                    </ul>
                                </el-col>
                            </el-row>
                        </div>
                        ...
                        <div class="top-item">
                            <el-row class="panel-info-1">
                                <el-col class="panel-heading-1">
                                    ...
                                    <ul>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell red"
                                                  aria-hidden="true"></span><span id="database3">{{businessData.database.critical}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell orange"
                                                  aria-hidden="true"></span><span id="database4">{{businessData.database.high}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell yellow"
                                                  aria-hidden="true"></span><span id="database5">{{businessData.database.medium}}</span></li>
                                        <li class="col-md-3"><span class="glyphicon glyphicon-bell gray"
                                                  aria-hidden="true"></span><span id="database6">{{businessData.database.low}}</span></li>
                                    </ul>
                                </el-col>
                            </el-row>
                        </div>
                    ...
                    <el-col :span="12">
                        <div class="panel panel-default">
                            <div class="panel-heading ">
                                ...
                                <div style="float:right;margin-top:-20px;"><select id="ZYCAndRHTX5"
                                            class="selectStyle"
                          ...
                          <option value="RHTX">融合通信资源池</option> -->
                                        <option v-for="(item, index) in idc"
                                                :value="item.VALUE"
                ...
                <el-row :gutter="10"
                                ...
                                <tbody>
                                    <tr>
                                        <td width="10%"
                                            ...
                                            style="padding: 0">
                                            <div id="storageImage"
                                                 @click="selectStoryage()"><span :class="['nav_left', {'storageImageSelect':selectCard === 'storage','storageImage':selectCard !== 'storage'}]"></span>内存
                                            </div>
                                        </td>
                                        <td rowspan="3">
                                            <div style="width:100%;height:215px;padding:10px;"
                                                 id="serverUsageDistribution">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center"
                                            style="padding: 0">
                                            <div id="cpuImage"
                                                 @click="selectCpu()"><span :class="['nav_left', {'cpuImageSelect':selectCard === 'cpu','cpuImage':selectCard !== 'cpu'}]"></span>CPU
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center"
                                            ...
                                            <div id="hardwareImage"
                                                 @click="selectHardware()"><span :class="['nav_left', {'hardwareImageSelect':selectCard === 'hardware','hardwareImage':selectCard !== 'hardware'}]"></span>存储
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <el-col :span="12">
                        <div class="panel panel-default">
                            ...
                            <div style="height:226.5px;padding:1px"
                                 id='dgs'>
                                <el-table id="dg"
                                          :data="visualAccountStatisticsOV"
                                          border
                                          max-height="225"
                                          size="small"
                                          style="width: 100%"
                                          header-row-class-name="tabelHeadClass"
                                          row-class-name="tabelRowClass">
                                    <el-table-column prop="businessName"
                                                     label="业务系统"></el-table-column>
                                    <el-table-column prop="physicalMachine"
                                                     label="物理机(台)"></el-table-column>
                                    <el-table-column prop="virtualMachine"
                                                     label="虚拟机(台)"></el-table-column>
                                    <el-table-column prop="storage"
                                                     label="存储(T)"></el-table-column>
                                    <el-table-column prop="database"
                                                     label="数据库"></el-table-column>
                                    <el-table-column prop="bandwidth"
                                                     label="带宽"></el-table-column>
                                    <el-table-column prop="os"
                                                     label="操作系统"></el-table-column>
                                    <el-table-column prop="total"
                                                     label="总金额(元)"
                                                     :formatter="totalMoneyFormatter"></el-table-column>
                                </el-table>
                            </div>
                        </div>
                    </el-col>
                    ...
                    <el-col :span="12">
                        <div class="panel panel-default">
                            <div class="panel-heading ">
                                ...
                                <div style="float:right;margin-top:-20px;">
                                    <select id="ZYCAndRHTX3"
                                            class="selectStyle"
                                            style="width:90px;"
                                            v-model="resourceUsageAnalyseIDC">
                                        <option value="ZYC">资源池</option>
                                        <option value="RHTX">融合通信</option>
                                    </select>
                                    <div class="panel-date">
                                        <el-date-picker id='beginDate1'
                                                        v-model="beginDate"
                                                        class="date-time"
                                                        size="mini"
                                    ...
                                    <div id="searchBtn1"
                                         class="panel-image approach"><img style="margin:2px 20% 0 20%;height:16px;"
                                             src="/static/img/osa/icon_find.png" />
                                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td width="10%"
                                            class="text-center"
                                            style="padding: 0">
                                            <div id="storageImage2"><span :class="['nav_left', {'storageImageSelect':resourceSelectCard === 'storage','storageImage':resourceSelectCard !== 'storage'}]"></span>内存
                                            </div>
                                        </td>
                                        <td rowspan="3">
                                            <div style="width:100%;height:215px;padding:10px;"
                                                 id="resourcePoolUsageAnalyze">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center"
                                            style="padding: 0">
                                            <div id="cpuImage2"><span :class="['nav_left', {'cpuImageSelect':resourceSelectCard === 'cpu','cpuImage':resourceSelectCard !== 'cpu'}]"></span>CPU
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center"
                                            style="padding: 0">
                                            <div id="hardwareImage2"><span :class="['nav_left', {'hardwareImageSelect':resourceSelectCard === 'hardware','hardwareImage':resourceSelectCard !== 'hardware'}]"></span>存储
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <div style="float:right;margin-top:-20px;">
                                    <div class="panel-date">
                                        <input id='beginDate2'
                                               type="text"
                                               class="date-time"
                                               style="border:0;width:90px;height:22px"
                                               onClick="WdatePicker();">
                                        <div class="date-btn">
                                            <div class="date-icon"></div>
                                        </div>
                                    ...
                                    <div id="searchBtn2"
                                         class="panel-image approach"><img style="margin:2px 20% 0 20%;height:16px;"
                                             src="${ctxStatic}/newthemes/images/icon_find.png" />
                                    </div>
                                </div>
                            </div>
                            <table class="table table-bordered">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //
            // },
            totalMoneyFormatter: function (row) {
