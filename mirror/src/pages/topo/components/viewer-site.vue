<template>
    <div id="wrapper"
        ...
        <div class="has-topo"
             v-show="showTopoView">
            <div class="top">
                <TopoInfo :topoData="topoData"></TopoInfo>
                <!--@changeTopo="changeTopo"-->
                <div class="tools">
                    <div class="line"
                         v-if="defaultOptions.onlineTab"></div>
                    <el-tooltip class="item"
                                effect="dark"
                                content="检索路径"
                                placement="bottom-start"
                                v-if="defaultOptions.onlineTab">
                        <div class="btn-lists">
                            <div class="btn-item"
                                 @click="getPath">
        ...
        <el-dialog class="yw-dialog"
            ...
            <el-form :inline="true"
                ...
                <el-form-item label="源地址"
                              prop="sourceIp">
                    <el-input v-model="form.sourceIp"
                              placeholder="源地址"></el-input>
                </el-form-item>
                <el-form-item label="目标地址"
                              prop="destIp">
                    <el-input v-model="form.destIp"
                              placeholder="目标地址"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            async getChildView(params) {
                if (params.name === 'AlertList') {
                    ...
                    this.$http.sendRequest({
                        ...
                        data: { idcType: params.idcType, ip: params.deviceIp, token: '5245ed1b-6345-11e' }
                    }).then((res) => {
                        let queryParams = {
