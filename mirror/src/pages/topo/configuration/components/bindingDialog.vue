    ...
    <div class="component">
        <el-container>
            ...
            <div class="itemDiv"
                 v-if="active == 1">
                <el-main>
                    <choose-item :deviceList="deviceList"
                                 :itemList="itemList"
                                 @changeItemList="changeItemList"></choose-item>
                </el-main>
                <el-footer style="height: 40px;text-align: center;">
                ...
                <el-main v-if="this.dialogData.bandType == 0">
                    <el-form :model="bindData"
                        ...
                        <el-form-item prop="name"
                            ...
                            <el-input type="text"
                                      v-model="bindData.name"></el-input>
                        </el-form-item>
                        <el-form-item label="告警显示值设置">
                            <el-checkbox-group v-model="bindData.alertLevelList"
                                               @change="alertListChangeEvent()">
                                <el-checkbox label="2"
                                             value="2">低</el-checkbox>
                                <el-checkbox label="3"
                                             value="3">中</el-checkbox>
                                <el-checkbox label="4"
                                             value="4">高</el-checkbox>
                                <el-checkbox label="5"
                                             value="5">重大</el-checkbox>
                            </el-checkbox-group>
                        </el-form-item>
                ...
                <el-main v-if="this.dialogData.bandType == 1">
                    <el-form :model="bindData"
                        ...
                        <el-form-item prop="unit"
                                      ...
                                      :rules="{required: true, message: '不能为空', trigger: 'blur'}">
                            <el-input type="text"
                                      v-model="bindData.unit"
                                      placeholder></el-input>
                        </el-form-item>
                        <el-form-item label="换算">
                            <el-select style="width:120px"
                                       v-model="bindData.conversionType"
                                       placeholder="请选择">
                                <el-option label="相乘"
                                           value="1"></el-option>
                                <el-option label="相除"
                            ...
                            <el-input type="number"
                                      v-model="bindData.conversionVal"
                                      style="width:150px;" />
                        ...
                        <el-form-item prop="countType"
                                      label="统计方式"
                                      :rules="{required: true, message: '不能为空', trigger: 'blur'}">
                            <el-select v-model="bindData.countType"
                                       placeholder="请选择">
                                <el-option label="最大"
                                           value="max"></el-option>
                                <el-option label="最小"
                            ...
                            <el-checkbox style="padding-left: 20px; width: 400px"
                                         v-model="bindData.valueView">是否显示监控值</el-checkbox>
                        </el-form-item>
                        <el-form-item label="设置阀值">
                            <el-button class="device-add"
                                       type="primary"
                                       @click="addSill()">新增</el-button>
                            <el-button class="device-del"
                                       type="primary"
                                       @click="deleteSill()">删除</el-button>
                        </el-form-item>
                        <el-table :data="sillList"
                                  border
                            ...
                            <el-table-column prop="name"
                                ...
                                <template slot-scope="scope">
                                    <el-select v-model="sillList[scope.$index].expressionSymbol">
                                        <el-option label="大于"
                                                   value=">"></el-option>
                                        <el-option label="小于"
                                                   value="<"></el-option>
                                        <el-option label="等于"
                                                   value="=="></el-option>
                                        <el-option label="大于或等于"
                                                   value=">="></el-option>
                                        <el-option label="小于或等于"
                                                   value="<="></el-option>
                                    </el-select>
                                    <el-input class="dom"
                                              v-model="sillList[scope.$index].expressionValue"
    ...
    export default {
        ...
        methods: {
            ...
            addSill() {
                ...
                this.sillList.push({ expressionSymbol: '>', expressionValue: '', color: '' })
