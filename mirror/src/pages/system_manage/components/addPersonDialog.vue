                ...
                <el-form class="yw-form is-required"
                    ...
                    <el-form-item label="部门"
                        ...
                        <el-popover placement="bottom-start"
                            ...
                            <comtree class="person-manage__tree"
                                     :data="departmentData"
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                personForm: {
                    ...
                    sex: '',
                    // userType: '2',
                    // 判断是否是cdn项目，如果是的话，cdn只有正式用户
                    userType: this.cdn != 'cdn' ? '2' : '1',
                    fax: '',
                    address: '',
                    no: '',
                    relationPerson: '',
        ...
        methods: {
            ...
            addPerson(form, pictureData) {
                personDataService.addPerson(form, pictureData).then(() => {
            ...
            updatePerson(uuid, form, pictureData) {
                personDataService.updatePerson(uuid, form, pictureData).then(() => {
