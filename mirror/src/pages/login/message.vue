            ...
            <div class="dialog-box">
                ...
                <section class="dialog-body">
                    ...
                    <div class="sms-wrap">
                        ...
                        <i class="sms-btn disabled"
                           v-show="getCodeVisiable">{{count}}s</i>
                        <i class="sms-btn"
                           v-show="!getCodeVisiable"
                           @click="getMassageCode">获取验证码</i>
                    </div>
                    <p class="error-tip"
                       v-if="errorTip">验证码错误，请重新获取</p>
                    <div class="btn-wrap">
                        <a class="btn"
                           type="button"
                           @click="login">登 录</a>
    ...
    export default {
        ...
        methods: {
            getMassageCode() {
                ...
                messageService.sendSmsCaptcha(param).then(() => {
                    this.errorTip = false
                    this.getCode()
                }).catch(() => {
                    this.errorTip = true
            ...
            login() {
                ...
                messageService.validSmsCaptcha(param).then(() => {
                    this.$message({
                        type: 'success',
                        message: '登录成功'
                    })
