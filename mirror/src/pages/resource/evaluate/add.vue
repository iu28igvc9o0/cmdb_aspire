<template>
    <div class="components-container evalute">
        ...
        <YwImport ref="importInstances"
                  ...
                  @setExportTemplate="setExportDownloadTemplate"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 导出下载模板
            setExportDownloadTemplate(data) {
                rbAssServiceFactory.exportCollectUnknown(data).then((res) => {
                    this.exportFiles({
                        data: res,
                        fileType: 'application/vnd.ms-excel',
                        fileName: '评估得分信息导入模板.xlsx'
                    })
                    return res
                })
            },
            ...
            resolveResult(type) {
                ...
                let temp = {}
                this.titleColumns.total.forEach((item) => {
                    temp[item.id] = {
                        'produce': '',
