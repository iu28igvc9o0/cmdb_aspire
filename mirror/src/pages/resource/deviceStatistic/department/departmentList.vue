        ...
        <el-form class="components-condition yw-form"
            ...
            <el-form-item label="二级部门">
                <el-select v-model="department2"
                           @change="getbizSystemList(department2)"
                           placeholder="请选择"
                           clearable
                           filterable>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            changeDeviceTypeList () {
              
                var obj = {
                    type: 'device_type',
                     pType: 'device_class',
                    pid: this.device_class
                }
                configDictServiceFactory.getDictsByType(obj).then((res) => {
            ...
            getdeviceMfrsList () {
                ...
                configDictServiceFactory.getProduce(data).then((res) => {
                    console.log(res)
