    ...
    export default {
        ...
        data() {
            return {
                ...
                listShow: true,
                moduleType: 'host',
                condicationCode: 'search_public_segment',// 'instance_list','ip_repository_inner'
                condicationCode1: 'search_public_ip',
                loading: false,
                loading_text: '正在加载数据，请稍等...',
                businessUuid: '',
                moduleId: 'b363417c8eac4fa3ad808f7edae7e67a',
                moduleId1: 'bdea5664089d4fdfa975570b6348424e',
                filterText: '',
                treeLoading: false,
                department1: '',
                department2: '',
                ...
                viewCodeName: 'public_segment_view',
                isRefresh: true,
                routerName: 'ResourceIframePublicNet'
            }
        },
        mounted: function () {
            this.initTree()
        ...
        methods: {
            ...
            tabCheck(data) {
                ...
                this.segmentAddr = ''
                if (data) {
                    this.condicationCode = 'search_public_segment'
                    this.moduleId = 'b363417c8eac4fa3ad808f7edae7e67a'
                    this.ipSingal = ''
                } else {
                    this.condicationCode1 = 'search_public_ip'
                    this.moduleId1 = 'bdea5664089d4fdfa975570b6348424e'
                    this.ipSingal = 'all'
                }
                this.listShow = data
                if (!data) {
            ...
            tabCheck1(data) {
                ...
                if (data.check) {
                    ...
                    if (data.query.public_segment_address) {
                        this.bizSystemCondition = {
                            all: {
                                value: data.query.public_segment_address,
                                key: data.query.public_segment_address,
                                id: data.query.id,
                                type: {
                                    idcType: data.query.idcType_dict_note_name,
                                    public_segment_type: data.query.public_segment_type_dict_note_name,
                                    public_ip_type: data.query.public_ip_type_dict_note_name,
                                    public_segment_address: data.query.public_segment_address
                                },
                                tree: {
                                    queryToData: {
                                        idcType: data.query.idcType,
                                        public_segment_type: data.query.public_segment_type,
                                        public_ip_type: data.query.public_ip_type,
                                        public_segment_address: data.query.public_segment_address
                                    }
                                }
                            }
