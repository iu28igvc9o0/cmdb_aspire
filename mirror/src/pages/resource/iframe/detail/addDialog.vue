                ...
                <el-form-item label="对端设备IP"
                    ...
                    <el-select v-model="form.zInstanceId"
                        ...
                        <template v-for="(item, index) in currentList">
                            <el-option v-if="item.id !== instanceId"
                                       :key="index"
                                       :label="item.ip"
                                       :value="item.id">
                            </el-option>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                rules: {
                    aPortId: [{ required: true, message: '请填写本地端口', trigger: 'blur' }, { max: 40, message: '最大长度40', trigger: 'blur' }],
                    idcType: [{ required: true, message: '请选择对端资源池', trigger: 'blur' }],
                    zInstanceId: [{ required: true, message: '请选择对端设备IP', trigger: 'blur' }],
                    zPortId: [{ required: true, message: '请填写对端端口', trigger: 'blur' }, { max: 40, message: '最大长度40', trigger: 'blur' }],
