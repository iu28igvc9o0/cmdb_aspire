<template>
    <div class="detailsColumn">
        ...
        <div id="myAnnular"
             style="float:left;width:34.5%;height:calc(100% - 42px);"></div>
        <div class="column">
            <div class="line"></div>
            <div class="title">{{zuInfo.department2}}业务系统设备分布</div>
            <div id="myDetailsColumnSubordinate"
        ...
        methods: {
            ...
            drawPie() {
                ...
                myPie.setOption({
                    ...
                    color: ['#5B94FF', '#1DDCEE', '#FFDF61', '#F8475C', '#FF862D', '#4FFF57', '#DFFF70', '#FFE823', '#607FF1', '#305BFF', '#0DA8FF', '#FFBC07', '#DD0F2C', '#FF6600', '#18DAAA', '#31D550', '#AFF800', '#1C56D9'], // 配置颜色
                    tooltip: {
                        // 提示事件类型和格式
                        trigger: 'item',
                ...
                myPie.on('click', function (params) { that.zuInfo.department2 = params.name === '未知' ? '' : params.name, that.getCountByIdcDep2Biz() })
            }
        }
    }
</script>
