            ...
            <div class="yw-el-table-wrap">
                <el-table :data="tableData"
                    ...
                    <el-table-column prop="podName"
                                     ...
                                     width="150px"
                                     :show-overflow-tooltip="true"></el-table-column>
                    <el-table-column prop="totalPlannedApplication"
                                     label="计划申请总量（台）"
                                     width="150px"
                                     :show-overflow-tooltip="true"></el-table-column>
                    <el-table-column prop="totalAllocatedEquipment"
                                     label="已分配设备总量（台）"
                                     width="150px"
                                     :show-overflow-tooltip="true"></el-table-column>
                    <el-table-column prop="vcpu"
                                     label="虚拟核数vCPU（个）"
                                     width="150px"
                                     :show-overflow-tooltip="true"></el-table-column>
                    <el-table-column prop="totalMemory"
                                     label="总内存（G）"
                                     width="150px"
                                     :show-overflow-tooltip="true"></el-table-column>
        ...
        methods: {
            ...
            search() {
                ...
                let param = {
                    ...
                    'deviceType': '虚拟机',
                    'department1': this.search_department1.id,
                    'department2': this.search_department2.id,
            ...
            exportData() {
                let param = {
                    ...
                    'deviceType': '虚拟机',
                    'department1': this.search_department1.id,
                    'department2': this.search_department1.id,
                    'createTime1': this.startDate,
                    'createTime2': this.endDate
                }
            ...
            getBizSysList() {
                ...
                this.bizSysList = []
                let data = {
                    'department1': this.search_department1 ? this.search_department1.id : '',
                    'department2': this.search_department2 ? this.search_department2.id : ''
                }
