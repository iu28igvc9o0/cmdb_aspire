/**
* @author: SmartLayout团队
* @date: 2021-03-08 10:14:02
* @description: 智能管理表格模板文件
*/
<template>
...
<script>
    export default {
            ...
            return {
                ...
                dialogConfig: {
                    table: {
                        ...
                        name: 'table',
                        mounted: async (data) => {
                            const tableJson = JSON.parse(JSON.stringify(require('./billLog.json'))) // 修改模板名称
                        ...
                        dialogConfig: {
                            form: {
                                name: 'form',
                                mounted: async () => {
                                    const modelHtml = JSON.parse(JSON.stringify(require('./billLog.json'))) // 修改模板名称
        ...
        async mounted() {
            this.tableJson = JSON.parse(JSON.stringify(require('./billLog.json')))
            ...
            afterHttp({ tableItem, responseBody }) {
                switch (tableItem.columnName) {
                    ...
                    case 'noticeType':
                        ...
                        break
                    default:
                        this.$utils.smartTableDataFormat(tableItem, responseBody, 'data', 'count')
                }
            },
            /**
