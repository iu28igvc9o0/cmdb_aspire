        ...
        <section class="yw-dialog-main">
            <el-form :rules="rules"
                ...
                <el-form-item label="服务人员"
                              prop="serverPerson">
                    <el-input style="width:178px"
                              v-model="form.serverPerson"></el-input>
                </el-form-item>
                <el-form-item label="服务级别"
                              prop="serverLevel">
                    <el-select style="width:178px"
                               v-model="form.serverLevel">
                ...
                <el-form-item label="处理时长"
                              prop="handleLong"
                              required>
                    <el-input v-model="form.handleLong"
                              style="width: 178px"
                              disabled>
                ...
                <el-form-item label="实际人天"
                              prop="realDays">
                    <el-input v-model="form.realDays"
                              type="number"
                              style="width: 178px"
                              :min="1">
                        <template slot="append">天</template>
                ...
                <el-form-item label="移动审批人"
                              prop="yidongApprover">
                    <el-input style="width:178px"
                              v-model="form.yidongApprover"></el-input>
                </el-form-item>
                <el-form-item label="运维审批人"
                              prop="devopsApprover">
                    <el-input style="width:178px"
                              v-model="form.devopsApprover"></el-input>
                </el-form-item>
                <el-form-item label="创建人"
                              prop="createUser">
                    <el-input style="width:178px"
                              v-model="form.createUser"></el-input>
                </el-form-item>
            </el-form>
        </section>
