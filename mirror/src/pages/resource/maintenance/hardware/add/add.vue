        ...
        <section class="yw-dialog-main">
            <el-form class="yw-form is-required"
                ...
                <el-form-item label="税率(%)"
                              prop="tax_rate">
                    <el-input v-model="objModel.tax_rate"></el-input>
                </el-form-item>
        ...
        methods: {
            ...
            addCommit() {
                ...
                var obj = {
                    ...
                    'taxRate': this.objModel.tax_rate,
                ...
                rbmaintenHardServiceFactory.updateMaintenance(obj).then((res) => {
                    ...
                    this.closeDialog()
                    this.$emit('setReloadTableData', false)
                })
            },
            ...
            packageAllData(row) {
                var obj = {
                    // 表示不采取分页
                    deviceSn: row,
                    projectName: this.objModel.project_name
                }
                rbmaintenHardServiceFactory.queryNeedInfoByNameAndDeviceSn(obj).then(res => {
                    var str = res
                    // 填空级联的数据
                    ...
                    this.objModel.warranty_date = str.warrantyDate
                    this.objModel.produce_name = str.produceName
                    this.objModel.produce_concat = str.produceConcat
                    this.objModel.produce_phone = str.producePhone
                    this.objModel.pre_tax = str.preTax
                    this.objModel.tax_rate = str.taxRate
                    this.objModel.after_tax = str.afterTax
                    this.objModel.unit_price = str.unitPrice
                    this.objModel.total_price = str.totalPrice
                    this.objModel.pay_method = str.payMethod
                    this.objModel.discount_amount = str.discountAmount
                    this.objModel.discount_rate = str.discountRate

                    var params = {
                        deviceSerialNumber: row,
                        warrantyDate: str.warrantyDate
                    }
