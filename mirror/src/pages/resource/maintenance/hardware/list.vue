<template>
    <div class="components-container yw-dashboard"
                    ...
                    <div v-for="(item, index) in checkColumns"
                        ...
                        <el-table-column :key="Math.random()"
                            ...
                            <template slot-scope="scope">
                                <el-button v-if="item.columnCode === 'ip' || item.columnCode === 'deviceName' "
                                           type="text"
                                           @click="goToInsDetail(scope.row)">
            ...
            <section class="yw-dialog-main">
                <el-form class="yw-form is-required"
                    ...
                    <el-form-item label="服务供应商"
                                  prop="produce_name">
                        <el-input v-model="update.produce_name"
                                  :disabled="true"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="是否购买维保"
                                  prop="buy_mainten">
                        <el-select style="width: 157px"
                                   v-model="update.buy_mainten"
                                   placeholder="请选择"
                                   class="list-sel"
                                   clearable>
                            <el-option v-for="(item, index) in optionsTrueFalseList"
                    ...
                    <el-form-item label="税率(%)"
                                  prop="tax_rate">
                        <el-input v-model="update.tax_rate"></el-input>
                    </el-form-item>
                ...
                <el-form class="yw-form is-required"
                    ...
                    <el-form-item label="维保管理员"
                        ...
                        <el-input style="width:178px"
                                  v-model="update.admin"></el-input>
                    </el-form-item>
                    <el-form-item label="税前(万)"
                                  prop="pre_tax">
                        <el-input style="width:178px"
                                  v-model="update.pre_tax"></el-input>
                    </el-form-item>
                    <el-form-item label="税率(%)"
                                  prop="tax_rate">
                        <el-input style="width:178px"
                                  v-model="update.tax_rate"></el-input>
                    </el-form-item>
                    <el-form-item label="税后(万)"
                                  prop="after_tax">
                        <el-input style="width:178px"
                                  v-model="update.after_tax"></el-input>
                    </el-form-item>
                    <el-form-item label="单价(万)"
                                  prop="unit_price">
                        <el-input style="width:178px"
                                  v-model="update.unit_price"></el-input>
                    </el-form-item>
                    <el-form-item label="总价(万)"
                                  prop="total_price">
                        <el-input style="width:178px"
                                  v-model="update.total_price"></el-input>
                    </el-form-item>
                    <el-form-item label="结算方式"
                                  prop="pay_method">
                        <el-select v-model="update.pay_method"
                    ...
                    <el-form-item label="折扣后金额(万)"
                                  prop="discount_amount">
                        <el-input style="width:178px"
                                  v-model="update.discount_amount"></el-input>
                    </el-form-item>
                    <el-form-item label="折扣率(%)"
                                  prop="discount_rate">
                        <el-input style="width:178px"
                                  v-model="update.discount_rate"></el-input>
                    </el-form-item>
                </el-form>
            </section>
            <section class="btn-wrap">
        ...
        <HardwareAdd v-if="hardwareDialogMsg.dialogVisible"
                     @setReloadTableData="getPageData"
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    tax_rate: [{ validator: (rule, value, callback) => this.validPercentage(rule, value, callback), trigger: 'change' }],
        ...
        methods: {
            ...
            showUpdateDialog() {
                ...
                this.update.tax_rate = str.taxRate
            ...
            exportExcelData() {
                this.loading = true
                this.loading_text = '正在导出数据，由于数据量较大，请耐心等待...'
                var obj = {
                    'system_name': this.system_name,
                    'device_name': this.device_name,
                    'warranty_date_before': this.warranty_date_before,
