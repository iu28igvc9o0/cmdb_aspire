                ...
                <el-form :model="update"
                    ...
                    <el-form-item label="设备序列号">
                        <el-input style="width: 178px"
                                  v-model="update.device_serial_number"
...
<script>
    ...
    export default {
        name: 'ResourceMaintenanceHardwareUseManage',
        components: {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    actual_man_day: [{ required: true, message: '请输入实际人天', trigger: 'blur' }, { pattern: /^[1-9][0-9]*$/, message: '请输入正整数', trigger: 'blur' }]
                },
                fileList: [],
                ifShowAlert: false,
                alertMsg: '',
