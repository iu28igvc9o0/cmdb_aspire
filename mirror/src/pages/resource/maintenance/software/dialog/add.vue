    ...
    <el-dialog class="yw-dialog"
        ...
        <section class="yw-dialog-main">
            <el-form class="yw-form is-required"
                ...
                <el-form-item label="本期维保开始时间"
                              prop="maintenBeginDate">
                    <el-input style="width:178px"
                              v-model="form.maintenBeginDate"
                              disabled></el-input>
                </el-form-item>
                <el-form-item label="本期维保结束时间"
                              prop="maintenEndDate">
                    <el-input style="width:178px"
                              v-model="form.maintenEndDate"
                              disabled></el-input>
                </el-form-item>
                ...
                <el-form-item label="软件名称"
                              prop="softwareName">
                    <el-input style="width:178px"
                              v-model="form.softwareName"></el-input>
                </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            setCurrProject(val) {
                ...
                this.form.company = project.maintenProduce
                ...
                this.form.userName = project.maintenProduceName
                this.form.telephone = project.maintenProducePhone
            },
            submit() {
