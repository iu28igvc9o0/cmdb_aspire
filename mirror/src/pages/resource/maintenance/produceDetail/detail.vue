            ...
            <el-collapse-item name="1">
                ...
                <el-form class="yw-form form-details"
                    ...
                    <el-form-item label="厂商图标">
                        <img  v-if="produceInfo.logoUrl" style="width: 117px; height: 43px" :src="produceInfo.logoUrl" />
                        <span  v-else style="color:#909399">未上传logo</span>
                        <!--<el-image :src="produceInfo.logoUrl"></el-image>-->
                    </el-form-item>
