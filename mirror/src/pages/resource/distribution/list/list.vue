    ...
    <div class="components-container yw-dashboard">
        <el-form class="components-condition yw-form"
            ...
            <el-form-item label="一级部门">
                ...
                <el-select v-model="primaryDepartment"
                           placeholder="请选择"
                           @change="changeDepartment2List(primaryDepartment)"
                           clearable
                           filterable>
            ...
            <el-form-item label="二级部门">
                ...
                <!--placeholder="请输入内容"></el-input>-->
                <el-select v-model="secondaryDepartment"
                           @change="getbizSystemList()"
                           placeholder="请选择"
                           clearable
                           filterable>
    ...
    export default {
        ...
        methods: {
            ...
            getbizSystemList() {
                ...
                this.bizSystemList = []
                let data = {
                    'department1': this.primaryDepartment,
                    'department2': this.secondaryDepartment
                }
