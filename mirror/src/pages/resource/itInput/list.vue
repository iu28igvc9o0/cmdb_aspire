    ...
    <div class="components-container yw-dashboard"
        ...
        <el-form class="components-condition yw-form"
            ...
            <el-form-item label="评估周期">
                <el-date-picker v-model="SelectData.year"
                                style="width: 90px"
                                type="year"
                                value-format="yyyy"
                                :clearable="false"
                ...
                <el-select v-model="SelectData.quarter"
                           style="width: 120px">
...
<script>
    ...
    export default {
        name: 'ResourceItInput',
        mixins: [QueryObject, department],
        components: {
        ...
        methods: {
            ...
            query() {
                ...
                //   console.log( _t.$refs.deviceInfo)
                //   _t.$refs[_t.currentTabComponent].init()
                // } else {
                //   _t.$refs[_t.currentTabComponent].query()
                // }
            ...
            async queryProvinces() {
                let loginUserDeparent = sessionStorage.getItem('provinceStorage') ||
                    JSON.parse(sessionStorage.getItem('loginUserInfo'))['dept_list'][0].name
                this.selectProvince = await this.getDepartmentList()
                this.selectProvince.some((item) => {

                    if (item.orgName === loginUserDeparent) {
                        this.SelectData.province = item.orgName
                        return true
                    } else {
                        return false
                    }
