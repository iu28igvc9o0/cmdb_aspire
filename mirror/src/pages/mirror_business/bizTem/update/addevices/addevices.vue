    ...
    <div class="component-container">
                    ...
                    <el-col :span="7">
                        <div class="devices-one">设备名称：
                            <el-input v-model="name"
                                      placeholder="请输入内容"
                                      class="devices-input input-tem-name1"></el-input>
                        </div>
                    </el-col>
                    <el-col :span="7">
        ...
        <div class="body-container"
            ...
            <el-table :data="tableData"
                ...
                <el-table-column prop="bizSystemName"
                                 label="业务系统"
                                 align="center">
                </el-table-column>
        ...
        <section style="height:86.72%">
            <div class="selected-head">
                ...
                <el-button type="primary"
                           ...
                           class="items-add mirror_but"
                           @click="addItems"
                           style="margin-left:0">添加</el-button>
                <el-button type="primary"
                           icon="el-icon-delete"
                           class="items-add mirror_but"
            ...
            <div class="selected-container"
                ...
                <ul>
                    ...
                    <li v-for="(item,index) in monitor"
                        :key="index"><span class="moni-name">{{item.name}}</span><i class="el-icon-delete"
                           @click="clear(index)"></i>
                    </li>
                </ul>
            </div>
        ...
        methods: {
            ...
            selected() {
                if (this.monitor.length <= 0) {
                    ...
                    // this.$router.go(-1)
                    this.$router.push('/mirror/template/update')
                }
            },
            // 取消选择
            cancel() {
