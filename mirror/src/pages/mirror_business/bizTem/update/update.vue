        ...
        <div class="body-container">
          ...
          <el-form-item prop="mon_type" label="监控类型：" class="add-tit" label-width="93px">
            ...
            <div class="add-table"
                ...
                <div v-else>
                    <theme-calce @stepChange="stepChange(arguments, 'msg')"
                                 :themeOptions="theme_data_options"
                                 :template1="template"
                                 :newTemplate1="newTemplate"
                                 :tableData1="tableData"></theme-calce>
                </div>
            </div>
            ...
            <div class="add-device"
                ...
                <div style=""
                    ...
                    <el-button class="device-add"
                               type="primary"
                               @click="addTrigger()">新增</el-button>
                    <el-button class="device-del"
                               type="primary"
                               @click="delteTrigger()">删除</el-button>
                </div>
                        ...
                        <el-form ref="business"
                                ...
                                <el-col :span="22"
                                    ...
                                    <el-row style="padding:15px;position: relative;margin-bottom: 0px;">
                                        ...
                                        <span style="position:absolute;right:10%;cursor: pointer;"
                                              @click="dataShow(0)"
                                              v-if="!biz_calc_state[0].dataShow">
                                            数据筛选
                                    ...
                                    <div v-show="biz_calc_state[0].dataShow">
                                        ...
                                        <el-row style="padding:2px 15px;margin: 10px 0;"
                                                v-for="(item, index) in biz_calc_obj[0].zbxA.field"
                                                :key="index">
                                            <el-col :span="3">
                                                <el-select size="small"
                                                           :value="item.field"
                                            ...
                                            <span align="center">
                                                <el-col :span="3">
                                                    <span class="buttonControl"
                                                          ...
                                                          @click="dataAdd('field', 'zbxA', 0)">
                                                        <i class="el-icon-plus"></i>
                                                    </span>
                                                    <span class="buttonControl"
                                                          @click="dataDel('field', 'zbxA', 0, index)">
                                        ...
                                        <el-row style="padding:2px 15px;margin:10px 0;"
                                                v-for="(item, index) in biz_calc_obj[0].zbxA.date"
                                                :key="index">
                                            <el-col :span="3">
                                                <el-select filterable
                                                           size="small"
                                            ...
                                            <span align="center">
                                                <el-col :span="3">
                                                    <span class="buttonControl"
                                                          style="margin-left:12px;"
                                                          @click="dataAdd('date', 'zbxA', 0)">
                                                        <i class="el-icon-plus"></i>
                                                    </span>
                                                    <span class="buttonControl"
                                                          @click="dataDel('date', 'zbxA', 0, index)">
                                                        <i class="el-icon-minus"></i>
                                                    </span>
                                                </el-col>
                                            </span>
                            ...
                            <el-row style="font-size:12px;background:#f2f8ff;border:1px solid #D6E1E5;border-radius:3px;display: flex;align-items:center;margin-top:20px;"
                                ...
                                <el-col :span="22"
                                    ...
                                    <el-row style="padding:15px;position: relative;margin-bottom: 0px;">
                                        ...
                                        <span style="position:absolute;right:10%;cursor: pointer;"
                                              @click="dataShow(1)"
                                              v-if="!biz_calc_state[1].dataShow">
                                            数据筛选
                                            <img style="margin-left: 10px;position: relative;vertical-align: text-bottom;"
                                                 src="../../../../assets/img/more_products.png"
                                                 height="16"
                                    ...
                                    <div v-show="biz_calc_state[1].dataShow">
                                        ...
                                        <el-row style="padding:2px 15px;margin: 10px 0;"
                                                v-for="(item, index) in biz_calc_obj[1].zbxB.field"
                                                :key="index">
                                            <el-col :span="3">
                                                <el-select size="small"
                                                           :value="item.field"
                                            ...
                                            <span align="center">
                                                <el-col :span="3">
                                                    <span class="buttonControl"
                                                          style="margin-left:12px;"
                                                          @click="dataAdd('field', 'zbxB', 1)">
                                                        <i class="el-icon-plus"></i>
                                                    </span>
                                                    <span class="buttonControl"
                                                          @click="dataDel('field', 'zbxB', 1, index)">
                                                        <i class="el-icon-minus"></i>
                                                    </span>
                                                </el-col>
                                            </span>
                                        ...
                                        <el-row style="padding:2px 15px;margin:10px 0;"
                                                v-for="(item, index) in biz_calc_obj[1].zbxB.date"
                                                :key="index">
                                            <el-col :span="3">
                                                <el-select filterable
                                                           size="small"
                                            ...
                                            <span align="center">
                                                <el-col :span="3">
                                                    <span class="buttonControl"
                                                          style="margin-left:12px;"
                                                          @click="dataAdd('date', 'zbxB', 1)">
                                                        <i class="el-icon-plus"></i>
                                                    </span>
                                                    <span class="buttonControl"
                                                          @click="dataDel('date', 'zbxB', 1, index)">
                                                        <i class="el-icon-minus"></i>
                                                    </span>
                                                </el-col>
                                            </span>
                            ...
                            <el-row style="font-size:12px;background:#f2f8ff;border:1px solid #D6E1E5;border-radius:3px;display: flex;align-items:center;margin-top:20px;"
                                ...
                                <el-col :span="22"
                                    ...
                                    <el-row style="padding:15px;position: relative;margin-bottom: 0px;">
                                        ...
                                        <span style="position:absolute;right:10%;cursor: pointer;"
                                              @click="dataShow(2)"
                                              v-if="!biz_calc_state[2].dataShow">
                                            数据筛选
                                            <img style="margin-left: 10px;position: relative;vertical-align: text-bottom;"
                                                 src="../../../../assets/img/more_products.png"
                                                 height="16"
                                    ...
                                    <div v-show="biz_calc_state[2].dataShow">
                                        ...
                                        <el-row style="padding:2px 15px;margin: 10px 0;"
                                                v-for="(item, index) in biz_calc_obj[2].zbxC.field"
                                                :key="index">
                                            <el-col :span="3">
                                                <el-select size="small"
                                                           :value="item.field"
                                            ...
                                            <span align="center">
                                                <el-col :span="3">
                                                    <span class="buttonControl"
                                                          style="margin-left:12px;"
                                                          @click="dataAdd('field', 'zbxC', 2)">
                                                        <i class="el-icon-plus"></i>
                                                    </span>
                                                    <span class="buttonControl"
                                                          @click="dataDel('field', 'zbxC', 2, index)">
                                                        <i class="el-icon-minus"></i>
                                                    </span>
                                                </el-col>
                                            </span>
                                        ...
                                        <el-row style="padding:2px 15px;margin:10px 0;"
                                                v-for="(item, index) in biz_calc_obj[2].zbxC.date"
                                                :key="index">
                                            <el-col :span="3">
                                                <el-select filterable
                                                           size="small"
                                            ...
                                            <span align="center">
                                                <el-col :span="3">
                                                    <span class="buttonControl"
                                                          style="margin-left:12px;"
                                                          @click="dataAdd('date', 'zbxC', 2)">
                                                        <i class="el-icon-plus"></i>
                                                    </span>
                                                    <span class="buttonControl"
                                                          @click="dataDel('date', 'zbxC', 2, index)">
                                                        <i class="el-icon-minus"></i>
                                                    </span>
                                                </el-col>
                                            </span>
                            ...
                            <div align="right">
                                <el-button type="primary"
                                           ...
                                           @click="addIndexNum()"> 添加监控项</el-button>
                            </div>
                            ...
                            <el-row>
                                <el-form-item label="监控项计算"
                                    ...
                                    <el-col :span="18">
                                        <el-input v-model="form.biz_calc_exp"
                                    ...
                                    <el-tooltip placement="top"
                                        ...
                                        <i class='el-icon-question'
                                           style="color: #93D0F7;font-size:20px;position: relative; left: 8px; top: 2px;"></i>
                                    </el-tooltip>
                                </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 4 数据相关方法
            initData() {
                this.fun_type_options = this.funTypeOptions
                this.mon_type_options = this.monTypeOptions
                this.sys_type_options = this.sysTypeOptions
                this.dim_options = this.dimOptions
                this.trigger_options = this.triggerOptions
                this.updateInit()
