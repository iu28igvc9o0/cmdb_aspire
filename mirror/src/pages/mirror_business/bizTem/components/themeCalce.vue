            ...
            <div>
                <div class="add-table">
                    <div style=""
                        ...
                        <el-button class="item-add"
                                   type="primary"
                                   @click="addIndex">新增</el-button>
                        <el-button class="item-related"
                                   type="primary"
                                   @click="updateIndex">修改</el-button>
                        <el-button class="item-del"
                                   type="primary"
                                   @click="deleteIndex">删除</el-button>
                    </div>
              ...
              align="center">
                    ...
                    <footer>
                        <el-button class="prevStep"
                                   type="primary"
                                   @click="prev">上一步</el-button>
                        <el-button class="nextStep"
                                   type="primary"
                                   @click="next">完 成</el-button>
                    </footer>
                </div>
            </div>

            <el-dialog title="新增业务指标"
                       :visible.sync="dialogFormVisible"
                       :close-on-click-modal="false"
                       width="90%"
                       class="addBiz yw-dialog"
                       :before-close="handleClose">
                <div class="heightp100-box pbottom">
                            ...
                            <el-col :span="7">
                                <el-tooltip placement="bottom"
                                    ...
                                    <div style="cursor:pointer;"
                                         @click="toThematicClick()">
                                        <span class="maddid-step-icon"
                                              style="background: #F5F5F5;border: 1px solid #999999;color:#333333;">1</span>
                                        <span class="maddid-step-content"
                                              style="color:#333333;">主题数据接入</span>
                                    </div>
                                </el-tooltip>
                            </el-col>
                            <el-col :span="10"
                                    class="maddid-step-segmenting">
                    ...
                    <div class="con">
                        <el-form ref="business"
                            ...
                            <el-row>
                                ...
                                <el-col :span="17">
                                    <el-form-item label="主题数据"
                                        ...
                                        <span v-if="theme_data_options.length > 0"
                                              style="cursor:pointer;margin-left:20px;font-size: 12px;color: #46BAFE;">主题来自：{{theme_data_options[0].biz_name}}业务系统</span>
                                        <span v-else
                                              style="cursor:pointer;margin-left:20px;font-size: 12px;color: #46BAFE;">该业务系统暂无主题数据,需接入主题数据</span>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row>
                                <el-col :span="7">
                                    <el-form-item label="计算时间点"
                                        ...
                                        <el-radio v-model="form.calc_type"
                                                  label="3"
                                                  @change="calcTypeChange()">第三方调用</el-radio>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="2"
                                        v-show="form.calc_type === '1' || form.calc_type === '3' ? false : true">
                            ...
                            <el-row>
                                <el-col :span="8">
                                    <el-form-item label="统计分组"
                                                  prop="biz_group"
                                                  style="float:left;margin-bottom: 2px !important;"
                                                  class="mei">
                                        <el-select filterable
                                                   style="width:326px;"
                                                   placeholder="请选择主题维度"
                                            ...
                                            <el-option v-for="item in weidu_all_list"
                                                       :key="item.dim_code"
                                                       :label="item.dim_name"
                                                       :value="item.dim_code">
                                            </el-option>
                            ...
                            <el-row style="font-size:12px;background:#f2f8ff;border:1px solid #D6E1E5;border-radius:3px;display: flex;align-items:center;margin-top:20px;"
                                    v-for="(item1, index1) in biz_calc_obj"
                                    :key="item1.staticsName">
                                <el-col :span="2"
                                ...
                                <el-col :span="22"
                                        style="background:#fff;border-left:1px solid #D6E1E5;">
                                    <el-row style="padding:15px;position: relative;margin-bottom: 0px;">
                                        ...
                                        <span style="position:absolute;right:20%;bottom:10px;width: 520px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;text-align:center;"
                                              v-if="index1 === 0">
                                            <span v-for="item in item1.bizGroup"
                                                  :key="item"
                                                  class="bizGroup">{{bizGroupFormatter(item)[0].dim_name}}</span>
                                        </span>
                                        <span style="position:absolute;right:20%;bottom:10px;width: 520px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;text-align:center;"
                                              v-else>
                                            <span v-for="item in item1.bizGroup"
                                                  :key="item"
                                                  class="bizGroup">{{bizGroupFormatter(item)[0].dim_name}}<i class="tag el-icon-close"
                                                   @click="delBizGroup(item1, item)"></i></span>
                                        </span>
                                        <span style="position:absolute;right:10%;cursor: pointer;"
                                              @click="dataShow(item1)"
                                              v-if="!item1.dataShow">
                                            数据筛选
                                            <img style="margin-left: 10px;position: relative;vertical-align: text-bottom;"
                                                 src="../../../../assets/img/more_products.png"
                                                 height="16"
                                                 width="16">
                                        </span>
                                        <span style="position:absolute;right:10%;cursor: pointer;"
                                            ...
                                            收起
                                            <img style="margin-left: 10px;position: relative;vertical-align: text-bottom;"
                                                 src="../../../../assets/img/less_products.png"
                                                 height="16"
                                                 width="16">
                                        </span>
                                    </el-row>
                                    ...
                                    <div v-show="item1.dataShow">
                                        ...
                                        <el-row style="padding:2px 15px;margin: 10px 0;"
                                                v-for="(item, index) in item1.field"
                                                :key="index">
                                            <el-col :span="3">
                                                <el-select size="small"
                                                           :value="item.field"
                                                           ...
                                                           v-model="item.field"
                                                           :clearable="true">
                                                    <el-option v-for="item in weidu_other_list"
                                                               :key="item.dim_code"
                                                               :label="item.dim_name"
                                                               :value="item.dim_code">
                                                    </el-option>
                                            ...
                                            <span align="center">
                                                <el-col :span="5">
                                                    <el-select filterable
                                                               ...
                                                               placeholder="请选择"
                                                               :clearable="true">
                                                        <el-option v-for="item in dim_options.fieldComparor"
                                                                   :key="item.value"
                                                                   :label="item.label"
                                                                   :value="item.value"
                                                                   class="sel_small">
                                            ...
                                            <el-col :span="3">
                                                <el-input :value="item.fieldValue"
                                            ...
                                            <span align="center">
                                                <el-col :span="3">
                                                    <span class="buttonControl"
                                                          ...
                                                          @click="dataAdd('field', item1)">
                                                        <i class="el-icon-plus"></i>
                                                    </span>
                                                    <span class="buttonControl"
                                                          @click="dataDel('field', item1, index)">
                                        ...
                                        <el-row style="padding:2px 15px;margin:10px 0;"
                                                v-for="(item, index) in item1.date"
                                                :key="index">
                                            <el-col :span="3">
                                                <el-select filterable
                                                           size="small"
                                                           ...
                                                           v-model="item.field"
                                                           :clearable="true">
                                                    <el-option v-for="item in weidu_time_list"
                                                               :key="item.dim_code"
                                                               :label="item.dim_name"
                                                               :value="item.dim_code">
                                                    </el-option>
                                            ...
                                            <span align="center">
                                                <el-col :span="5">
                                                    <el-select filterable
                                                               ...
                                                               :clearable="true">
                                                        <el-option v-for="item in dim_options.DimDateOption"
                                                                   :key="item.value"
                                                                   :label="item.label"
                                                                   :value="item.value"
                                                                   class="sel_small">
                                            ...
                                            <el-col :span="4"
                                                ...
                                                <el-select filterable
                                                           ...
                                                           :clearable="true">
                                                    <el-option v-for="item in dim_options.dateTypeOpiton"
                                                               :key="item.value"
                                                               :label="item.label"
                                                               :value="item.value"
                                                               class="sel_small">
                                            ...
                                            <span align="center">
                                                <el-col :span="2"
                                                    ...
                                                    <el-select filterable
                                                               ...
                                                               :clearable="true">
                                                        <el-option v-for="item in dim_options.numTypeOption"
                                                                   :key="item.value"
                                                                   :label="item.label"
                                                                   :value="item.value"
                                                                   class="sel_small">
                                            ...
                                            <el-col :span="2"
                                                    style="padding: 0 8px 0 0;">
                                                <el-input :value="item.dateValue"
                                                          v-model="item.dateValue"></el-input>
                                            </el-col>
                                            <el-col :span="3">
                                                <el-select filterable
                                                           size="small"
                                                           ...
                                                           :clearable="true">
                                                    <el-option v-for="item in dim_options.timeOptions"
                                                               :key="item.value"
                                                               :label="item.label"
                                                               :value="item.value"
                                                               class="sel_small">
                                            ...
                                            <span align="center">
                                                <el-col :span="3">
                                                    <span class="buttonControl"
                                                          style="margin-left:12px;"
                                                          @click="dataAdd('date', item1)">
                                                        <i class="el-icon-plus"></i>
                                                    </span>
                                                    <span class="buttonControl"
                                                          @click="dataDel('date', item1, index)">
                                                        <i class="el-icon-minus"></i>
                                                    </span>
                                                </el-col>
                                            </span>
                                    ...
                                    <el-row style="margin-bottom:10px"
                                            v-if="item1.staticsName !== 'A'">
                                        <div align="right">
                                            <span class="scheduleDel"
                                                  @click="delIndexNum(item1)">
                                                删除
                                            </span>
                                        </div>
                                    </el-row>
                            ...
                            <div align="right">
                                <el-button type="primary"
                                           ...
                                           @click="addIndexNum()"
                                           style="width:auto"> 添加监控项</el-button>
                            </div>

                            <el-row v-for="(item, index) in form.biz_theme_exp"
                                    :key="index">
                                <el-col :span="4">
                                    <el-form-item label="监控项名称"
                                                  :prop="'biz_theme_exp.' + index + '.name'"
                                                  :rules="{required: true, message: '不能为空', trigger: 'blur'}"
                                                  label-width="100px"
                                                  style="padding-left:5px;margin-bottom:0px;">
                                        <el-col>
                                            <el-input v-model="item.name"
                                                      placeholder=""
                                                      :title="item.name"
                                                      class="itemCode"></el-input>
                                        </el-col>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item label="监控项编码"
                                                  :prop="'biz_theme_exp.' + index + '.code'"
                                                  :rules="{required: true, message: '不能为空', trigger: 'blur'}"
                                                  label-width="100px"
                                                  style="padding-left:5px;margin-bottom:0px;">
                                        <el-col>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="监控项计算"
                                                  :prop="'biz_theme_exp.' + index + '.exp'"
                                                  :rules="[{validator: biz_calc_exp, trigger: 'blur'}]"
                                                  label-width="100px"
                                                  style="padding-left:5px;margin-bottom:0px;">
                                        <el-col :span="12">
                                            <el-input v-model="item.exp"
                                                      placeholder="A"
                                                      :title="item.exp"
                                                      class="itemCode"></el-input>
                                        </el-col>
                                        <el-col :span="1">
                                            <i class="el-icon-circle-plus-outline"
                                               style="color: #409EFF;font-size:20px;position: relative; left: 8px; top: 2px;cursor:pointer;"
                                               @click="addExp(item, index)"></i>
                                        </el-col>
                                        <el-col :span="1">
                                            <i class="el-icon-remove"
                                               style="color: #409EFF;font-size:20px;position: relative; left: 8px; top: 2px;cursor:pointer;"
                                               @click="delExp(item, index)"></i>
                                        </el-col>
                                        <!-- <el-col :span="3">
                    ...
                    <div class="fixed-bottom-box t-center">
                        <el-button type="primary"
                                   @click="dialogY()"
                                   class="schedule-add">确定提交</el-button>
                        <el-button @click="dialogN()"
                                   class="schedule-add">取消</el-button>
                    </div>
                </div>
            </el-dialog>
        </div>
...
<script>
    ...
    import optionsMixin from '../config/options-mixin'
    export default {
        mixins: [optionsMixin],
        data() {
        ...
        methods: {
            ...
            initDim() {
                this.dim_options.dateTypeOpiton = JSON.parse(JSON.stringify(this.dimOptions)).dateTypeOpiton
                this.form = {
                    name: '',
                    key: '',
                    biz_theme_id: '',
            ...
            // 4 数据相关方法
            initData() {
                this.dim_options = JSON.parse(JSON.stringify(this.dimOptions))
            },
            pageList() {
                this.tableData = []
