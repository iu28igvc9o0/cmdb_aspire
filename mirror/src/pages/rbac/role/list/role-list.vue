        ...
        <div>
            <el-row>
                ...
                <el-col :span="18">
                    <el-button type="primary"
                               class="confirm-add-new-role pull-right"
                               v-show="roleCreate"
                               @click="create">创建角色</el-button>
                </el-col>
            </el-row>
                ...
                <el-table v-show="roleView"
                    ...
                    <el-table-column label="名称"
                        ...
                        <template slot-scope="scope">
                            <el-button @click.native.prevent="roleDetail(scope.$index, scope.row.name)"
                                       type="text">
                                {{scope.row.name}}
                            </el-button>
                            <el-popover placement="top-start"
                                        trigger="hover"
                                        @show="getRoleUsers(scope.row.name)">
                    ...
                    <el-table-column label="操作"
                        ...
                        <template slot-scope="scope">
                            ...
                            <i v-show="roleDelete1"
                               class="el-icon-delete"
                               @click="roleDelete(scope.$index, scope.row.name)"></i>
                            <!--</el-tooltip>-->
                        </template>
                    </el-table-column>
                </el-table>
                <el-pagination v-show="roleView"
                               class="pull-right"
            ...
            <el-dialog title="删除角色"
                ...
                <span slot="footer"
                    ...
                    <el-button type="primary"
                               @click="deleteRoleMethod()">确 定</el-button>
                </span>
            </el-dialog>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            revokeRoleUsers(user) {
                ...
                rbRoleService.revokeRoleUsers(data, { role_name: user.role_name }).then(() => {
