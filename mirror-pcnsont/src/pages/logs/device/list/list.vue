    ...
    <el-dialog class="yw-dialog"
      ...
      <el-form ref="filterRuleForm"
        ...
        <el-form-item label="过滤规则类型:"
                      prop="ruleType" >
          <el-select v-model="filterRuleData.ruleType" style="width: 200px;" disabled>
            <el-option label="通用" value="common"></el-option>
            <el-option label="登录进程" value="login"></el-option>
            <el-option label="权限级别检查" value="permission"></el-option>
            <el-option label="操作审计" value="operation"></el-option>
          </el-select>
        </el-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        filterRuleData: {
          ruleType: this.ruleType ? this.ruleType : 'common',
          name: '',
          description: ''
        },
        filterFromRule: {
    ...
    methods: {
      ...
      getLogFilterRuleList () {
        LogServiceFactory.getLogFilterRuleList(this.ruleType ? this.ruleType : 'common').then((res) => {
