<template>
  <div class="choose-wrap">
    <section >
      ...
      <!-- 搜索框 -->
      <section class="yw-search-wrap"  style="width:150px;float: left">
        <YwSearch :searchParams="searchParams" style="width:140px;margin-right: 5px;"
        ...
        <treeselect class="yw-treeselect" style="width:200px;float: left;font-color: #606266"
...
/deep/.yw-treeselect.vue-treeselect .vue-treeselect__control .vue-treeselect__placeholder {
    color:#C0C4CC;
}
.search-right {
  width: 364px;
