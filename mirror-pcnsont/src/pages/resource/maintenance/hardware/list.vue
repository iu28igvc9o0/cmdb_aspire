      ...
      <section class="yw-dialog-main">
        <el-form class="yw-form is-required"
          ...
          <el-form-item label="合同编号"
                        prop="project_no">
            <el-input v-model="update.project_no"
                      :disabled="true"></el-input>
          </el-form-item>
  ...
  data () {
    return {
      ...
      rules: {
        ...
        origin_buy: [{ required: true, message: '是否购买维保', trigger: 'change' }],
  ...
  methods: {
    ...
    showUpdateDialog () {
      ...
      this.update.project_no = str.projectNo,
        this.update.projectName = str.projectName
      this.update.produceName = str.produceName
