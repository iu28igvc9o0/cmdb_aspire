            ...
            <div class="form">
                <div class="tableBotton">
                    ...
                    <el-row  style="padding: 0px 10px 10px 10px;">
                        <el-col :span="12" style="border:1px solid #92b4e9;  min-height: 40px;"><div style="text-align:center; line-height:  40px"><span style="margin-right: 20px;">最新stp信息</span><span>采集时间：{{deviceStpInfo.indexDate}}</span></div></el-col>
                        <el-col :span="12" style="border:1px solid #92b4e9;min-height: 40px;"><div style="text-align:center;line-height:  40px "><span style="margin-right: 20px;">历史stp信息（最近7天）</span>
                            <span>
                            <el-select v-model="timeVal" placeholder="请选择" @change="changeQuery">
                                <el-option
                        ...
                        </span><span style="padding-left: 20px;">采集时间：{{historyDeviceStpInfo.indexDate}}</span></div></el-col>
                    </el-row>
                    <el-row >
                        <el-col :span="12">
                            <div class="yw-el-table-wrap table">
                                <div style="border:1px solid #DEE9FC">
                                    ...
                                    >
                                        <el-table-column prop="ifDescr" label="端口名称" :min-width="'120'" sortable show-overflow-tooltip></el-table-column>
                                        <el-table-column prop="stpPortState" label="当前状态" :min-width="'120'" sortable show-overflow-tooltip></el-table-column>
                                        <el-table-column prop="stpPortDesignatedRoot" label="根网桥" :min-width="'120'" sortable show-overflow-tooltip></el-table-column>
                                        <el-table-column prop="stpPortDesignatedBridge" label="指定网桥" :min-width="'120'" sortable show-overflow-tooltip></el-table-column>
                                        <el-table-column prop="stpPortDesignatedPort" label="指定端口" :min-width="'120'" sortable show-overflow-tooltip></el-table-column>
                                        <el-table-column prop="stpPortForwardTransitions" label="状态转变次数" :min-width="'120'" sortable show-overflow-tooltip></el-table-column>
                                        <el-table-column prop="stpPortPathCost" label="路径开销" :min-width="'120'" sortable show-overflow-tooltip></el-table-column>
                                    </el-table>
                                </div>
                            </div>
                            </el-col>
