...
const NAV_ITEM_ALERT = {
  name: '设备告警',
  icon: '#icongaojing',
  base: '/mirror_alert/alert',
  routers: [{
      path: '/manage',
      name: '设备告警管理',
      component: 'alert.vue'
...
const NAV_ITEM_DEVICE_v = {
  name: '设备版本',
  icon: '#iconjiankong',
  base: '/',
  routers: [{
    path: 'mirror_alert/os/list',
    name: '设备版本列表',
    component: 'list.vue'
  },
    {
...
const NAV_ITEM_NET_PERFORMANCE = {
  icon: '#iconjiankong',
  name: '网络性能分析',
  base: '/mirror_alert',
  routers: [{
    path: '/net_performance_analysis',
    name: '网络性能分析',
    component: 'view.vue'
  }]
}

const NAV_ITEM_NET_OPTIMIZE = {
  icon: '#iconjiankong',
  name: '网络优化',
  base: '/mirror_alert',
  routers: [{
    path: '/network/optimize',
    name: '网络优化',
    component: 'list.vue'
  }]
}
...
const DEFAULT_NAV_CONFIG = {
  categories: [
    ...
    NAV_ITEM_DASHBOARD,
    NAV_ITEM_DEVICE_v,
    NAV_ITEM_NET_PERFORMANCE,
    NAV_ITEM_NET_OPTIMIZE
