...
@AllArgsConstructor
@NoArgsConstructor
public class DepartmentCreateResponse  implements Serializable {
	/** 
	 * @fields serialVersionUID 
	 */ 
	
	private static final long serialVersionUID = 3690392692609469253L;
