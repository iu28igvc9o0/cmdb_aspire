...
public class RedisProperties {
     ...
     * 用户权限缓存KEY前缀
     */
    private String redisKeyPrefixPermission = "rbac-service-permission";

    /**
     * 资源模式缓存KEY前缀
     */
    private String redisKeyPrefixResourceSchemaHash = "rbac-service-resource-schema-hash";
    
    /**
     * 资源模式集合缓存KEY前缀
     */
    private String redisKeyPrefixResourceSchemaList = "rbac-service-resource-schema-list";
