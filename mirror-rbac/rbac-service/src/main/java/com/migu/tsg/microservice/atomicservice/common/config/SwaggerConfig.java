...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
     ...
     */
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("RBAC API Documentation").description("version v1")
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.migu.tsg.microservice.atomicservice")).build()
