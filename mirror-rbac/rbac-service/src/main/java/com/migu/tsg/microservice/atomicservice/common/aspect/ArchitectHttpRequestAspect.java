 ...
 * 类名称: ArchitectHttpRequestAspect.java <br>
 * 类描述: AOP处理请求路径有效性 <br>
 * 创建人: WangSheng <br>
...
@Aspect
@Component
public class ArchitectHttpRequestAspect {

    /**
     * 日志
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(ArchitectHttpRequestAspect.class);
     ...
     * 切入点
     */
    @Pointcut("execution(public * com.migu.tsg.microservice.atomicservice.architect.controller.*Controller.*(..))")
    public void point() {
    }
    ...
    public void doBefore(final JoinPoint joinPoint) throws Exception {
        LOGGER.debug("***** Welcome Access Architect Server *****");
        ...
        LOGGER.debug("***** Call Architect Service Start *****");
        // url
    ...
    public void doAfterReturning(final Object object) {
        ...
        LOGGER.debug("***** Call Architect Service End *****");
    }
}
