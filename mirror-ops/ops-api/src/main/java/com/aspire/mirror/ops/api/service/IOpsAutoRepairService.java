...
public interface IOpsAutoRepairService {
	
	@PostMapping(value="/syncApItemList", produces = MediaType.APPLICATION_JSON_VALUE)
	@ApiOperation(value = "同步自愈指标", notes = "同步自愈指标", response = GeneralResponse.class, tags = {"Ops Auto Repair service API"})
	@ApiResponses(value = {@ApiResponse(code = 200, message = "返回", response = Map.class), @ApiResponse(code = 500, message = "Unexpected error")})
    ...
    @ApiOperation(value = "获取自愈状态列表", notes = "获取自愈状态列表",
            response = Map.class, tags = {"Ops Auto Repair service API"})
    ...
    @ApiOperation(value = "查询自愈指标类型列表", notes = "查询自愈指标类型列表", 
    				response = OpsApItemTypeDTO.class, tags = {"Ops Auto Repair service API"})
    ...
    @ApiOperation(value = "根据指标类型id查询自愈指标列表", notes = "根据指标类型id查询自愈指标列表", 
    				response = OpsApItemDTO.class, tags = {"Ops Auto Repair service API"})
    ...
    @ApiOperation(value = "查询自愈方案列表", notes = "查询自愈方案列表", response = OpsAutoRepairSchemeDTO.class, tags = {"Ops Auto Repair service API"})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "返回", response = OpsAutoRepairSchemeDTO.class),
            			   @ApiResponse(code = 500, message = "Unexpected error")})
    ...
    @ApiOperation(value = "查询自愈方案执行历史", notes = "查询自愈方案执行历史", response = OpsAutoRepairExecuteLogDTO.class, tags = {"Ops Auto Repair service API"})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "返回", response = OpsAutoRepairExecuteLogDTO.class),
            			   @ApiResponse(code = 500, message = "Unexpected error")})
