package com.aspire.mirror.inspection.server.controller.authcontext;

import com.aspire.mirror.inspection.server.anno.ResFilterKeysValid;
...
public class ControllerAuthAspect {
     ...
     */
    @Pointcut("execution(public * com.aspire.mirror.inspection.server.controller..*Controller.*(..))")
