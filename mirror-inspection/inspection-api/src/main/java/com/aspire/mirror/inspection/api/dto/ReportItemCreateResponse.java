 ...
 * 类名称:   ReportItemCreateResponse.java
...
@AllArgsConstructor
@NoArgsConstructor
public class ReportItemCreateResponse implements Serializable {
	
	private static final long serialVersionUID = -8964113923008391863L;
