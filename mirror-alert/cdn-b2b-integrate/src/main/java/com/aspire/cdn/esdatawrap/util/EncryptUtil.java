...
public class EncryptUtil {
     ...
     * @return
     */
    public static String base64EncryptUrlSafe(String content) {
    	return Base64Utils.encodeToUrlSafeString(content.getBytes(Charset.forName(DEFAULT_CHARSET)));
    }
     ...
     * @return
     */
    public static String base64DecryptUrlSafe(String content) {
    	return new String(Base64Utils.decodeFromUrlSafeString(content), Charset.forName(DEFAULT_CHARSET));
    }
