...
public class DateUtil {
     ...
     * 分到秒基数
     */
    public static final long DATE_MINUTE_TO_SECONDS = 60 * 1000l;
    ...
    public static List<Date> getExecDuration(int firstMinute,int delayMinute,int intervalMinute) {
		    	Calendar calendar = Calendar.getInstance();
				calendar.set(Calendar.MINUTE, (calendar.get(Calendar.MINUTE)) / firstMinute * firstMinute);
				calendar.set(Calendar.SECOND, 0);
