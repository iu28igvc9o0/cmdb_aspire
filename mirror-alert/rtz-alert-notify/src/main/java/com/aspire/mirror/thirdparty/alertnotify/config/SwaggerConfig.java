package com.aspire.mirror.thirdparty.alertnotify.config;
...
public class SwaggerConfig {
     ...
     */
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Alert notify API").description("Alert notify API")
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors
                        .basePackage("com.aspire.mirror.thirdparty.alertnotify.controller"))
