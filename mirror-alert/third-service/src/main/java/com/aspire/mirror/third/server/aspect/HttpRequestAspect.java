package com.aspire.mirror.third.server.aspect;
...
import com.aspire.mirror.third.server.annotation.ResultCode;
...
import com.aspire.mirror.third.server.exception.BadRequestUrlException;
import static com.aspire.mirror.third.server.handle.ExceptionHandle.RESULT_CODE;
...
public class HttpRequestAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(public * com.aspire.mirror.third.server.controller.*Controller.*(..))")
    public void point() {
    }
