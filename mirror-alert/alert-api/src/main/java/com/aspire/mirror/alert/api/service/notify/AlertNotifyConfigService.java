...
@RequestMapping(value = "/alerts/notifyConfig")
public interface AlertNotifyConfigService {
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "返回", response = String.class),
            @ApiResponse(code = 500, message = "Unexpected error")})
    String createAlertNotifyConfig(@RequestBody AlertNotifyConfigReq request);
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "返回", response = String.class),
            @ApiResponse(code = 500, message = "Unexpected error")})
    String updateAlertNotifyConfig(@RequestBody AlertNotifyConfigReq request);
    ...
    @ApiOperation(value = "发送", notes = "发送", tags = {"Alerts Notify Config API"})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "返回"),
            @ApiResponse(code = 500, message = "Unexpected error")})
    void send();

    @GetMapping(value = "/resend", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "重新发送", notes = "重新发送", tags = {"Alerts Notify Config API"})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "返回"),
            @ApiResponse(code = 500, message = "Unexpected error")})
    void resend();
