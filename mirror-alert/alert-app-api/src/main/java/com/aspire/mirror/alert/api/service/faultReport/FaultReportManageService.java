package com.aspire.mirror.alert.api.service.faultReport;
...
@Api(value = "故障管理")
public interface FaultReportManageService {
    ...
    void insert(@RequestBody FaultReportManageReq manage);
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "返回", response = void.class),
            @ApiResponse(code = 500, message = "Unexpected error", response = void.class)})
    void update(@RequestBody FaultReportManageReq manage);
    ...
    @ApiOperation(value = "查询详情", notes = "查询详情", response = FaultReportManageReq.class, tags = {"fault report manage API"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "返回", response = FaultReportManageReq.class),
            @ApiResponse(code = 500, message = "Unexpected error", response = FaultReportManageReq.class)})
    FaultReportManageReq selectById(@PathVariable("id") Integer id);
    ...
    PageResponse<FaultReportManageReq> selectListByParams(@RequestParam(value = "faultReportUser",required = false) String faultReportUser,
