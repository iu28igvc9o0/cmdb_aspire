package com.aspire.mirror.monitor.server.aspect;
...
import com.aspire.mirror.monitor.server.annotation.ResultCode;
import com.aspire.mirror.monitor.server.enums.ResultErrorEnum;
...
import com.aspire.mirror.monitor.server.exception.BadRequestUrlException;
import static com.aspire.mirror.monitor.server.handle.ExceptionHandle.RESULT_CODE;

/**
 * 项目名称: Elasticsearch-service <br>
 * 包: com.aspire.mirror.elasticsearch.server.aspect <br>
...
public class HttpRequestAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(public * com.aspire.mirror.monitor.server.controller.*Controller.*(..))")
    public void point() {
    }
    ...
    public void doBefore(final JoinPoint joinPoint) throws Exception {
        LOGGER.debug("***** Welcome Access Elasticsearch Server *****");
        ...
        LOGGER.debug("***** Call Elasticsearch Service Start *****");
        // url
    ...
    public void doAfterReturning(final Object object) {
        ...
        LOGGER.debug("***** Call Elasticsearch Service End *****");
    }
}
