...
@RestController
@Slf4j
public class AlertDeriveAlertsHisV2Controller extends CommonController implements AlertDeriveAlertsHisV2Service {
    @Autowired
    private IAlertDeriveAlertsHisBizV2 alertDeriveAlertsBizV2;
    @Autowired
