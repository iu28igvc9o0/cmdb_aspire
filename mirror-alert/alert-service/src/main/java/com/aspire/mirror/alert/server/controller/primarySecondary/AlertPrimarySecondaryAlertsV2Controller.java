...
@RestController
@Slf4j
public class AlertPrimarySecondaryAlertsV2Controller extends CommonController implements AlertPrimarySecondaryAlertsV2Service {
    @Autowired
    private IAlertPrimarySecondaryAlertsBizV2 alertPrimarySecondaryAlertsBizV2;
    @Autowired
    ...
    public PageResponse<Map<String, Object>> list(@RequestBody QueryParams queryParams) {
        List<AlertFieldVo> modelFromRedisList = alertFieldBiz.getModelFromRedis(AlertConfigConstants.REDIS_MODEL_PRIMARY_SECONDARY_ALERT, null);
        return alertPrimarySecondaryAlertsBizV2.findPage(generateCriteria(queryParams, modelFromRedisList));
    }
    ...
    public Map<String, Object> export(@RequestBody QueryParams queryParams) {
        ...
        List<Map<String, Object>> pageResult =
                alertPrimarySecondaryAlertsBizV2.list(criteria);
