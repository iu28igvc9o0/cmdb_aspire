...
import com.aspire.mirror.composite.service.derive.ICompAlertDeriveAlertsV2Service;
import com.migu.tsg.microservice.atomicservice.composite.clientservice.derive.AlertDeriveAlertsV2ServiceClient;
 ...
 */
@RestController
public class CompAlertDeriveAlertsV2Controller implements ICompAlertDeriveAlertsV2Service {

    @Autowired
    private AlertDeriveAlertsV2ServiceClient alertDeriveAlertsV2ServiceClient;
    /**
     * 查询衍生记录列表
     *
