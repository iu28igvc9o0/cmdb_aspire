package com.aspire.mirror.composite.payload.primarySecondary;
...
@NoArgsConstructor
@AllArgsConstructor
public class CompAlertPrimarySecondaryResp {
     ...
     * 主要告警数量
     */
    private Integer primaryAlertCount;
    /**
     * 次要告警数量
     */
    private Integer secondaryAlertCount;
    /**
     * 最新告警时间
     */
    private Date newestSecondaryDate;
}