...
public interface ICompSysMenuService {
    /**
     *
     * @return
     */
    ...
    List<CompSysMenuResp> listAll(@PathVariable("sys_id") String sysId) ;
    ...
    CompSysMenuResp insert(@RequestBody CompSysMenuReq sysMenuReq);
    ...
    CompSysMenuResp update(@RequestBody CompSysMenuReq sysMenuReq);
    ...
    CompSysMenuResp selectById(@PathVariable("id") String id);
}
