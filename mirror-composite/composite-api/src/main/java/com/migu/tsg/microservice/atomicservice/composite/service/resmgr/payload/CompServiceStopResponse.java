...
* File Name:CompServiceStopResponse.java
* Package Name:com.migu.tsg.microservice.atomicservice.composite.service.resMgr.payload
* ClassName: CompServiceStopResponse <br/>
* date: 2017年9月15日 下午4:00:16 <br/>
* 服务停止请求model
* @author pengguihua
* @version 
* @since JDK 1.6
...
public class CompServiceStopResponse {
    ...
    * File Name:CompServiceStopResponse.java
    * Package Name:com.migu.tsg.microservice.atomicservice.composite.service.resMgr.payload
    * ClassName: InstanceSize <br/>
    * date: 2017年9月15日 下午3:35:55 <br/>
    * InstanceSize对象
    * @author pengguihua
    * @version CompServiceStopResponse
    * @since JDK 1.6
    */
    @Data
    ...
    * File Name:CompServiceStopResponse.java
    * Package Name:com.migu.tsg.microservice.atomicservice.composite.service.resMgr.payload
    * ClassName: AutoScaleConfig <br/>
    * date: 2017年9月15日 下午3:36:45 <br/>
    * AutoScaleConfig对象
    * @author pengguihua
    * @version CompServiceStopResponse
    * @since JDK 1.6
