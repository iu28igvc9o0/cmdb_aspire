package com.aspire.mirror.composite.service.cmdb.restful.ipResource;
...
/**
 * @author fanwenhui
 * @date 2020-06-11 15:24
 * @description 提供给BPM系统-资源管理流程的页面查询接口
 */
@RequestMapping(value = "${version}/restful/cmdb/ipResource")
public interface IpResourceRestfulAPI {
