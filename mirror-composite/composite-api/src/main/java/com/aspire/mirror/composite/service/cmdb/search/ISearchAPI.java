package com.aspire.mirror.composite.service.cmdb.search;
 ...
 * 作者姓名           修改时间           版本号              描述
 */
@RequestMapping("${version}/cmdb/search")
public interface ISearchAPI {

    /**
     * 获取自定义过滤列
     */
    @RequestMapping(value = "/getOrInsertColumnFilter/{menuType}/{moduleId}", method = RequestMethod.GET)
