 ...
 * <p/> 
 *
 * 文件名:  ICompYumManageService.java 
 * <p/>
 *
 * 功能描述: TODO 
 * <p/>
...
public interface ICompYumManageService {
	...
	@PostMapping(value = "/downloadYumFile", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "下载yum文件", notes = "下载yum文件", response = GeneralResponse.class, tags = {"Yum Manage service API"})
