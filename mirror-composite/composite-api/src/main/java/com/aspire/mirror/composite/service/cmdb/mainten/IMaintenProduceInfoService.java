...
@Api(value = "维保厂商信息")
@RequestMapping("${version}/cmdb/maintenProduce")
public interface IMaintenProduceInfoService {
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "新增成功", response = String.class),
            @ApiResponse(code = 500, message = "内部错误")})
    Map<String, Object> insertProduce(ProduceInfoResq produceInfoRequest, @RequestParam(value = "logo",required = false) MultipartFile logo);
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "根据厂商ID和类型查询联系人信息联系人成功", response = String.class),
            @ApiResponse(code = 500, message = "内部错误")})
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "更新联系人", response = String.class),
            @ApiResponse(code = 500, message = "内部错误")})
