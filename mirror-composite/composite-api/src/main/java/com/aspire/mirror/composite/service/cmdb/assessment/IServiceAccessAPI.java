...
/**
 * 项目名称:
 * 包: com.aspire.mirror.composite.service.cmdb.assessment
 * 类名称:
 * 类描述:
 * 创建人: PJX
 * 创建时间: 2019/7/15 16:11
 * 版本: v1.0
 */
@Api(value = "服务评估管理")
@RequestMapping("${version}/cmdb/device")
public interface IServiceAccessAPI {
//    @GetMapping("/serviceAssess/insert")
//    @ApiOperation(value = "新增统计数据", notes = "新增统计数据", tags = {"CMDB Server Assess API"})
...
//    Map<String,Object> insert(@RequestParam(value = "quarter") String quarter);
    ...
    @GetMapping("/serviceAssess/queryAllData")
    @ApiOperation(value = "查询统计数据", notes = "查询统计数据", tags = {"CMDB Server Assess API"})
    ...
    @ApiOperation(value = "保存总得分", notes = "保存总得分", tags = {"CMDB Server Assess API"})
    ...
    @ApiOperation(value = "获取厂商评分下设备类型评分状态", notes = "获取厂商评分下设备类型评分状态", tags = {"CMDB Server Assess API"})
