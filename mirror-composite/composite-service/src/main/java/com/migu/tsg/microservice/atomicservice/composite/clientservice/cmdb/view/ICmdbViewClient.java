package com.migu.tsg.microservice.atomicservice.composite.clientservice.cmdb.view;
...
public interface ICmdbViewClient {

    /**
     * 根据模型分组获取视图列表
     */
    @RequestMapping(value = "/cmdb/view/listByQuery", method = RequestMethod.POST)
     ...
     * 根据id获取数据结构(全部)
     */
    @RequestMapping(value = "/cmdb/view/getDataStructure", method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/cmdb/view/getNextNodeData", method = RequestMethod.POST)
     ...
     * 根据id获取视图结构
     */
    @RequestMapping(value = "/cmdb/view/getStructure", method = RequestMethod.GET)
     ...
     * 新增自定义视图
     */
    @RequestMapping(value = "/cmdb/view/save", method = RequestMethod.POST)
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "新增成功", response = List.class),
            @ApiResponse(code = 500, message = "内部错误")})
    Map<String, Object> save(@RequestParam("userName") String userName, @RequestBody CmdbView cmdbView);

    /**
     * 删除自定义视图
     */
    @RequestMapping(value = "/cmdb/view/deleteView", method = RequestMethod.DELETE)
     ...
     * 删除自定义视图节点
     */
    @RequestMapping(value = "/cmdb/view/deleteNode", method = RequestMethod.DELETE)
