...
public class POICascadeUtils2 {
    ...
    public static void initDropDownList(Workbook workbook, List<ExcelData> dataList) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            if ("listSel".equals(controlCode)) {
                ...
                List<ExcelData> childList = excelData.getChildList();
                if ("parent".equals(levelType) || StringUtils.isBlank(levelType)) {
        ...
        if (sheetIndex > 0) {
            for (int i = 0; i < sheetIndex; i++) {
                ...
                if (!EXCEL_HIDE_SHEET_NAME.equals(sheet.getSheetName())) {
                    int startRow = 2;
                    List<ExcelData> child = Lists.newArrayList();
    ...
    private static Integer getParentIndex(ExcelData data, List<ExcelData> dataList) {
