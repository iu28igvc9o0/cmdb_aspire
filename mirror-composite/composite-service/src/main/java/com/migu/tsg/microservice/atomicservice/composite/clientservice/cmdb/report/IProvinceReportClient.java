...
public interface IProvinceReportClient {

    @PostMapping("/cmdb/province/report/getSetting")
    ...
    @PostMapping("/cmdb/province/report/getTableByName")
    @ApiOperation(value = "获取表列配置", notes = "获取表列配置", tags = {"CMDB REPORT API"})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "查询成功", response = Map.class),
            @ApiResponse(code = 500, message = "内部错误")})
    ...
    @PostMapping("/cmdb/province/report/save")
    @ApiOperation(value = "保存上报省份数据", notes = "保存上报省份数据", tags = {"CMDB REPORT API"})
    @ApiResponses(value = {@ApiResponse(code = 200, message = "查询成功", response = Map.class),
            @ApiResponse(code = 500, message = "内部错误")})
    Map<String, String> save(@RequestParam("userName") String username, @RequestBody Map<String,Object> insertDataBox);

    @PostMapping("/cmdb/province/report/getSettingData")
    ...
    @PostMapping("/cmdb/province/report/submitCheck")
    ...
    @PostMapping("/cmdb/province/report/submitApprove")
    ...
    @PostMapping("/cmdb/province/report/getProvinceStatus")
