...
public class AESUtil {
    ...
    //算法
    private static final String TRANSFORMAT = "AES/ECB/PKCS5Padding";
    ...
    public static String encodeKeyToBase64(String key) {
        String keyBase64 = "";
        keyBase64 = new String(Base64.encodeBase64(key.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        return keyBase64;
    }

    public static String decodeBase64ToKey(String keyBase64) {
        String key = "";
        key = new String(Base64.decodeBase64(keyBase64), StandardCharsets.UTF_8);
        return key;
    }
}