package com.migu.tsg.microservice.atomicservice.composite.clientservice.cmdb.restful.beixiang;
 ...
 * FileName: IBeiXiangRestfulClient
 * Author:   hangfang
 * Date:     2020/1/8
...
public interface IBeiXiangRestfulClient {
    /**
     * 资源池数量统计
     * 1、大屏登录后的初始展示界面；
     ...
     * @param top 展示前几
     */
    @RequestMapping(value = "/cmdb/restful/beixiang/countIdcTypePer", method = RequestMethod.GET)
     ...
     * @param top 展示前几
     */
    @RequestMapping(value = "/cmdb/restful/beixiang/countIdcDeviceNumber", method = RequestMethod.GET)
     ...
     * @param top 展示前几
     */
    @RequestMapping(value = "/cmdb/restful/beixiang/countDepart1BizPer", method = RequestMethod.GET)
     ...
     * @param top 展示前几
     */
    @RequestMapping(value = "/cmdb/restful/beixiang/countDepart1BizNumber", method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/cmdb/restful/beixiang/countDepart1DeviceNumber", method = RequestMethod.GET)
     ...
     * @param idcType 资源池名称
     */
    @RequestMapping(value = "/cmdb/restful/beixiang/countDeviceByIdcType", method = RequestMethod.GET)
     ...
     * @param top 展示前几
     */
    @RequestMapping(value = "/cmdb/restful/beixiang/countDepart1Device", method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/cmdb/restful/beixiang/RoomDevicePer", method = RequestMethod.GET)
