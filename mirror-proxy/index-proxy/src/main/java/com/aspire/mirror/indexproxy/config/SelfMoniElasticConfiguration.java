...
import com.aspire.mirror.indexproxy.util.PropertyMapper;
 ...
 * <p/>
 * 
 * 类名: SelfMoniElasticConfiguration
 * <p/>
 *
 * 类功能描述: 自监控采集值ES存储配置
 * <p/>
...
public class SelfMoniElasticConfiguration {
	
	@Bean
	@ConfigurationProperties(prefix = "selfMoni.elasticsearch.rest")
