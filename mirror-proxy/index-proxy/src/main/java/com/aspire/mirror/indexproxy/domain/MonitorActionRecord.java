...
public class MonitorActionRecord extends BasicDataOperateAware implements Serializable {
	private static final long	serialVersionUID		= -9096648659737146369L;
	public static final String	ACTION_TYPE_URL			= "1";
	public static final String	ACTION_TYPE_FUNCTION	= "2";
	
	public static final Integer	EVENT_TYPE_EXCEPTION	= 1;
	public static final Integer	EVENT_TYPE_NORMAL		= 2;
	public static final Integer	EVENT_TYPE_GENERAL		= 3;
