...
import com.aspire.mirror.indexproxy.config.redisson.ClusterServersConfig;
import com.aspire.mirror.indexproxy.config.redisson.IRedisonConfigContentAware;
import com.aspire.mirror.indexproxy.config.redisson.MasterSlaveServersConfig;
import com.aspire.mirror.indexproxy.config.redisson.ReplicatedServersConfig;
import com.aspire.mirror.indexproxy.config.redisson.SentinelServersConfig;
import com.aspire.mirror.indexproxy.config.redisson.SingleServerConfig;

import lombok.extern.slf4j.Slf4j;

@Slf4j
@Configuration
@ConditionalOnExpression("${middleware.configuration.switch.redis:true}")
