 ...
 * Variable: gridSize
 * 
 * Specifies the grid size. Default is 10. 默认网格大小
 */
mxGraph.prototype.gridSize = 6;
...
mxGraph.prototype.zoom = function (factor, center) {
	// 如果缩放比列小于初始化的比列return
	geDiagramContainerSc(1)
	if ((this.view.scale * factor * 100) / 100 < window._globalScale) {
		return
	}
