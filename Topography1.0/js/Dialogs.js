 ...
 */
/**
 * Constructs a new open dialog.      console.log(document.documentElement.clientWidth,'2222')
 */
...
var EditDiagramDialog = function (editorUi) {
	...
	var okBtn = mxUtils.button(mxResources.get('ok'), function () {
		...
		if (select.value == 'new') {
			...
			try {
				console.log(mxUtils.parseXml(data).documentElement)
...
var OutlineWindow = function (editorUi, x, y, w, h) {
	...
	var resizeListener = mxUtils.bind(this, function () {
		...
		var x = document.documentElement.clientWidth - 240;
		var y = document.documentElement.clientHeight - 240;
	...
	this.window.addListener(mxEvent.NORMALIZE, mxUtils.bind(this, function () {
		outline.suspended = false;
		outline.update();
		// document.getElementsByClassName('contains')[0].style.display = 'none'
	}));

	this.window.addListener(mxEvent.MINIMIZE, mxUtils.bind(this, function () {
		outline.suspended = true;
		// document.getElementsByClassName('contains')[0].style.display = ''
	}));
