...
EditorUi = function (editor, container, lightbox) {
  ...
  // mxEvent.addListener(document, 'mousedown', this.keydownHandler);
  ...
  // Stores the current style and assigns it to new cells 存储当前样式并将其分配给新单元格
 ...
 */
EditorUi.prototype.splitSize = (mxClient.IS_TOUCH || mxClient.IS_POINTER) ? 0 : 0;
  ...
  if (!this.editor.extendCanvas) {
    ...
    if (mxUtils.hasScrollbars(graph.container)) {
      if (graph.pageVisible) {
        ...
        graph.container.scrollTop = Math.floor(pad.y - this.editor.initialTopSpacing) - 34;
...
EditorUi.prototype.refresh = function (sizeDidChange) {
  ...
  // this.diagramContainer.style.paddingTop = '40px'
  // this.diagramContainer.style.paddingBottom = '40px'
...
EditorUi.prototype.createDivs = function () {
  ...
  this.sidebarContainer.style.borderRight = 'none !important';
