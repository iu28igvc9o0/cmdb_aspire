...
Format.prototype.refresh = function () {
	...
	if (graph.isSelectionEmpty()) {
		mxUtils.write(label, mxResources.get('SetUp'));
...
BaseFormatPanel.prototype.createStepper = function (input, update, step, height, disableFocus, defaultValue) {
	...
	up.style.border = '1px solid rgb(192, 192, 192)';
	up.style.display = 'inline-block';
	up.style.position = 'relative';
	up.style.height = 19 + 'px';
	up.style.bottom = '2px'
	up.style.right = '0px'
	up.style.width = 20 + 'px';
	up.className = 'geBtnUp';
	stepper.appendChild(up);

	var down = up.cloneNode(false);
	down.style.border = '1px solid rgb(192, 192, 192)';
	down.style.height = 19 + 'px';
	down.style.bottom = '2px'
	down.style.width = 20 + 'px';
	down.style.right = '1px'
