 ...
 * <p>
 * 项目名称:  mirror平台-模板
 * 包:       com.aspire.mirror.template.server.config
...
public class SwaggerConfig {
     ...
     */
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Template API").description("Template API").termsOfServiceUrl("").version("1.0.0")
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors
                        .basePackage("com.aspire.mirror.template.server.controller"))
