package com.aspire.mirror.collect.config;
...
//    }
     ...
     */
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Collect API").description("Collect API").termsOfServiceUrl("").version("1.0.0")
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors
                        .basePackage("com.aspire.mirror.collect.controller"))
