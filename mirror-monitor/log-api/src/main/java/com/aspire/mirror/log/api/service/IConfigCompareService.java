...
public interface IConfigCompareService {
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message = "成功"),
            @ApiResponse(code = 500, message = "内部错误")})
    List<ConfigCompareResp> exportCompareList(@RequestBody List<Integer> ids);
    ...
    void importFile(@RequestBody List<ConfigCompareReq> configCompareList);
     ...
     * @return
     */
    @GetMapping(value = "/logs/{compare_id}", produces = "application/json;charset=UTF-8")
