package com.aspire.mirror.elasticsearch.server.aspect;
...
import com.aspire.mirror.elasticsearch.server.annotation.ResultCode;
import com.aspire.mirror.elasticsearch.server.exception.BadRequestUrlException;

import static com.aspire.mirror.elasticsearch.server.handle.ExceptionHandle.RESULT_CODE;
...
public class HttpRequestAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(public * com.aspire.mirror.elasticsearch.server.controller.*Controller.*(..))")
    public void point() {
    }
