...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
    ...
    ApiInfo apiInfo() {
            return new ApiInfoBuilder().title("ELASTICSEARCH API Documentation").description("version v1").termsOfServiceUrl("")
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors
                        .basePackage("com.aspire.mirror.elasticsearch.server.controller"))
