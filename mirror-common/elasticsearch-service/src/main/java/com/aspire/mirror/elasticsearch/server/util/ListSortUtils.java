...
import com.aspire.mirror.elasticsearch.server.exception.CustomizedException;


/**
* 项目名称: rbac-service <br>
* 包: com.migu.tsg.microservice.atomicservice.common.util <br>
* 类名称: ListSortUtils.java <br>
* 类描述: 
...
public class ListSortUtils {
        ...
        Collections.sort(list, new Comparator<E>() {
            public int compare(E a, E b) {
                ...
                try {
                    ...
                    LOGGER.error("method[sort] The list for sort has error{}", e);
                }
                return ret;
            }
        });
    ...
    public static <E> void sort(List<E> list, final String[] sortnameArr, final boolean[] typeArr) {
        if (sortnameArr.length != typeArr.length) {
            throw new CustomizedException("属性数组元素个数和升降序数组元素个数不相等");
        }
        Collections.sort(list, new Comparator<E>() {
            public int compare(E a, E b) {
                int ret = 0;
     ...
     * @throws Exception
     */
    private static <E> int compareObject(final String sortname, final boolean isAsc, final E a, final E b)
            throws Exception {
        int ret;
     ...
     * @return String
     */
    private static String addZero2Str(final Number numObj, final int length) {
     ...
     * @throws Exception 异常
     */
    private static Object forceGetFieldValue(final Object obj, final String fieldName) throws Exception {
        ...
        if (!accessible) {
			...
			/*
			 * field.setAccessible(true); object = field.get(obj); //
			 * 还原private,protected属性的访问性质 field.setAccessible(accessible); return object;
			 */
        }
        object = field.get(obj);
        return object;
