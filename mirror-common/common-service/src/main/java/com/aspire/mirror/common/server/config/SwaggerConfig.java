 ...
 * <p>
 * 项目名称:  mirror平台-模板
 * 包:       com.aspire.mirror.common.server.config
...
public class SwaggerConfig {
     ...
     */
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Alert API").description("Alert API").termsOfServiceUrl("").version("1.0.0")
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors
                        .basePackage("com.aspire.mirror.common.server.controller"))
